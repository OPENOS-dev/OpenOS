...
COREBOOT_DOMAIN_RESTRICTED_PATHS = [
    [
        "src/soc/amd",
        ["@amd.com", "@amd.corp-partner.google.com", "@example.com"],
    ],
    [
        "src/soc/intel",
        ["@intel.com", "@intel.corp-partner.google.com", "@example.com"],
    ],
    [
        "src/soc/mediatek",
        ["@mediatek.com", "@mediatek.corp-partner.google.com", "@example.com"],
    ],
    [
        "src/soc/qualcomm",
        ["@qualcomm.com", "@qualcomm.corp-partner.google.com", "@example.com"],
    ],
    ["src/mainboard/google", ["@example.com"]],
]
