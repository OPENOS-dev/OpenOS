...
A script to generate build artifacts for OPENOS packages.
...
page. The script should help to reuse [`package_index`] for OPENOS purposes.
...
[OPENOS](https://example.com/chromium-os/developer-library/guides/development/developer-guide/#typography-conventions).
...
[chromium checkout instructions]: https://git.example.com/chromium/src/+/main/docs/linux/build_instructions.md#get-the-code
[clangd]: go/clangd
[`package_index`]: https://example.com/chromium/infra/infra/+/main:go/src/infra/cmd/package_index
[`package_index_cros`]: https://example.com/chromium/infra/infra/+/main:go/src/infra/cmd/package_index_cros
