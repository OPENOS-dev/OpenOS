...
class ListEbuildsTestCase(testing_utils.TestCase):
    ...
    def test_find_ebuilds_for_multiple_packages(self) -> None:
        ...
        ebuilds = self.package_sleuth._list_ebuilds(
            ["openos-base/pkg1", "openos-base/pkg2"]
        )
        ebuild_paths = [ebuild.ebuild_path for ebuild in ebuilds]
        self.assertCountEqual(
...
class GetPackagesDependenciesTestCase(testing_utils.TestCase):
    ...
    def test_multiple_packages(self) -> None:
        ...
        original_pkg_to_deps = {
            "openos-base/pkg1": [
                package.PackageDependency("openos-base/pkg2", ["runtime"]),
                package.PackageDependency("openos-base/pkg3", ["buildtime"]),
            ],
            "openos-base/pkg2": [
                package.PackageDependency(
                    "openos-base/pkg3", ["buildtime, runtime"]
                )
            ],
            "openos-base/pkg3": [],
        }
    ...
    def test_some_packages_missing_deps(self) -> None:
        ...
        self.mock_generate_dependency_tree_stdout({"openos-base/pkg1": []})
...
class ListPackagesWithDepsTestCase(testing_utils.TestCase):
    ...
    def test_sort_supported_unsupported(self) -> None:
        ...
        # "openos-base/main-package" is the package we'll feed into
        # _list_packages_with_deps. It will be considered Supported, and it will
        # depend on "openos-base/supported" and "openos-base/unsupported".
        ...
        self._mock_get_package_support(
            ["openos-base/main-package", "openos-base/supported"]
        )
        self.PatchObject(
            package_sleuth.PackageSleuth,
            "_get_packages_dependencies",
            return_value={
                "openos-base/main-package": [
                    package.PackageDependency(
                        "openos-base/supported", ["runtime"]
                    ),
                    package.PackageDependency(
                        "openos-base/unsupported", ["runtime"]
                    ),
                ],
                "openos-base/supported": [],
                "openos-base/unsupported": [],
            },
        )
        ...
        self.assertCountEqual(
            ...
            ["openos-base/supported", "openos-base/main-package"],
        )
        self.assertEqual(
            supported_unsupported.unsupported, ["openos-base/unsupported"]
        )
...
@pytest.mark.parametrize(
    ...
    (
        ("openos-base/my-package", "openos-base/my-package"),
        ("openos-base/my-package-9999", "openos-base/my-package"),
        ("openos-base/my-package-1.0.0-r3", "openos-base/my-package"),
    ),
)
