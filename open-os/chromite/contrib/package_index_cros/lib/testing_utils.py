...
def _get_overlay_masters(overlay_dir: Path) -> str:
    ...
    masters = []
    # openos doesn't inherit openos, but everything else does.
    if overlay_dir.name != "openos-overlay":
        masters.append("openos")
...
def _get_ebuild_contents(
    ...
    return f"""# Copyright 2024 OCS (Open Code Studio)
...
class TestCase(cros_test_lib.MockTempDirTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.source_root = Path(self.tempdir) / "openos"
    ...
    @property
    def openos_overlay_dir(self) -> Path:
        """Return the path to the checkout's openos-overlay repo."""
        return self.source_root / "src" / "third_party" / "openos-overlay"
    ...
    def _setup_overlays(self) -> None:
        ...
        for overlay_dir in self._all_overlay_dirs:
            ...
            self._mock_paths_to_checkouts[str(overlay_dir)] = {
                "name": f"openos/overlays/{repo_name}",
    ...
    def _create_ebuild(
        ...
        category: str = "openos-base",
        stable_version: str = "1.0.0-r1",
        cros_workon_localnames: Tuple[str] = ("platform2",),
        cros_workon_projects: Tuple[str] = ("openos/platform2",),
        ...
        Args:
            category: The package category, such as "openos-base".
            ...
            private: If True, create the ebuild in the private overlay dir.
                Otherwise, create it in the openos-overlay dir.
        ...
        for project, localname in zip(
            ...
            if category in ("openos-base", "brillo-base"):
                subdir = ""
            else:
                subdir = "third_party"
