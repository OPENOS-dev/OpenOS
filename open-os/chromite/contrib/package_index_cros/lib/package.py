...
def get_package_support(
    ...
    *   Package is built with gn.
    ...
    def has_local_source():
        ...
        # *   openos-base/intel-nnha: platform2 with non-existing
        #     PLATFORM_SUBDIR.
        # *   openos-base/quipper: platform2 with non-existing
        #     PLATFORM_SUBDIR.
    ...
    def is_built_with_gn():
        ...
        # * openos-base/arc-common-scripts
        # * openos-base/arc-myfiles
        # * openos-base/arc-removable-media
        # TODO: Returns true for makefile packages (should be false):
        # * openos-base/avtest_label_detect
...
class Package:
    ...
    # src/third_party.
    src_categories = ["openos-base", "brillo-base"]
    ...
    def _get_ebuild_source_dirs(self) -> List[str]:
        ...
        Based on:
        https://example.com/o/src/third_party/openos-overlay/eclass/cros-workon.eclass;drc=236057acc44bead024a78b50362ec2c82205c286;l=383
        """
    ...
    def _get_ebuilds_dest_dirs(self) -> List[str]:
        ...
        https://example.com/o/src/third_party/openos-overlay/eclass/cros-workon.eclass;drc=236057acc44bead024a78b50362ec2c82205c286;l=474
        """
    ...
    def _get_source_dirs_to_temp_source_dirs_map(
        ...
        https://example.com/o/src/third_party/openos-overlay/eclass/cros-workon.eclass;drc=236057acc44bead024a78b50362ec2c82205c286;l=564
