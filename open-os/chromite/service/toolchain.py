...
def emerge_and_upload_lints(board: str, start_time: int) -> str:
    ...
    gs_file = (
        f"gs://openos-toolchain-artifacts/code-health/{start_time}/"
        f"{lints_fname}"
    )
...
class BuildLinter:
    ...
    BASE_DIR = Path("var/lib/openos/package-artifacts")
    ...
    def emerge_with_linting(
        ...
        Args:
            ...
            use_staticcheck: whether to set environment variables for the
        ...
        # Packages outside of platform2 are only supported for staticcheck.
        platform2_packages = [
    ...
    def fetch_findings(
        ...
        Args:
            ...
            use_staticcheck: whether or not to look for lints from Staticcheck
                (Go linter)
    ...
    def _fetch_staticcheck_lints(self) -> List[LinterFinding]:
        ...
        for package_atom, files in self._fetch_from_linting_artifacts(
            ...
            findings.extend(self._parse_staticcheck_files(files, package_atom))
    ...
    def _parse_staticcheck_files(
        ...
        for file_path in files:
            package_match = BuildLinter.STATICCHECK_PKG_PATTERN.search(
                file_path
            )
    ...
    def _get_sorting_key(self, file_name: str) -> int:
        ...
        m = BuildLinter.STATICCHECK_TIMESTAMP_PATTERN.search(file_name)
