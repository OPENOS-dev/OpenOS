...
class CreateBinhostCLsTest(cros_test_lib.RunCommandTestCase):
    ...
    def testCreateBinhostCLs(self) -> None:
        ...
        self.assertEqual(
            cls, ["the_cl", "https://example.com/another/42", "sdk_version/18"]
        )
...
class get_latest_version_test(cros_test_lib.MockTestCase):
    ...
    def testSuccess(self) -> None:
        ...
        cat_patch.assert_called_with("gs://openos-sdk/cros-sdk-latest.conf")
...
class UprevSdkAndPrebuiltsTest(cros_test_lib.MockTestCase):
    ...
    _old_sdk_bucket = "old-openos-sdk"

    # Contents of the SDK version file. Intended to be %-interpolated.
    _sdk_version_file_template = """# Copyright 2022 OCS (Open Code Studio)
# Use of this source code is governed by a BSD-style license that can be
# found in the LICENSE file.
...
# If empty, Chromite will assume a default value, likely "openos-sdk".
SDK_BUCKET="%(sdk_bucket)s"
"""

    # Contents of the host prebuilt file. Intended to be %-interpolated.
    _prebuilt_file_template = (
        'FULL_BINHOST="gs://openos-prebuilt/board/amd64-host/'
...
source /mnt/host/source/src/third_party/openos-overlay/openos/config/make.conf.common
...
PORTDIR_OVERLAY="
  ...
  /mnt/host/source/src/third_party/openos-overlay
...
FULL_BINHOST="gs://openos-prebuilt/host/amd64/amd64-host/chroot-%(version)s/packages/"
PORTAGE_BINHOST="$FULL_BINHOST"

GENTOO_MIRRORS="https://commondatastorage.googleapis.com/openos-localmirror"
GENTOO_MIRRORS="$GENTOO_MIRRORS https://commondatastorage.googleapis.com/openos-mirror/gentoo"
...
"""
    ...
    def test_update_where_sdk_bucket_is_none(self) -> None:
        ...
        self._test_update("gs://openos-prebuilt", None, self._old_sdk_bucket)
    ...
    def test_update_where_sdk_bucket_is_empty_string(self) -> None:
        ...
        from None.
        """
        self._test_update("gs://openos-prebuilt", "", "")
    ...
    def test_update_where_sdk_bucket_has_no_prefix(self) -> None:
        ...
        self._test_update(
            "openos-prebuilt", "new-openos-sdk", "new-openos-sdk"
        )

    def test_update_sdk_bucket_to_default_value(self) -> None:
        self._test_update("openos-prebuilt", "openos-sdk", "")
...
class UprevToolchainVirtualsSdkTest(cros_test_lib.MockTempDirTestCase):
    ...
    def write_versions(
        ...
        openos_overlay = self.tempdir
        dev_lang_rust = openos_overlay / "dev-lang" / "rust"
        dev_lang_rust.mkdir(parents=True)
        for ver in dev_lang_rust_versions:
            (dev_lang_rust / f"rust-{ver}.ebuild").touch()

        virtual_rust = openos_overlay / "virtual" / "rust"
        ...
        return openos_overlay

    def test_nop_update(self):
        openos_overlay = self.write_versions(
            dev_lang_rust_versions=["1.77.0"],
            virtual_rust_versions=["1.77.0"],
        )
        updated_files = sdk.uprev_toolchain_virtuals(openos_overlay)
    ...
    def test_revision_upgrade(self):
        ...
        updated_files = sdk.uprev_toolchain_virtuals(openos_overlay)
        new_virtual = (
            openos_overlay / "virtual" / "rust" / "rust-1.77.0-r1.ebuild"
        )
        old_virtual = (
            openos_overlay / "virtual" / "rust" / "rust-1.77.0.ebuild"
        )
    ...
    def test_highest_is_picked_of_multiple_versions(self):
        ...
        updated_files = sdk.uprev_toolchain_virtuals(openos_overlay)
        new_virtual = (
            openos_overlay / "virtual" / "rust" / "rust-1.77.0-r3.ebuild"
        )
        old_virtual = (
            openos_overlay / "virtual" / "rust" / "rust-1.77.0-r2.ebuild"
        )
        self.assertEqual(updated_files, [new_virtual])
        self.assertFalse(old_virtual.exists())
        self.assertTrue(new_virtual.exists())
    ...
    def test_virtual_rev_is_bumped_if_version_equality_is_downgrade(self):
        ...
        updated_files = sdk.uprev_toolchain_virtuals(openos_overlay)
        new_virtual = (
            openos_overlay / "virtual" / "rust" / "rust-1.77.0-r7.ebuild"
        )
        old_virtual = (
            openos_overlay / "virtual" / "rust" / "rust-1.77.0-r6.ebuild"
        )
        self.assertEqual(updated_files, [new_virtual])
        self.assertFalse(old_virtual.exists())
        self.assertTrue(new_virtual.exists())
    ...
    def test_virtual_revision_is_lowered_if_version_equality_is_upgrade(self):
        ...
        updated_files = sdk.uprev_toolchain_virtuals(openos_overlay)
        new_virtual = (
            openos_overlay / "virtual" / "rust" / "rust-1.80.0-r1.ebuild"
        )
        old_virtual = (
            openos_overlay / "virtual" / "rust" / "rust-1.77.0-r6.ebuild"
        )
    ...
    def test_virtual_ebuild_writing_only_replaces_version(self):
        ...
        sdk.uprev_toolchain_virtuals(openos_overlay)
        new_virtual = (
            openos_overlay / "virtual" / "rust" / "rust-1.80.0-r1.ebuild"
        )
        self.assertEqual(
