...
_PATH_RULES: List[Tuple[str, Callable[..., bool | None]]] = [
    ...
    (
        r"src/third_party/openos-overlay/sys-boot/openos-bootimage/.*",
        _bootimage_enabled,
    ),
    (
        r"src/third_party/openos-overlay/sys-boot/coreboot/.*",
        _bootimage_enabled,
    ),
    (
        r"src/third_party/openos-overlay/sys-boot/depthcharge/.*",
        _bootimage_enabled,
    ),
    (
        r"src/third_party/openos-overlay/sys-boot/edk2/.*",
        _bootimage_enabled,
    ),
    (
        r"src/third_party/openos-overlay/sys-boot/libpayload/.*",
        _bootimage_enabled,
    ),
]
