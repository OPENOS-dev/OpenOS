    ...
    def test_registered_handlers(self) -> None:
        ...
        for android_package in android.GetAllAndroidPackages():
            cpv = package_info.SplitCPV(
                "openos-base/" + android_package, strict=False
            )
...
class AndroidVersionsTest(cros_test_lib.MockTestCase):
    ...
    def setUp(self) -> None:
        package_result = [
            "openos-base/android-vm-tm-4717008-r1",
            "openos-base/update_engine-0.0.3-r3408",
        ]
        self.PatchObject(
        ...
        self.PatchObject(
            ...
            return_value="openos-base/android-vm-tm",
        )
        FakeEnvironment = {
    ...
    def test_determine_android_version_when_not_present(self) -> None:
        ...
        package_result = ["openos-base/update_engine-0.0.3-r3408"]
        self.PatchObject(
            portage_util, "GetPackageDependencies", return_value=package_result
        )
        version = packages.determine_android_version(self.board)
...
class GetAllFirmwareVersionsTest(cros_test_lib.RunCommandTempDirTestCase):
    ...
    def setUp(self) -> None:
        ...
        # "/build/hana/usr/sbin/openos-firmwareupdate --manifest" inside the
...
class DetermineKernelVersionTest(cros_test_lib.RunCommandTempDirTestCase):
    ...
    def test_determine_kernel_version(self) -> None:
        ...
        kernel_candidates = [
            "sys-kernel/openos-kernel-experimental-4.18_rc2-r23",
            "sys-kernel/openos-kernel-4_4-4.4.223-r2209",
            "sys-kernel/openos-kernel-5_15-5.15.65-r869",
...
class ChromeVersionsTest(cros_test_lib.MockTestCase):
    ...
    def test_determine_chrome_version(self) -> None:
        ...
        r1_cpf = "openos-base/openos-chrome-78.0.3900.0_rc-r1"
...
class PlatformVersionsTest(cros_test_lib.MockTestCase):
    ...
    def test_versions_based_on_mock(self) -> None:
        ...
        version_info_mock = openos_version.VersionInfo(test_platform_version)
...
def test_uprev_chrome_all_files_already_exist(
    ...
    unstable_chrome = cr.test.Package(
        "openos-base", "openos-chrome", version="9999", keywords="~*"
    )
    if modify_unstable:
...
class UprevDrivefsTest(cros_test_lib.MockTestCase):
    ...
    def setUp(self) -> None:
        self.refs = [
            uprev_lib.GitRef(
                path="/openos/platform/drivefs-google3/",
            ...
            uprev_lib.UprevVersionedModifications(
                ...
                files=[
                    os.path.join(
                        package_root,
                        "openos-kernel-5_4",
                        "openos-kernel-5_4-9999.ebuild",
                    ),
                    os.path.join(
                        package_root, "openos-kernel-5_4", "Manifest"
                    ),
                ],
            ),
            uprev_lib.UprevVersionedModifications(
                ...
                files=[
                    os.path.join(
                        package_root,
                        "openos-kernel-5_15",
                        "openos-kernel-5_15-9999.ebuild",
                    ),
                    os.path.join(
                        package_root, "openos-kernel-5_15", "Manifest"
                    ),
                ],
            ),
        ]
...
class UprevHeliumArtifactsTest(cros_test_lib.RunCommandTempDirTestCase):
    ...
    component = "openos-base"
    package_name = "openos-board-default-arc-apps-selphie"
    version = "0.0.1"
    revision = "1"
    tarfile_name = "starbase_helium-arcvm-artifacts_tarfile.tar.zst"
    tarfile_hash = "42"
    ebuild_name_format = "openos-board-default-arc-apps-selphie-%s%s.ebuild"
    rev0_ebuild_name = ebuild_name_format % (version, "")
    old_ebuild_name = ebuild_name_format % (version, f"-r{revision}")
    ebuild_content_format = """# Buildable ebuild
foo
...
<manifest>
  ...
  <project path="src/third_party/openos-overlay" name="openos/overlays/openos-overlay" />
</manifest>
"""
...
"""
        file_layout = (
            ...
            D(
                ...
                [
                    F(
                        "openos/config/openos_version.sh",
                        cros_version_contents,
                    ),
                    D(
                        packages._CROSH_CP,
...
class UprevLkgmFileTest(cros_test_lib.MockTempDirTestCase):
    ...
    def test_success(self) -> None:
        ...
        lkgm_dir = self.tempdir / "src" / "openos"
