...
# for 90 days.
ANDROID_BUCKET_URL = "gs://android-build-openos/builds"
...
def GetAndroidPackageDir(
    ...
    """
    return os.path.join(overlay_dir, "openos-base", android_package)
...
_RUNTIME_ARTIFACTS_BUCKET_URL = "gs://openos-arc-images/runtime_artifacts"
...
def FindRuntimeArtifactsPin(
    ...
    Args:
        ...
        milestone: The OPENOS milestone (can be found using
