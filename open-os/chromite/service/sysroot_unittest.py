    ...
    def testCreateSimpleChromeSysroot(self) -> None:
        ...
        self.rc.assertCommandCalled(
            [
                ...
                "--out-file",
                "sysroot_openos-base_openos-chrome.tar.xz",
                "--deps-only",
            ],
            enter_chroot=True,
...
class BuildPackagesRunConfigTest(
    ...
    def testGetPackages(self) -> None:
        ...
        self.assertIn("openos-base/autotest-all", packages)
...
[ebuild r U] openos-base/tast-build-deps ... to /build/sysroot/
[binary U] openos-base/openos-chrome ... /build/sysroot/"""
        self.rc.AddCmdResult(
        ...
        self.assertIn("openos-base/tast-build-deps", packages)
        self.assertIn("test/package4", packages)
    ...
    def testGetEmergeFlags(self) -> None:
        ...
        self.assertIn(
            "--force-remote-binary=openos-base/openos-chrome", flags
        )
        self.assertIn("--force-remote-binary=openos-base/chrome-icu", flags)
