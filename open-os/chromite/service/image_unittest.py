...
class BuildImageTest(
    ...
    def setUp(self) -> None:
        ...
        self.PatchObject(
            openos_version,
            "VersionInfo",
            return_value=openos_version.VersionInfo(
...
class TestCreateStrippedPackagesTar(cros_test_lib.MockTempDirTestCase):
    ...
    def test(self) -> None:
        ...
        self.PatchObject(
            ...
            side_effect=[
                [package_info.SplitCPV("openos-base/chrome-1-r0")],
                [
        ...
        osutils.Touch(
            os.path.join(pkg_dir, "openos-base", "chrome-1-r0.tbz2"),
            makedirs=True,
        )
        ...
        stripped_files_list = [
            os.path.join(
                "stripped-packages", "openos-base", "chrome-1-r0.tbz2"
            ),
    ...
    def test_command_building(self):
        ...
        expected_uri_mapping = {
            "dev": [
                ...
                f"OPENOS-recovery-R100-12345.0.0-{board}.instructions",
            ],
            "canary": [
