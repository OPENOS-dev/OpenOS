...
_IMAGE_TYPE_DESCRIPTION = {
    constants.BASE_IMAGE_BIN: "Non-developer OPENOS",
    constants.DEV_IMAGE_BIN: "Developer",
    constants.TEST_IMAGE_BIN: "Test",
    constants.FACTORY_IMAGE_BIN: "OPENOS Factory install shim",
...
def Build(
    ...
    version_info = openos_version.VersionInfo(
    ...
    for image_type in images:
        ...
        if image_type != constants.IMAGE_TYPE_FLEXOR_KERNEL:
            msg += (
                ...
                "To flash the image to a OPENOS device, use:\n"
