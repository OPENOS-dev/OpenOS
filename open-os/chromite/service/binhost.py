...
_PROTOCOL = "https"
_CHROMEOS_PREBUILTS_DOMAIN = "us-central1-openos-prebuilts.cloudfunctions.net"
...
_BINHOSTS_GS_BUCKET_NAME_STAGING = "staging-openos-prebuilt"
_BINHOSTS_GS_BUCKET_NAME_PROD = "openos-prebuilt"
...
def SetBinhost(
    ...
    Args:
        ...
        uri: The new value for the binhost key,
            e.g. gs://openos-prebuilt/foo/bar.
