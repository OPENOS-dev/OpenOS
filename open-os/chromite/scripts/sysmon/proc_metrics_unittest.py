        ...
        with mock.patch("psutil.process_iter", autospec=True) as process_iter:
            process_iter.return_value = [
                _mock_process(
                    ...
                    cmdline=[
                        ...
                        (
                            ...
                            "openos4-row3-rack13-host9/646252-provision"
                            "/20171307125911"
                        ),
                        "-m",
                        "openos4-row3-rack13-host9",
                        "--verbose",
                        "--lab",
                        "True",
                        "--provision",
                ...
                _mock_process(
                    ...
                    cmdline=[
                        (
                            "/usr/local/google/home/openos-test/.cache/"
                ...
                _mock_process(
                    ...
                    cmdline=[
                        ...
                        (
                            "/usr/local/autotest/server/autoserv"
                            " -s -P 196499100-openos-test/group0 ..."
                        ),
                    ],
                ),
                _mock_process(
                ...
                _mock_process(
                    name="sshd", cmdline=["sshd:", "openos-test", "[priv]"]
                ),
                _mock_process(
                    name="python3.8",
                    cmdline=[
                ...
                _mock_process(
                    ...
                    cmdline=[
                        "python",
                        (
                            "/tmp/openos-cache/common/gsutil_4.57.tar.gz/"
                            "gsutil/gsutil"
                        ),
                        "-o",
                        "Boto:num_retries=10",
                ...
                _mock_process(
                    ...
                    cmdline=[
                        ...
                        "-instances=google.com:openos-lab:us-central1:tko",
                        "-credential_file=...",
                    ],
                ),
                _mock_process(
                ...
                _mock_process(
                    ...
                    cmdline=["/home/openos-test/.../cros-tool-runner", "..."],
                ),
                _mock_process(
                    name="fluent-bit",
