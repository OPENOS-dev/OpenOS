...
AUTOTEST_PROJECT_NAME = "openos/third_party/autotest"
AUTOTEST_EBUILD = "openos-base/autotest"
DOWNGRADE_EBUILDS = ["openos-base/autotest"]
...
def GetPackageAPI(portage_root, package_cp):
    ...
    Args:
        ...
        package_cp: A string similar to 'openos-base/autotest-tests'.
...
def UpdatePackageContents(change_report, package_cp, portage_root=None) -> None:
    ...
    Args:
        change_report: ItemizedChangeReport object for the changes to be
            made to the package.
        package_cp: A string similar to 'openos-base/autotest-tests' giving
...
def ParseArguments(argv):
    ...
    # build pre-dates https://review.example.com/#/c/62880/ )
    parser.add_argument(
