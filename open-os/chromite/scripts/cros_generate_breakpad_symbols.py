...
EXPECTED_POOR_SYMBOLIZATION_FILES = ALLOWED_DEBUG_ONLY_FILES | {
    ...
    # Pulled from
    # https://skia.example.com/buildbot/+/refs/heads/main/gold-client/, no
    # need to resymbolize.
    "usr/bin/goldctl",
}
...
ALLOWLIST_NO_SYMBOL_FILE_VALIDATION = {
    ...
    # https://example.com/chromium/chromium/src/+/main:native_client/src/trusted/service_runtime/linux/nacl_bootstrap.x
...
# Regular expression for OPENOS's libc.so. Note that some containers have
...
class SymbolFileLineCounts:
    ...
    def __init__(self, sym_file: str, elf_file: str) -> None:
        # https://git.example.com/breakpad/breakpad/+/HEAD/docs/symbol_files.md
