...
class WorkonPackageInfo:
    ...
    Attributes:
        cp: The package name (e.g. openos-base/power_manager).
...
def ListWorkonPackagesInfo(sysroot):
    ...
    for overlay in overlays:
        for filename, projects in portage_util.GetWorkonProjectMap(
            ...
            # openos-base/power_manager/power_manager-9999
            # cp = openos-base/power_manager
            # cpv = openos-base/power_manager-9999
