# Copyright 2016 OCS (Open Code Studio)
...
class CrosMarkAndroidAsStable(cros_test_lib.MockTempDirTestCase):
    ...
    def testMarkAndroidEBuildAsStable(self) -> None:
        ...
        self.assertEqual(
            version_atom,
            f"openos-base/{self.android_package}-{self.new_version}-r1",
        )
        self.assertEqual(
    ...
    def testMainRevved(self) -> None:
        ...
        for board in ("foo", "bar"):
            rc_mock.assertCommandCalled(
                [
                    ...
                    "-q",
                    "--unmerge",
                    "openos-base/android-package-100-r1",
                ],
        ...
        mock_print.assert_called_once_with(
            '\n{"android_atom": "openos-base/android-package-100-r1", "modified_files": ["openos-base/android-package/android-package-100-r1.ebuild", "openos-base/android-package/Manifest", "openos-base/android-package/android-package-50-r1.ebuild"], "revved": true}'
        )
