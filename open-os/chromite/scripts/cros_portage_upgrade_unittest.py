...
EBUILDS = {
    ...
    "openos-base/flimflam-0.0.1-r228": {
        "EAPI": "2",
        "SLOT": "0",
        "KEYWORDS": "amd64 x86 arm",
        "RDEPEND": ">=dev-libs/D-2",
    },
    "openos-base/flimflam-0.0.2-r123": {
        "EAPI": "2",
        "SLOT": "0",
        "KEYWORDS": "~amd64 ~x86 ~arm",
        "RDEPEND": ">=dev-libs/D-3",
    },
    "openos-base/libchrome-57098-r4": {
        "EAPI": "2",
        "SLOT": "0",
        "KEYWORDS": "amd64 x86 arm",
        "RDEPEND": ">=dev-libs/E-2",
    },
    "openos-base/libcros-1": {
        "EAPI": "2",
        "SLOT": "0",
        "KEYWORDS": "amd64 x86 arm",
        "RDEPEND": "dev-libs/B dev-libs/C openos-base/flimflam",
        "DEPEND": (
            "dev-libs/B dev-libs/C openos-base/flimflam "
            "openos-base/libchrome"
        ),
    },
    "virtual/libusb-0": {
        "EAPI": "2",
...
GOLDEN_DEP_GRAPHS = {
    ...
    "openos-base/libcros-1": {
        "needs": {
            ...
            "openos-base/libchrome-57098-r4": "buildtime",
            "openos-base/flimflam-0.0.1-r228": "runtime/buildtime",
        }
    },
    "openos-base/flimflam-0.0.1-r228": {
...
class TreeInspectTest(CpuTestBase):
    ...
    def testFindUpstreamFlimflam(self) -> None:
        ...
        (ebuild, cpv, cp) = self._GenerateTestInput(
            category="openos-base", pkg_name="flimflam", ver_rev="0.0.1-r228"
        )
        result = self._TestFindUpstreamCPV(cp, ebuild)
        self.assertEqual(result, cpv)
    ...
    def testFindUpstreamFlimflamUnstable(self) -> None:
        ...
        (ebuild, cpv, cp) = self._GenerateTestInput(
            category="openos-base", pkg_name="flimflam", ver_rev="0.0.2-r123"
        )
...
class GetCurrentVersionsTest(CpuTestBase):
    ...
    def testGetCurrentVersionsOnePkgLibcros(self) -> None:
        target_pinfolist = [
            cpu.PInfo(
                package="openos-base/libcros", cpv="openos-base/libcros-1"
            )
        ]
        self._TestGetCurrentVersionsLocalCpv(target_pinfolist)
...
class GetPreOrderDepGraphTest(CpuTestBase):
    ...
    def testGetPreOrderDepGraphCrosbaseLibcros(self):
        return self._TestGetPreOrderDepGraph("openos-base/libcros")
