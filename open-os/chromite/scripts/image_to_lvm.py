...
"""Converts OPENOS disk image to LVM stateful."""
...
def create_lvm_state_partition(image_name: str) -> Iterator[Path]:
    ...
    Args:
        image_name: Name of the OPENOS image.
    ...
    with contextlib.ExitStack() as stack:
        ...
        # https://example.com/o/src/platform2/openos-common-script/share/lvm-utils.sh;l=59-64;drc=a8f359bd28881351a729cc6069f1646522b9aee3
        ...
        # https://example.com/o/src/platform2/openos-common-script/share/lvm-utils.sh;l=79;drc=a8f359bd28881351a729cc6069f1646522b9aee3
