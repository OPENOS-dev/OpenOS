...
For general Gerrit documentation, see:
  https://review.example.com/Documentation/
...
Example:
  ...
  $ gerrit reviewers 28123 foo@example.com    # Add foo@ as a reviewer on CL \
28123.
  $ gerrit reviewers 28123 ~foo@example.com   # Remove foo@ as a reviewer on \
CL 28123.
Scripting:
