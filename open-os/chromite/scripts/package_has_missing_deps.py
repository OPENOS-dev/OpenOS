...
VIRTUALS = {
    ...
    "virtual/tflite-stable-delegate-deps": (
        "openos-base/intel-npu-umd",
        "openos-base/intel-openvino",
        "openos-base/mtk-apu-firmware",
        "openos-base/mtk-apu-lib",
        "openos-base/mtk-neuron",
    ),
    "virtual/vulkan-icd": (
        "media-libs/img-ddk",
        "media-libs/img-ddk-bin",
        ...
        if lookup is None:
            ...
            for pkg in (
                ...
                if f"{pkg.category}/{pkg.package}" in (
                    "openos-base/aosp-frameworks-ml-nn-vts",
                    "openos-base/factory",
                    "sys-devel/gcc-bin",
                ):
                    continue
...
def get_parser() -> commandline.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="OPENOS board (Uses the SDK if not specified)",
    )
...
https://example.com/chromium-os/developer-library/guides/portage/\
