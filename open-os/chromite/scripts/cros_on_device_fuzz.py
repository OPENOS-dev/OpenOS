...
"""Run fuzzers on OPENOS Devices for given packages.
...
def _get_device(
    ...
    """Get OpenOSDevice host from commandline.Device collection.
    ...
    Returns:
        A remote_accessOpenOSDevice connection.
    """
    return remote_accessOpenOSDevice(
        collection.hostname,
