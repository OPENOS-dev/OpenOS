    ...
    def setUp(self) -> None:
        ...
        self.licenses = {
            ...
            "PUB": {
                ...
                "dir": "src/third_party/openos-overlay/licenses/PUB",
                "board": "foo",
                "type": self.LICENSE_CUSTOM,
            },
            "CCL": {
                "contents": "OPENOS Custom License",
                "dir": "src/private-overlays/openos-overlay/licenses/CCL",
                "board": "openos",
                "type": self.LICENSE_CUSTOM,
            },
            "CPL": {
                "contents": "OPENOS Partner License",
                "dir": (
                    "src/private-overlays/openos-partner-overlay/licenses/CPL"
                ),
                "board": "openos-partner",
                "type": self.LICENSE_CUSTOM,
            },
            "FTL": {
        ...
        overlays = [
            ...
            },
            {
                ...
                "masters": ["foo", "openos-partner"],
            },
            {
                "dir": "src/private-overlays/openos-overlay",
                "repo-name": "openos",
                "masters": ["openos", "portage-stable"],
            },
            {
                "dir": "src/private-overlays/openos-partner-overlay",
                "repo-name": "openos-partner",
                "masters": ["openos"],
            },
            {
                "dir": "src/third_party/openos-overlay",
                "repo-name": "openos",
...
"""
    ...
    def testDeprecatedLicenses(self) -> None:
        ...
        licenses_lib._CheckForKnownBadLicenses(
            "openos-base/google-sans-fonts-1-r13", {"Google-TOS"}
        )
