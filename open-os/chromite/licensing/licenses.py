...
https://example.com/chromium-os/licensing/licensing-for-openos-developers

End user (i.e. package owners) documentation is here:
https://example.com/chromium-os/licensing/licensing-for-openos-package-owners
...
If you want to check licensing against all OPENOS packages, you should
