...
Documentation on this script is also available here:
  https://example.com/chromium-os/licensing
"""
...
# fallbacks for them.
SDK_OVERLAY_DIRS = [
    "src/third_party/openos-overlay",
    "src/private-overlays/openos-overlay",
]

COPYRIGHT_ATTRIBUTION_DIR = os.path.join(
    constants.SOURCE_ROOT,
    "src/third_party/openos-overlay/licenses/copyright-attribution",
)

# Virtual packages don't need to have a license and often don't, so we skip them
# openos-base contains google platform packages that are covered by the
...
<p>
See <a href="https://example.com/chromium-os/licensing/licensing-for-openos-developers">Licensing for OPENOS Developers</a> and
<a href="https://example.com/chromium-os/licensing/licensing-for-openos-package-owners">Licensing for OPENOS Package Owners</a>
...
<a href="https://git.example.com/openos/chromite/+/HEAD/licensing/about_credits.tmpl">chromite/licensing/about_credits.tmpl</a>.
    ...
    def _GetOverrideLicense(self):
        ...
        for filename in (pv.pvr, pv.pv, pv.package):
            ...
            if os.path.exists(file_path):
                ...
                # into
                # openos-overlay/../dev-util/bsdiff
...
def _GetLicenseDirectories(
    ...
    Args:
        ...
        buildroot: The root openos path.
...
def _CheckForKnownBadLicenses(cpf, licenses) -> None:
    ...
    if "Google-TOS" in licenses:
        # Note: DO NOT ADD ANY MORE PACKAGES HERE.
        LEGACY_PKGS = {
            "openos-base/openos-board-default-apps-atlas",
            "openos-base/openos-board-default-apps-cave",
            "openos-base/openos-board-default-apps-chell",
            "openos-base/openos-board-default-apps-nocturne",
            "openos-base/openos-board-default-apps-setzer",
            "openos-base/openos-board-default-apps-snappy",
            "openos-base/openos-board-default-apps-soraka",
            "openos-base/openos-board-default-apps-terra",
            "openos-base/openos-bsp-trogdor-private",
            "openos-base/openos-chrome",
            "openos-base/openos-default-apps",
            "openos-base/openos-firmware-anx7688",
            "openos-base/fibocom-firmware",
            "openos-base/google-sans-fonts",
            "openos-base/houdini",
            "openos-base/houdini-pi",
            "openos-base/houdini-qt",
            "openos-base/intel-hdcp",
            "openos-base/monotype-fonts",
            "openos-base/qc7180-modem-firmware",
            "openos-base/sc7280-modem-firmware",
            "openos-base/modem-logger-sc",
            "openos-base/modem-fw-dlc",
            ...
            "sys-boot/openos-firmware-ps8751",
            "sys-boot/openos-vendor-strings-wilco",
    ...
    def ProcessPackageLicenses(self) -> None:
        ...
        for package_name in self.packages:
            ...
            if self.placeholder:
                ...
                pkg.homepages = ["https://example.com/"]
                continue
...
to /tmp/portage/:
https://git.example.com/openos/overlays/portage/+/gentoo
...
to third_party/openos-overlay/licenses/
...
after fixing the license."""
    ...
    def GenerateHTMLLicenseOutput(
        ...
        if os_version and milestone_version:
            env = {
                "openos-manifest-link": gs_urls_util.GsUrlToHttp(
                    "gs://openos-manifest-versions/buildspecs/"
...
def ListInstalledPackages(sysroot, all_packages=False):
    ...
    if all_packages:
        ...
        # included and shipped in OPENOS.
        ...
        # [binary     U  ] openos-base/some-package-13.0.0.133-r1 [12.0.0.77-r1]
