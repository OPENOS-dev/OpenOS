...
The dev server allows you to update your OPENOS machine with new builds
...
Note: Every time you create a OPENOS build, the URL of the dev server
...
[xBuddy for Devserver]: https://example.com/chromium-os/developer-library/reference/tools/xbuddy/
