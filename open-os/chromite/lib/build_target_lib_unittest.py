...
def test_find_overlays_public(tmp_path, monkeypatch, public) -> None:
    ...
    cros_path = tmp_path / "src" / "third_party" / "openos-overlay"
    portage_testables.Overlay(cros_path, "openos")
    ...
    openos_path = tmp_path / "src" / "private-overlays" / "openos-overlay"
    portage_testables.Overlay(openos_path, "openos")
    ...
    if not public:
        ...
        expected_overlays.add(openos_path)
