...
def test_generate_unsigned_gspaths(setup: Path) -> None:
    ...
    expected_gspaths = set(
        [
            (
                "gs://openos-image-archive/firmware-dedede-13606.B-branch-"
            ...
            (
                "gs://openos-image-archive/dedede-firmware/R*-13606.459.0/"
                "firmware_from_source.tar.bz2"
            ),
            (
                "gs://openos-image-archive/some-branch-name-branch-"
                "firmware/R*-13606.459.0/firmware_from_source.tar.bz2"
            ),
            (
                "gs://openos-image-archive/some-branch-name-branch-"
