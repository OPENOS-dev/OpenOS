...
"""Library for running OPENOS tests."""
...
class CrOSTest:
    """Class for running OPENOS tests."""
    ...
    def _Build(self) -> None:
        ...
        build_target = self.chrome_test_target or "openos_preflight"
        cros_build_lib.run(
    ...
    def _RunTastTests(self):
        ...
        cmd += [
            ...
            # 'gs://openos-prebuilt/board/amd64-host/.../
            # openos-base/tast-vars*'
