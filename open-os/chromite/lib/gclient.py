...
CHROME_COMMITTER_URL = "https://git.example.com/chromium/src"
...
def _GetGclientSolutions(internal, rev, template, managed):
    ...
    #               this custom dep here: example.com/i/3304125.
...
def WriteConfigFile(
    ...
    For gclient documentation, see:
        https://git.example.com/chromium/tools/depot_tools/+/HEAD/README.gclient.md
