...
class SysrootLibTest(cros_test_lib.MockTempDirTestCase):
    ...
    def _writeOverlays(
        ...
        By default, uses one fake board overlay, and the openos and portage
...
"""
    ...
    def testBuildTargetOverlays(self) -> None:
        ...
        overlays = expected + ["/path/to/openos-overlay"]
    ...
    def testNoBuildTargetOverlay(self) -> None:
        ...
        self._writeOverlays(["/path/to/openos-overlay", "/path/to/chipset-x"])
    ...
    def testChipset(self) -> None:
        ...
        all_overlays = chipsets + ["/path/to/openos-overlay"]
    ...
    def testNoChipset(self) -> None:
        ...
        self._writeOverlays(
            ["/path/to/openos-overlay", "/path/to/overlay-board"]
        )
