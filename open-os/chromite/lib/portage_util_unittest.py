...
"""
    ...
    def testCheckHasTestWithoutEbuild(self) -> None:
        ...
        package_name = "openos-base/temp_mypackage"
...
class ProjectAndPathTest(cros_test_lib.MockTempDirTestCase):
    ...
    def _MockParseWorkonVariables(
        ...
        # We need 'openos-base' here because it controls default _SUBDIR
        # values.
...
class EBuildRevWorkonTest(cros_test_lib.MockTempDirTestCase):
    ...
    def testNoVersionScript(self) -> None:
        """Verify default behavior with no openos-version.sh script."""
        self.assertEqual("1234", self.m_ebuild.GetVersion(None, None, "1234"))

    def testValidVersionScript(self) -> None:
        """Verify normal behavior with a openos-version.sh script."""
...
class FindOverlaysTest(cros_test_lib.MockTempDirTestCase):
    ...
    def setUp(self) -> None:
            ...
            D(
                ...
                (
                    ...
                    D(
                        "third_party",
                        (
                            D("openos-overlay", overlay_files),
        ...
        osutils.WriteFile(
            conf_path % {"overlay": "openos-overlay"},
            conf_data % {"repo-name": "openos", "masters": ""},
        )
        osutils.WriteFile(
...
class GetOverlayEBuildsTest(cros_test_lib.MockTempDirTestCase):
    ...
    def testWantedPackage(self) -> None:
        ...
        package_name = "openos-base/mypackage"
    ...
    def testAnyPackage(self) -> None:
        ...
        package_name = "openos-base/package_name"
        self._CreatePackage(package_name)
    ...
    def testUnknownPackage(self) -> None:
        ...
        self._CreatePackage("openos-base/package_name")
        ebuilds = portage_util.GetOverlayEBuilds(
            self.overlay, False, ["openos-base/other_package"]
        )
    ...
    def testManuallyUprevedPackagesIgnoredByDefault(self) -> None:
        ...
        package_name = "openos-base/manuallyuprevved_package"
...
class ProjectMappingTest(cros_test_lib.TestCase):
    ...
    def testSplitEbuildPath(self) -> None:
        ...
        ebuild_path = "openos-base/platform2/platform2-9999.ebuild"
        components = ["openos-base", "platform2", "platform2-9999"]
    ...
    def testFindWorkonProjects(self) -> None:
        ...
        frecon_project = "openos/platform/frecon"
        dev_install = "openos-base/dev-install"
        dev_install_project = "openos/platform2"
        matches = [
...
class FindEbuildTest(cros_test_lib.RunCommandTestCase):
    ...
    def testFindEbuildsForPackagesReturnResultsSimple(self) -> None:
        equery_output = (
            "/openos-overlay/misc/foo/foo.ebuild\n"
            "/openos-overlay/misc/bar/bar.ebuild\n"
        )
        ...
        self.assertEqual(
            ...
            {
                "misc/bar": "/openos-overlay/misc/bar/bar.ebuild",
                "misc/foo": "/openos-overlay/misc/foo/foo.ebuild",
            },
        )
    ...
    def testFindEbuildsForPackagesWithoutCategoryReturnResults(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                "bar": "/openos-overlay/misc/bar/bar.ebuild",
                "misc/foo": "/openos-overlay/misc/foo/foo.ebuild",
            },
        )
    ...
    def testFindEbuildsForPackagesReturnNone(self) -> None:
        ...
        equery_output = "/openos-overlay/bar/bar.ebuild\n"
        self.rc.AddCmdResult(
    ...
    def testFindEbuildsForPackagesInvalidEbuildsOrder(self) -> None:
        equery_output = (
            "/openos-overlay/bar/bar.ebuild\n"
            "/openos-overlay/foo/foo.ebuild\n"
        )
        self.rc.AddCmdResult(
            ["equery", "--no-color", "--no-pipe", "which", "foo", "bar"],
            stdout=equery_output,
    ...
    def testFindEbuildForPackageReturnResults(self) -> None:
        equery_output = "/openos-overlay/misc/foo/foo-9999.ebuild\n"
        self.rc.AddCmdResult(
        ...
        self.assertEqual(
            ...
            "/openos-overlay/misc/foo/foo-9999.ebuild",
        )
...
class FindOverlaysForPackagesTest(cros_test_lib.RunCommandTestCase):
    ...
    def testFindOverlaysForPackagesSimple(self) -> None:
        ...
        self.assertEqual(overlays, ["portage-stable", "openos"])
...
class GetReverseDependenciesTest(cros_test_lib.RunCommandTestCase):
    ...
    def testGetReverseDependencies(self) -> None:
        expected = [
            ...
            package_info.parse("openos-base/openos-base-1-r11"),
...
class AnalyzeEmergeFailureTest(cros_test_lib.TestCase):
    ...
    def testSlotConflictErrors(self):
        ...
        self.assertEqual(result[0].pkg, "openos-base/patchpanel:0")
        self.assertEqual(
            result[0].kind, portage_util.ErrorKind.MULTI_VERSION_CONFLICT
        )
        self.assertEqual(result[1].pkg, "openos-base/system_api:0")
        self.assertEqual(
        ...
        self.assertListEqual(
            ...
            [
                portage_util.PortageError(
                    ...
                    pkg="sys-kernel/linux-firmware-0.0.1-r701::openos",
                    reason=reason,
                ),
            ],
        )
...
openos-base/system_api:0 for /build/octopus/

  (openos-base/system_api-0.0.1-r5420:0/0.0.1-r5420::openos, installed in '/build/octopus/') pulled in by
    openos-base/system_api:0/0.0.1-r5420= required by (openos-base/libiioservice_ipc-0.0.1-r490:0/0.0.1-r490::openos, binary scheduled for merge to '/build/octopus/')
                            ^^^^^^^^^^^^^^^
    (and 38 more with the same problem)

  (openos-base/system_api-0.0.1-r5419:0/0.0.1-r5419::openos, binary scheduled for merge to '/build/octopus/') pulled in by
    openos-base/system_api:0/0.0.1-r5419= required by (openos-base/patchpanel-client-0.0.1-r707:0/0.0.1-r707::openos, binary scheduled for merge to '/build/octopus/')
                            ^^^^^^^^^^^^^^^
    (and 3 more with the same problem)

openos-base/patchpanel:0 for /build/octopus/

  (openos-base/patchpanel-0.0.2-r1054:0/0.0.2-r1054::openos, ebuild scheduled for merge to '/build/octopus/') pulled in by
    (no parents that aren't satisfied by other packages in this slot)

  (openos-base/patchpanel-0.0.2-r1052:0/0.0.2-r1052::openos, binary scheduled for merge to '/build/octopus/') pulled in by
    openos-base/patchpanel:0/0.0.2-r1052= required by (openos-base/dns-proxy-0.0.1-r699:0/0::openos, binary scheduled for merge to '/build/octopus/')
                            ^^^^^^^^^^^^^^^
...
!!! The following binary packages have been ignored due to non matching USE:
    ...
    =openos-base/openos-firmware-null-0.0.3-r197 -cros_ec -has_openos_config_bsp_private # for /build/octopus/
...
- media-sound/adhd-0.0.7-r3267::openos (masked by: package.mask)

(dependency required by "openos-base/power_manager-0.0.2-r4956::openos" [binary])
(dependency required by "openos-base/update_engine-0.0.3-r4786::openos" [binary])
(dependency required by "virtual/target-chromium-os-1-r265::openos" [installed])
(dependency required by "virtual/target-chrome-os-1.3-r45::openos" [installed])
(dependency required by "virtual/target-os-1.3-r3::openos" [ebuild])
...
!!! The following binary packages have been ignored due to non matching USE:
    ...
    =openos-base/cros-camera-0.0.1-r1805 -arcvm -cheets # for /build/kukui64/
...
(dependency required by "virtual/target-chromium-os-1-r265::openos" [ebuild])
(dependency required by "virtual/target-chrome-os-1.3-r45::openos" [ebuild])
(dependency required by "virtual/target-os-1.3-r3::openos" [ebuild])
(dependency required by "virtual/target-os" [argument])
"""
...
!!! The following binary packages have been ignored due to non matching USE:
    ...
    =openos-base/trunks-0.0.1-r3602 -cr50_onboard cros-debug tpm2_simulator # for /build/brya-cbx/
    =openos-base/trunks-0.0.1-r3602 -cr50_onboard cros-debug tpm2_simulator # for /build/brya-cbx/
...
emerge: there are no ebuilds built with USE flags to satisfy "openos-base/trunks:=[test?]" for /build/brya-cbx/.
!!! One of the following packages is required to complete your request:
- openos-base/trunks-0.0.1-r3602::openos (Change USE: +test)
(dependency required by "openos-base/libhwsec-0.0.1-r869::openos[-test]" [ebuild])
