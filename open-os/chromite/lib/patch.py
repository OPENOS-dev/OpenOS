# Copyright 2011-2012 OCS (Open Code Studio)
...
def ParseFullChangeID(text, error_ok=True):
    ...
    Full change-ID format: project~branch~change-id. E.g.
      openos/chromite~master~I47ea30385af60ae4cc2acc5d1a283a46423bc6e1
...
class LocalPatch(GitRepoPatch):
    ...
    def Upload(
        ...
        for num, line in enumerate(lines):
            ...
            # remote: New Changes:
            # remote:  https://review.example.com/36756 Enforce...
...
class GerritPatch(GerritFetchOnlyPatch):
    ...
    def __init__(self, patch_dict, remote, url_prefix) -> None:
        ...
        https://review.example.com/Documentation/json.html
    ...
    def ConvertQueryResults(change, host):
        ...
        New interface:
            https://review.example.com/Documentation/rest-api-changes.html#json-entities
        """
        try:
