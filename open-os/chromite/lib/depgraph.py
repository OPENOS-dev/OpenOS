...
class DepGraphGenerator:
    ...
    def GenDependencyTree(self, with_roots: bool = False):
        ...
        for node, node_deps in digraph.nodes.items():
            ...
            #
            # Here's an example CPV: openos-base/power_manager-0.0.1-r1
            # Split up, this CPV would be:
            #   C -- Component: openos-base
            ...
            # destined for ROOT, then (in the OPENOS build) we must be
            ...
            # The only packages that will have a distinct root (in the OPENOS
