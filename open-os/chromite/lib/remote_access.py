...
class DefaultDeviceError(RemoteAccessException):
    """Raised when a default OpenOSDevice can't be found."""
    ...
    def __init__(
        ...
        Args:
            remote_host: The ip or hostname of the remote test machine.  The
                test machine should be running a OPENOS test image.
...
class OpenOSDeviceHandler:
    """A wrapper of OpenOSDevice."""

    def __init__(self, *args, **kwargs) -> None:
        """Creates a RemoteDevice object."""
        self.device = OpenOSDevice(*args, **kwargs)
...
class OpenOSDevice(RemoteDevice):
    """Basic commands to interact with a OPENOS device over SSH."""
