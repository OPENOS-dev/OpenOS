...
def test_query_ebuilds(fake_build_query_overlays) -> None:
    ...
    assert found_packages == {
        "openos-base/openos-bsp-fake-0.0.1-r256::fake",
        "openos-base/openos-bsp-fake-9999::fake",
        "openos-base/openos-bsp-fake-private-0.0.1::fake-private",
        "openos-base/openos-bsp-fake-private-9999::fake-private",
    }
    assert all(x.eapi == 7 for x in ebuilds)
    assert all(x.eclasses == ["cros-workon", "openos-bsp"] for x in ebuilds)
...
@pytest.mark.parametrize(
    ...
    [
        (
            "openos-base/openos-bsp-fake-0.0.1-r256",
            "amd64",
            build_query.Stability.STABLE,
        ),
        (
            "openos-base/openos-bsp-fake-9999",
            "amd64",
            build_query.Stability.UNSTABLE,
        ),
        (
            "openos-base/openos-bsp-fake-private-0.0.1",
            "amd64",
            build_query.Stability.UNSTABLE,
        ),
        (
        ...
        (
            "openos-base/openos-bsp-fake-private-9999",
            "arm",
            build_query.Stability.UNSTABLE,
        ),
        (
