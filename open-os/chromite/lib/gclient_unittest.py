...
"""
  ...
  'managed': True,
  'name': 'src',
  'url': 'https://git.example.com/chromium/src.git@7becbe4afb42b3301d42149d7d1cade017f150ff'}]
target_os = ['openos']
cache_dir = '/b/git-cache'
"""
...
"""
  ...
  'managed': True,
  'name': 'src',
  'url': 'https://git.example.com/chromium/src.git@HEAD'}]
target_os = ['openos']
cache_dir = '/b/git-cache'
"""
        # pylint: enable=line-too-long
...
"""
  ...
  'managed': True,
  'name': 'CHROME_DEPS',
  'url': 'https://git.example.com/chrome/tools/buildspec.git'}]
target_os = ['openos']
cache_dir = '/b/git-cache'
"""
        )
  ...
  'managed': True,
  'name': 'src',
  'url': 'https://git.example.com/chromium/src.git@41.0.2270.0'}]
target_os = ['openos']
cache_dir = '/b/git-cache'
"""
        )
...
"""
  ...
  'managed': True,
  'name': 'src',
  'url': 'https://git.example.com/chromium/src.git@91.0.2431.1'}]
target_os = ['openos']
cache_dir = '/b/git-cache'
"""
        )
