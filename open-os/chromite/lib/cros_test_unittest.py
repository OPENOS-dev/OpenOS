...
class CrOSTester(CrOSTesterBase):
    ...
    def testFlashChromeCheckout(self) -> None:
        ...
        # Flashing a public image should use gs://openos-image-archive/
        self._tester.flash = True
        self._tester.public_image = True
        self._tester._device.board = "octopus"
        self._tester.Run()
        self.assertCommandContains(
            [
                ...
                "flash",
                "ssh://localhost:9222",
                "gs://openos-image-archive/octopus-public/12345.0.0",
            ]
        )

        # Flashing an internal image should use gs://openos-image-archive/
        ...
        self.assertCommandContains(
            [
                ...
                "flash",
                "ssh://localhost:9222",
                "gs://openos-image-archive/octopus-release/12345.0.0",
            ]
        )
