...
class StatefulUpdaterTest(cros_test_lib.MockTempDirTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.StartPatcher(OpenOSDeviceMock())
    ...
    def testTargetStatefulUpdateFileDoNotExist(self) -> None:
        ...
        with remote_accessOpenOSDeviceHandler(
