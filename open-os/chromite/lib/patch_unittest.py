...
FAKE_PATCH_JSON = {
    ...
    "owner": {
        "name": "Chromite main",
        "email": "chromite@example.com",
    },
    "url": "https://review.example.com/1112",
...
FAKE_GERRIT_ACCT_JSON = {
    ...
    "email": "happy-funky-duck@example.com",
    "name": "Duckworth Duck",
}
        ...
        "be54f9935bedb157b078eefa26fc1885b8264da6": {
            ...
            "fetch": {
                "http": {
                    ...
                    "url": "https://git.example.com/example/repo",
                },
                "repo": {
                    "ref": "refs/changes/15/8366/1",
                    "url": "example/repo",
...
class TestGerritFetchOnlyPatch(cros_test_lib.MockTestCase):
    ...
    def testFromAttrDict(self) -> None:
        ...
        attr_dict_without_msg = {
            ...
            cros_patch.ATTR_OWNER_EMAIL: "foo@example.com",
...
class MockPatchFactory:
    ...
    def MockPatch(
        ...
        patch_dict = {
            ...
            "subject": subject,
            "owner": {"email": "elmer.fudd@example.com"},
            "remote": remote,
