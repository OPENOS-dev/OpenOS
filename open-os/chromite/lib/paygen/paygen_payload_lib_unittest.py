...
class PaygenLibTest(cros_test_lib.RunCommandTempDirTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.old_image = gspaths.Image(
            ...
            key="mp-v3",
            uri=(
                "gs://openos-releases/dev-channel/x86-alex/1620.0.0/"
                "openos_1620.0.0_x86-alex_recovery_dev-channel_mp-v3.bin"
            ),
        )
        ...
        self.old_base_image = gspaths.Image(
            ...
            uri=(
                "gs://openos-releases/dev-channel/x86-alex/1620.0.0/"
                "openos_1620.0.0_x86-alex_base_dev-channel_mp-v3.bin"
            ),
        )
        ...
        self.new_image = gspaths.Image(
            ...
            key="mp-v3",
            uri=(
                "gs://openos-releases/dev-channel/x86-alex/4171.0.0/"
                "openos_4171.0.0_x86-alex_recovery_dev-channel_mp-v3.bin"
            ),
        )
        ...
        self.new_dlc_image = gspaths.DLCImage(
            ...
            uri=(
                "gs://openos-releases/dev-channel/x86-alex/4171.0.0/dlc/"
        ...
        self.old_dlc_image = gspaths.DLCImage(
            ...
            dlc_package="sample-package",
            uri=(
                "gs://openos-releases/dev-channel/x86-alex/1620.0.0/dlc/"
                "sample-dlc/sample-package/dlc.img"
            ),
        )
        ...
        self.old_test_image = gspaths.UnsignedImageArchive(
            ...
            uri=(
                "gs://openos-releases/dev-channel/x86-alex/1620.0.0/"
                "openos_1620.0.0_x86-alex_recovery_dev-channel_test.bin"
            ),
        )
        ...
        self.new_test_image = gspaths.Image(
            ...
            uri=(
                "gs://openos-releases/dev-channel/x86-alex/4171.0.0/"
                "openos_4171.0.0_x86-alex_recovery_dev-channel_test.bin"
            ),
        )
...
class PaygenPayloadLibBasicTest(PaygenLibTest):
    ...
    def testVerifyPayloadPublicKey(self) -> None:
        ...
        payload.build.bucket = "gs://openos-release-test"
