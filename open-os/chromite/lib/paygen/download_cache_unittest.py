...
class DownloadCacheTest(cros_test_lib.TempDirTestCase):
    ...
    uri_large = "gs://openos-releases-test/download_cache/file_large"
    uri_a = "gs://openos-releases-test/download_cache/file_a"
    uri_b = "gs://openos-releases-test/download_cache/file_b"
