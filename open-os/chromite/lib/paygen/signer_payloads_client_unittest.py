...
from chromite.api.gen.openos import build_report_pb2
from chromite.api.gen.openos import common_pb2
from chromite.api.gen.openos import signing_pb2
...
class SignerPayloadsClientIntegrationTest(cros_test_lib.MockTempDirTestCase):
    ...
    def setUp(self) -> None:
        # This is in the real production openos-releases, but the listed
    ...
    def testDownloadSignatures(self) -> None:
        ...
        uris = [
            b"gs://openos-releases-test/sigining-test/foo",
            b"gs://openos-releases-test/sigining-test/bar",
        ]
    ...
    def testGetHashSignatures(self) -> None:
        ...
        clean_uri = (
            "gs://openos-releases/test-channel/%s/crostools-client/**"
...
class LocalSignerPayloadsClientTest(cros_test_lib.TempDirTestCase):
    ...
    def setUp(self) -> None:
        """Setup for tests, and store off some standard expected values."""
        self._docker_image = (
            "us-docker.pkg.dev/openos-release-bot/signing/signing:16963491"
        )
