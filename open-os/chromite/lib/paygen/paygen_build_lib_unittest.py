...
class BasePaygenBuildLibTestWithBuilds(cros_test_lib.MockTempDirTestCase):
    ...
    def testDefaultPayloadUri(self) -> None:
        ...
        self.assertEqual(
            ...
            "openos_1.2.3_foo-board_foo-channel_full_mp-v2.bin-abc123.signed",
        )
        ...
        self.assertEqual(
            result,
            "gs://crt/foo-channel/foo-board/1.2.3/payloads/openos_1.0.0-1"
        ...
        self.assertEqual(
            ...
            "openos_3588.0.0-3590.0.0_x86-alex-he_stable-channel_delta_mp-v3"
            ".bin-abc123.signed",
        )
