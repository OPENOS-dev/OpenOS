...
"""Utilities for building OPENOS kernels.
...
class Builder:
    ...
    def _CreateCustomKernelInternal(
        ...
        # 1. Build/Update openos-initramfs package.
        logging.info("Ensuring openos-initramfs package is up-to-date.")
        initramfs_pkg = "openos-base/openos-initramfs"
        try:
        ...
        try:
            # Find the actual kernel package name (e.g., openos-kernel-5_15).
