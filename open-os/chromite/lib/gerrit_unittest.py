...
default, this server is t3st-chr0m3-review.example.com. These tests will
...
class GerritTestCase(cros_test_lib.MockTempDirTestCase):
    ...
    t3st-chr0m3(-review).example.com. The test server configuration may be
    ...
    def _create_gerrit_instance(self, tmp_dir):
        ...
        gerrit_host = os.environ.get(
            "CROS_TEST_GERRIT_HOST", "%s-review.example.com" % default_host
        )
...
class GerritHelperTest(GerritTestCase):
    ...
    def _ChooseReviewers(self):
        ...
        return ["dborowitz@example.com", "jrn@example.com"]
