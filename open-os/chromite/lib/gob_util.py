...
https://review.example.com/Documentation/rest-api.html
"""
...
def _QueryString(param_dict, first_param=None):
    ...
    https://review.example.com/Documentation/rest-api-changes.html#list-changes
    """
...
def GetSsoConfig(host: str) -> Tuple[Dict[str, str], Dict[str, str], str]:
    ...
    git_host = f"{gob}.git.example.com"
...
def CreateHttpReq(
    ...
    try:
        ...
        if cookies and sso_headers:
            ...
            host = host.replace("example.com", "git.example.com")
...
def QueryChanges(
    ...
    Args:
        ...
        param_dict: A dictionary of search parameters, as documented here:
            https://review.example.com/Documentation/user-search.html
