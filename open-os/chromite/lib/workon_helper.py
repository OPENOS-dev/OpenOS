...
def _IsWorkonEbuild(include_chrome, ebuild_path, ebuild_contents=None):
    ...
    """
    # TODO(rcui): remove special casing of openos-chrome here when we make it
...
def ListAllWorkedOnAtoms():
    ...
    Returns:
        Dictionary of atoms marked as worked on (e.g. ['openos-base/shill'])
        for each system.
    """
...
class WorkonHelper:
    ...
    def _GetWorkonEbuilds(
        ...
        Args:
            ...
            filter_on_arch: True iff we should only return ebuilds which are
                ...
                interested in.
            include_chrome: True iff we should also include openos-chrome and
    ...
    def ListAtoms(self, use_all=False, use_workon_only=False):
        ...
        Returns:
            a list of atoms (e.g. ['openos-base/shill', 'sys-apps/dbus']).
        """
