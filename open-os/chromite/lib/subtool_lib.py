...
https://example.com/o/src/config/proto/openos/build/api/subtools.proto
"""
...
# https://example.com/i/go/src/go.chromium.org/luci/cipd/common/common.go
...
_DEFAULT_CIPD_PREFIX = "openos/infra/tools"
    ...
    def _upload_bundle(
        ...
        if metadata.cipd_package.package:
            ...
            if not use_production:
                bucket_override = "openos-throw-away-bucket"
