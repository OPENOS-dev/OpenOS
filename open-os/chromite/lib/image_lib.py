...
"""Utilities for manipulating OPENOS images."""
...
def _ParseParted(lines):
    ...
    #   /foo/openos_qemu_image.bin:3360MB:file:512:512:gpt:;
...
def GetBuildImageEnvvars(
    image_names: Set[str],
    board: str,
    version_info: Optional[openos_version.VersionInfo] = None,
    ...
    Args:
        ...
        version_info: OPENOS version information that needs to be populated.
