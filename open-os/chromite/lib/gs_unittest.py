...
Uploading   gs://openos-throw-away-bucket/vapier/null:         0 B    \r\
Uploading   gs://openos-throw-away-bucket/vapier/null:         0 B    \r\
...
class LSTest(AbstractGSContextTest):
    ...
    def testListFunkyChars(self) -> None:
        ...
        pfx = "gs://openos-localmirror/distfiles/openos-firmware-pit"
        self.gs_mock.SetDefaultCmdResult(
            stdout=f"""\
...
class CopyTest(AbstractGSContextTest, cros_test_lib.TempDirTestCase):
    ...
    def testGeneration404(self) -> None:
        ...
        stderr = (
            ...
            "gs://openos-releases/tobesigned/50,beta-\n"
            "channel,mccloud,6158.66.0,OPENOS-\n"
...
class GSRetryFilterTest(cros_test_lib.TestCase):
    ...
    LOCAL_PATH = "/tmp/file"
    REMOTE_PATH = (
        "gs://openos-prebuilt/board/beltino/paladin-R33-4926.0.0"
        "-rc2/packages/openos-base/autotest-tests-0.0.1-r4679.tbz2"
    )
...
class GSContextTest(AbstractGSContextTest):
    ...
    URL = "gs://openos-image-archive/x86-mario-release/R17-1413.0.0-a1-b1346"
    FILE_NAME = "openos_R17-1413.0.0-a1_x86-mario_full_dev.bin"
