# Copyright 2013 OCS (Open Code Studio)
...
"""
    ...
    def testGetUrlFromRemoteOutput(self) -> None:
        ...
        remote_output = (
            "remote:\nremote:\nremote:   "
            "https://chrome-internal-review.example.com/c/openos/"
...
Reviewed-on: https://review.example.com/c/openos/chromite/+/2040633
Reviewed-by: Mike Frysinger <vapier@example.com>
Commit-Queue: François Degros <fdegros@example.com>
Tested-by: François Degros <fdegros@example.com>
"""
        result = cros_build_lib.CompletedProcess(stdout=log_output)
        self.PatchObject(git, "RunGit", return_value=result)
...
class RawDiffTest(cros_test_lib.MockTestCase):
    ...
    def testRawDiff(self) -> None:
        ...
        # pylint: disable=line-too-long
        diff_output = """
:100644 100644 ac234b2... 077d1f8... M\topenos-base/openos-chrome/Manifest
:100644 100644 9e5d11b... 806bf9b... R099\topenos-base/openos-chrome/openos-chrome-40.0.2197.0_rc-r1.ebuild\topenos-base/openos-chrome/openos-chrome-40.0.2197.2_rc-r1.ebuild
:100644 100644 70d6e94... 821c642... M\topenos-base/openos-chrome/openos-chrome-9999.ebuild
:100644 100644 be445f9... be445f9... R100\topenos-base/chromium-source/chromium-source-40.0.2197.0_rc-r1.ebuild\topenos-base/chromium-source/chromium-source-40.0.2197.2_rc-r1.ebuild
:100644 100644 d02943a... 114bc47... M\topenos-base/openos-chrome/User Data.txt
"""
        # pylint: enable=line-too-long
        ...
        self.assertEqual(
            ...
            [
                (
                    ...
                    "M",
                    None,
                    "openos-base/openos-chrome/Manifest",
                    None,
                    [],
                    [],
                ),
                (
                    ...
                    "openos-chrome-40.0.2197.0_rc-r1.ebuild",
                    "openos-base/openos-chrome/"
                    "openos-chrome-40.0.2197.2_rc-r1.ebuild",
                    [],
                    [],
                ),
                (
                    ...
                    "M",
                    None,
                    "openos-base/openos-chrome/openos-chrome-9999.ebuild",
                    None,
                    [],
                    [],
                ),
                ...
                (
                    ...
                    "M",
                    None,
                    "openos-base/openos-chrome/User Data.txt",
                    None,
                    [],
                    [],
                ),
