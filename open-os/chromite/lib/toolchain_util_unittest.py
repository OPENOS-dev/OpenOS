...
class ProfilesNameHelperTest(cros_test_lib.MockTempDirTestCase):
    ...
    def testParseBenchmarkProfileName(self) -> None:
        ...
        # Test parse success
        profile_name = "openos-chrome-amd64-77.0.3849.0_rc-r1.afdo"
        ...
        # Test Arm parsing.
        profile_name = "openos-chrome-arm-77.0.3849.0_rc-r1.afdo"
        result = toolchain_util._ParseBenchmarkProfileName(profile_name)
        self.assertEqual(
            result,
            toolchain_util.BenchmarkProfileVersion(
    ...
    def testExtractChromeVersionFromDebugFileNameWorks(self) -> None:
        result = toolchain_util._ExtractChromeVersionFromDebugFileName(
            "openos-chrome-amd64-130.0.6700.0_rc-r1.debug.bz2"
        )
        self.assertEqual(
            "130.0.6700.0_rc-r1",
            result.version_rc,
        ...
        with self.assertRaises(ValueError):
            toolchain_util._ExtractChromeVersionFromDebugFileName(
                "openos-chrome-amd64-130.0.6700.0.debug.bz2"
            )

        # Missing openos-chrome prefix.
        with self.assertRaises(ValueError):
            toolchain_util._ExtractChromeVersionFromDebugFileName(
    ...
    def testParseMergedProfileName(self) -> None:
        ...
        afdo_name = (
            "openos-chrome-amd64-atom-77-3809.38-1562580965"
        ...
        afdo_name = (
            "openos-chrome-arm-none-77-3809.38-1562580965"
            "-benchmark-77.0.3849.0-r1-redacted.afdo.xz"
        )
        result = toolchain_util._ParseMergedProfileName(afdo_name)
        self.assertEqual(
    ...
    def testRemoveVersionSuffixes(self) -> None:
        self.assertEqual(
            toolchain_util._RemoveVersionSuffixes(
                package_info.parse(
                    "openos-base/openos-chrome-79.0.3900.0_rc-r1"
                ).version
            ),
            "79.0.3900.0",
        )
        self.assertEqual(
            toolchain_util._RemoveVersionSuffixes(
                package_info.parse(
                    "openos-base/openos-chrome-79.0.3900.0_pre123_rc-r1"
                ).version
            ),
            "79.0.3900.0",
        )
        self.assertEqual(
            toolchain_util._RemoveVersionSuffixes(
                package_info.parse(
                    "openos-base/openos-chrome-79.0.3900.0-r1"
                ).version
            ),
            "79.0.3900.0",
        )
...
class PrepareBundleTest(cros_test_lib.RunCommandTempDirTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.chrome_package = "openos-chrome"
        self.kernel_package = "openos-kernel-3_18"
        self.profile_info = {"arch": "amd64"}
        self.chrome_PV = "openos-base/openos-chrome-78.0.3893.0_rc-r1"
        ...
        self.data = (
            b"openos-chrome-amd64-atom-77-3809.38-1562580965"
...
class CommonPrepareBundleTest(PrepareBundleTest):
    ...
    def testGetEbuildInfo(self) -> None:
        ...
        self.glob.return_value = ["openos-chrome-96.0.4657.0_rc-r2.ebuild"]
        ret = self.obj._GetEbuildInfo("openos-chrome")
        ...
        self.assertEqual(ret.CPV.category, "openos-base")
        self.assertEqual(ret.CPV.package, "openos-chrome")
        self.glob.assert_called_once()

    def testGetEbuildInfoWithoutRevision(self) -> None:
        """Verify that EbuildInfo is correctly returned."""
        self.glob.return_value = ["openos-chrome-96.0.4657.0_rc.ebuild"]
        ret = self.obj._GetEbuildInfo("openos-chrome")
    ...
    def testGetEbuildInfoWithMultipleChromes(self) -> None:
        self.glob.return_value = [
            "openos-chrome-78.0.3893.0.ebuild",
            "openos-chrome-78.0.3893.0_rc-r1.ebuild",
            "openos-chrome-78.0.3893.100_rc-r1.ebuild",
            "openos-chrome-78.0.3893.10_rc-r1.ebuild",
            "openos-chrome-78.0.3893.10_pre1234_rc-r2.ebuild",
        ]
        ret = self.obj._GetEbuildInfo("openos-chrome")
    ...
    def test_GetArtifactVersionInGob(self) -> None:
        ...
        self.fetch.assert_called_once_with(
            ...
            "chromium/src/+/refs/tags/%s/openos/profiles/%s.afdo.newest.txt"
...
class PrepBundLatestAFDOArtifactTest(PrepareBundleTest):
    ...
    def setUp(self) -> None:
        ...
        files_in_gs_bucket = [
            # Benchmark profiles
            ("openos-chrome-arm-78.0.3892.0_rc-r1.afdo.bz2", 1.0),
            ("openos-chrome-amd64-78.0.3893.0_rc-r1.afdo.bz2", 2.0),
            ("openos-chrome-amd64-78.0.3896.0_rc-r1.afdo.bz2", 1.0),  # Latest
            ("openos-chrome-amd64-78.0.3897.0_rc-r1-merged.afdo.bz2", 3.0),
            # CWP profiles
    ...
    def testFindLatestAFDOArtifactPassWithBenchmarkAfdo(self) -> None:
        ...
        self.assertEqual(
            latest_afdo,
            os.path.join(
                self.gs_url, "openos-chrome-amd64-78.0.3896.0_rc-r1.afdo.bz2"
            ),
        )
    ...
    def testFindLatestAFDOArtifactPassWithBenchmarkAfdoArm(self) -> None:
        ...
        self.assertEqual(
            latest_afdo,
            os.path.join(
                self.gs_url, "openos-chrome-arm-78.0.3892.0_rc-r1.afdo.bz2"
            ),
        )

    def testFindLatestAfdoArtifactOnPriorBranch(self) -> None:
        """Test that we find a file from prior branch when we have none."""
        self.obj._ebuild_info["openos-chrome"] = toolchain_util._EbuildInfo(
            path="path",
        ...
        self.assertEqual(
            ...
            os.path.join(
                self.gs_url,
                "openos-chrome-amd64-78.0.3896.0_rc-r1.afdo.bz2",
            ),
        )
    ...
    def testFindLatestAFDOArtifactFailToFindAnyFiles(self) -> None:
        ...
        self.obj._ebuild_info["openos-chrome"] = toolchain_util._EbuildInfo(
            path="path",
            CPV=package_info.parse(
                "openos-base/openos-chrome-80.0.3950.0_rc-r1"
            ),
        )
    ...
    def testFindLatestAFDOArtifactsFindMaxFromInvalidFiles(self) -> None:
        ...
        mock_gs_list = [
            self.MockListResult(
                ...
                url=os.path.join(
                    self.gs_url, "openos-chrome-amd64-78.afdo.bz2"
                ),
                creation_time=1.0,
            )
        ]
...
class PrepareForBuildHandlerTest(PrepareBundleTest):
    ...
    def setUp(self) -> None:
        ...
        self.verified_afdo_name = (
            f"openos-chrome-amd64-atom-78-3876.0-{self.week_old_ts}-"
    ...
    def testPrepareUnverifiedChromeBenchmarkAfdoFileExists(self) -> None:
        ...
        self.gsc_ls.side_effect = (
            [
                ...
                "openos-chrome-amd64-1.2.3.4_rc-r1.debug"
            ],
        )
        ...
        expected_exists = [
            mock.call(
                "gs://path/to/unvetted/"
                "openos-chrome-amd64-1.2.3.4_rc-r1.afdo.bz2"
            ),
        ]
        expected_ls = [
            mock.call(
                "gs://image-archive/path/openos-chrome-amd64-*.debug.bz2"
            ),
        ]
        expected_list = [
            mock.call(
                "gs://path/to/perfdata/"
                "openos-chrome-amd64-1.2.3.4*.perf.data.bz2",
                details=True,
            ),
        ]
    ...
    def testPrepareUnverifiedChromeBenchmarkArmAfdoFile(self) -> None:
        ...
        self.gsc_ls.side_effect = (
            [
                "gs://image-archive/path/to/"
                "openos-chrome-arm-4.3.2.1_rc-r2.debug"
            ],
        )
        self.gsc_list.side_effect = (
            [
        ...
        expected_exists = [
            mock.call(
                "gs://path/to/unvetted/"
                "openos-chrome-arm-4.3.2.1_rc-r2.afdo.bz2"
            ),
        ]
        expected_ls = [
            mock.call(
                "gs://image-archive/path/openos-chrome-arm-*.debug.bz2"
            ),
        ]
        expected_list = [
            mock.call(
                "gs://path/to/perfdata/"
                "openos-chrome-arm-4.3.2.1*.perf.data.bz2",
                details=True,
            ),
        ]
        self.assertEqual(expected_exists, self.gs_context.Exists.call_args_list)
    ...
    def testPrepareUnverifiedChromeBenchmarkAfdoFileMissingDebug(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            r'"openos-chrome-amd64-\*.debug.bz2" in '
    ...
    def testPrepareUnverifiedChromeBenchmarkAfdoFileMissingPerf(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            r'"openos-chrome-amd64-1.2.3.4\*.perf.data.bz2" '
    ...
    def callPrepareVerifiedKernelCwpAfdoFile(
        ...
        kernel_package = "sys-kernel/openos-kernel-5_15-5.15.12-r1234"
        ...
        if toolchain_util.BENCHMARK_AFDO_GS_URL in gs_urls:
            if arch == "amd64":
                return os.path.join(
                    ...
                    "openos-chrome-amd64-78.0.3839.0_rc-r1.afdo.bz2",
                )
            if arch == "arm":
                return os.path.join(
                    toolchain_util.BENCHMARK_AFDO_GS_URL,
                    "openos-chrome-arm-78.0.3840.0_rc-r1.afdo.bz2",
                )
        ...
        expected_exists = [
            mock.call(
                os.path.join(
                    ...
                    (
                        "openos-chrome-amd64-atom-78-3876.0-"
        ...
        self.patch_ebuild.assert_called_once_with(
            self.obj._GetEbuildInfo(toolchain_util.constants.CHROME_PN),
            {
                "UNVETTED_AFDO_FILE": os.path.join(
                    ...
                    "tmp",
                    (
                        f"openos-chrome-arm-none-78-3879.0-{self.day_old_ts}-"
        ...
        self.patch_ebuild.assert_called_once_with(
            self.obj._GetEbuildInfo(toolchain_util.constants.CHROME_PN),
            {
                "UNVETTED_AFDO_FILE": os.path.join(
                    ...
                    "tmp",
                    (
                        "openos-chrome-arm-arm32-78-3879.0-"
        ...
        self.patch_ebuild.assert_called_once_with(
            self.obj._GetEbuildInfo(toolchain_util.constants.CHROME_PN),
            {
                "UNVETTED_AFDO_FILE": os.path.join(
                    ...
                    "tmp",
                    (
                        "openos-chrome-arm-exp-78-3876.0-"
...
class BundleArtifactHandlerTest(PrepareBundleTest):
    ...
    def setUp(self) -> None:
        ...
        self.afdo_name = f"openos-chrome-amd64-{benchmark_version}_rc-r1.afdo"
        self.perf_name = f"openos-chrome-amd64-{benchmark_version}.perf.data"
        self.release_afdo_name = (
            f"openos-chrome-amd64-atom-{cwp_version}-"
            f"benchmark-{benchmark_version}-r1-redacted.afdo.xz"
        )
        self.debug_binary_name = (
            f"openos-chrome-amd64-{benchmark_version}_rc-r1.debug"
        )
        self.merged_android_afdo_name = (
            f"openos-chrome-amd64-{benchmark_version}_rc-r1-merged.afdo"
        )
    ...
    def callBundleVerifiedKernelCwpAfdoFile(self, ebuild_data_list) -> None:
        ...
        profile_path = self.chroot.full_path(
            ...
            "debug",
            "boot",
            f"openos-kernel-{self.kernel_version}-{profile_name}",
        )
    ...
    def testBundleVerifiedKernelCwpAfdoFileRaises(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            f"openos-kernel-{self.kernel_version}",
        ):
            self.callBundleVerifiedKernelCwpAfdoFile(ebuild_data_list)
...
class ReleaseChromeAFDOProfileTest(PrepareBundleTest):
    ...
    def setUp(self) -> None:
        ...
        self.arch = "atom"
        self.benchmark_name = "openos-chrome-amd64-77.0.3849.0_rc-r1.afdo"
        self.benchmark_full = (
        ...
        self.merged_name = "openos-chrome-amd64-%s-%s" % (
            cwp_string,
            benchmark_string,
        )
    ...
    def testProcessAFDOProfileForOPENOSReleaseProfile(self) -> None:
...
class CreateAndUploadMergedAFDOProfileTest(PrepBundLatestAFDOArtifactTest):
    ...
    def _benchmark_afdo_profile_name(
        ...
        result = (
            f"openos-chrome-{arch}-{major}.{minor}.{build}.{patch}"
            f"_rc-r{rev}{suffix}"
        )
...
class GetUpdatedFilesTest(cros_test_lib.MockTempDirTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.kernel_key_name = f"openos-kernel-{self.kernel_name}"
