...
_CACHE_PATH = "var/cache/edb/openos"

_CHROMIUMOS_OVERLAY = os.path.join(
    constants.CHROOT_SOURCE_ROOT, constants.CHROMIUMOS_OVERLAY_DIR
)
_CHROMIUMOS_CONFIG = os.path.join(_CHROMIUMOS_OVERLAY, "openos", "config")
...
class Sysroot:
    ...
    def InstallMakeConfSdk(
        ...
        Args:
            build_target: The BuildTarget to use.
            public_only: Whether to only search public OPENOS repos.
        """
...
# Source make.conf from each overlay."""
        ...
        # If there is a boto file in the openos internal overlay, use it as it
