...
class TestLogArchiver(cros_test_lib.MockTempDirTestCase):
    ...
    def testArchiveFiles(self) -> None:
        ...
        interesting_log_files = [
            self._create_file("openos-chrome", "test.INFO.log"),
            self._create_file("openos-chrome", "reproxy_test.INFO"),
            self._create_file("openos-chrome", "reproxy_test.rrpl"),
        ]
        uninteresting_log_files = [
            self._create_file("openos-chrome", "test.INFO"),
        ]
        ...
        self.assertEqual(
            archive_files,
            [
                "reclient-openos-chrome/test.INFO.log.gz",
                "reclient-openos-chrome/reproxy_test.INFO.gz",
                "reclient-openos-chrome/reproxy_test.rrpl.gz",
            ],
        )
    ...
    def testNinjaLogArchive(self) -> None:
        ...
        log_path = os.path.join(self.src_dir, "reclient-openos-chrome")
