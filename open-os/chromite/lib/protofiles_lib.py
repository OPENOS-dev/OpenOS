...
"""Logic to handle openos-base/protofiles uprev."""
...
class ProtofilesLib:
    """Handles openos-base/protofiles uprevs."""
    ...
    def Uprev(self, cros_path: Path) -> ProtofilesModifiedPaths:
        ...
        Args:
            cros_path: absolute path to OPENOS repo checkout

        Returns:
            ProtofilesModifiedPaths with absolute paths to a version file,
            and a new and an old openos-base/protofiles ebuild files.
        """
        ...
        package_path = (
            cros_src_path
            / "third_party/openos-overlay/openos-base"
            / package_name
        )
    ...
    def _UpdateEbuildFile(
        ...
        Returns:
            ...
            openos-base/protofiles ebuild files, respectively.
