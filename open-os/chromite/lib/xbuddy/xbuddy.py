...
class XBuddy:
    ...
    def _LookupChannel(
        ...
        # Due to historical reasons, gs://openos-releases uses
        ...
        for build_id in build_id_as_is, build_id_suffix:
            try:
                ...
                if common_util.IsAnonymousCaller(e):
                    logging.error(
                        "Anonymous caller cannot list openos image archive"
                    )
    ...
    def Translate(
        ...
        Returns:
            ...
            file_name: The file name of the artifact. Can take any of the file
                ...
                e.g. 'openos_test_image.bin' or 'update.gz' if the path list
