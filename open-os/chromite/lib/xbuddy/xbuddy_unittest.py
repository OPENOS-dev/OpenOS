...
GS_ALTERNATE_DIR = "gs://openos-alternate-archive/"
...
class xBuddyTest(cros_test_lib.TestCase):
    ...
    def testGetLatestVersionFromGsDir(self) -> None:
        ...
        mock_data1 = """gs://openos-releases/stable-channel/parrot/3701.96.0/
    gs://openos-releases/stable-channel/parrot/3701.98.0/
    gs://openos-releases/stable-channel/parrot/3912.100.0/
    gs://openos-releases/stable-channel/parrot/3912.101.0/
    gs://openos-releases/stable-channel/parrot/3912.79.0/
    gs://openos-releases/stable-channel/parrot/3912.79.1/"""

        mock_data2 = """\
    gs://openos-image-archive/parrot-release/R26-3912.101.0
    gs://openos-image-archive/parrot-release/R27-3912.101.0
    gs://openos-image-archive/parrot-release/R28-3912.101.0"""
    ...
    def testLookupOfficial(self) -> None:
        ...
        with mock.patch.object(
            ...
            cat_mock.assert_called_with(
                "gs://openos-image-archive/b-s/LATEST-main", encoding="utf-8"
            )
    ...
    def testLookupChannel(self, version_mock) -> None:
        ...
        version_mock.assert_called_with(
            "gs://openos-image-archive/b-release/R*4100.68.0",
    ...
    def testResolveVersionToBuildIdAndChannel_Official(
        ...
        lookup_mock.assert_called_with(
            "chell", "-s", image_dir="gs://openos-alternate-archive/"
        )
        ...
        lookup_mock.assert_called_with(
            "chell", "paladin", image_dir="gs://openos-alternate-archive/"
        )
    ...
    def testResolveVersionToBuildIdAndChannel_Channel(
        ...
        lookup_mock.assert_called_with(
            ...
            "-s",
            channel="dev",
            image_dir="gs://openos-alternate-archive/",
        )
        ...
        with mock.patch.object(
            ...
            with mock.patch.object(self.mock_xb, "_Download") as download_mock:
                ...
                def _Download(image) -> None:
                    gs_image = "gs://openos-image-archive/" + version
