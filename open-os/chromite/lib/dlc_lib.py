...
# OPENOS Google Storage Buckets.
GS_LOCALMIRROR_BUCKET = "gs://openos-localmirror"
GS_LOCALMIRROR_PRIVATE_BUCKET = "gs://openos-localmirror-private"

# OPENOS Google Storage Bucket related paths.
GS_DLC_IMAGES_DIR = "dlc-images"

# OPENOS Google Storage Bucket related values.
...
def FactoryInstallDlc(
    *,
    ...
    for d_package in dlc_packages:
        ...
        # Refer to
        # http://cs/openos_public/src/third_party/eclass-overlay
...
def ValidateDlcIdentifier(name) -> None:
    ...
    For more info see:
    https://git.example.com/openos/platform2/+/HEAD/dlcservice/docs/developer.md#create-a-dlc-module
