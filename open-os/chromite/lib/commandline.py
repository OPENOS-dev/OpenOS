    ...
    def SetupOptions(self) -> None:
        ...
        if self.caching:
            ...
            self.add_common_argument_to_group(
                ...
                default=None,
                type="str_path",
                help="Override the calculated openos cache directory; "
...
class ArgumentParser(BaseParser, argparse.ArgumentParser):
    ...
    def add_bool_argument(
        ...
        See
        https://git.example.com/openos/chromite/+/HEAD/docs/cli-guidelines.md#Boolean-Options
...
def ScriptWrapperMain(
    ...
    Args:
        find_target_func: a function, which, when given the absolute
            ...
            /home/ferringb/openos/chromite/bin/cros_sdk; note that any
