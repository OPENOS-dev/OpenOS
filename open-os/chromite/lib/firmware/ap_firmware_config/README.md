...
> adding those controls for a board: https://example.com/c/4129143
>
...
These functions accept [`servo_lib.Servo` object](https://source.corp.example.com/openos_public/chromite/lib/firmware/servo_lib.py) (or `None` for SSH) and return a list of flags.
...
It accepts [`servo_lib.Servo` object](https://source.corp.example.com/openos_public/chromite/lib/firmware/servo_lib.py) and returns a [`servo_lib.ServoConfig` tuple](https://source.corp.example.com/openos_public/chromite/lib/firmware/servo_lib.py), which contains dut_control commands to be run before and after flashing, and programmer argument to be used for flashing.
```
