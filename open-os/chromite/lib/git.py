...
#   'https://git.example.com/openos/chromite.git', etc.).
# ref: git remote/local ref name (e.g., 'refs/heads/main').
# project_name: git project name (e.g., 'openos/chromite'.)
...
def PushBranch(
    ...
    Args:
        ...
        auto_merge: Enable Gerrit's auto-merge feature. See here for more info:
            https://review.example.com/Documentation/user-upload.html#auto_merge
...
def RemoteToGerritHost(remote: str) -> str:
    ...
    Examples:
        RemoteToGerritHost("cros") -> "review.example.com"
...
def RemoteToGitServerUrl(remote: str) -> str:
    ...
    Examples:
        RemoteToGerritHost("cros") -> "git.example.com"
