...
AUTHENTICATION_BUCKET = "gs://openos-authentication-bucket/"
...
class GSContext:
    ...
    GSUTIL_URL = (
        ...
        + "openos-mirror/gentoo/distfiles/%s" % GSUTIL_TAR
    )
...
"""
    ...
    def _ConfigureBotoConfig(self) -> None:
        ...
        print("Configuring gsutil. **Please use your @example.com account.**")
        try:
    ...
    def CheckPathAccess(self, path: str) -> None:
        ...
        if not self._TestGSLs(path):
            logging.warning(
                ...
                "/openos/docs/+/HEAD/gsutil.md#setup",
                path,
            )
        ...
        if self.dry_run:
            ...
            try:
                ...
                if self._use_luci_auth:
                    ...
                    docs_url = (
                        "https://example.com/chromium-os/developer-"
    ...
    def GetGsNamesWithWait(
        ...
        'openos_R17-1413.0.0-a1_x86-mario_full_dev.bin'). Returns the name
...
def escape_gsutil_url(url: str, specials: str = "?*[]") -> str:
    ...
    Examples:
        gs://openos-localmirror/foo[bar].tar ->
        gs://openos-localmirror/foo[[]bar[]].tar
