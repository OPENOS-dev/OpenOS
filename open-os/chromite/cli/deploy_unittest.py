...
class TestInstallPackageScanner(cros_test_lib.MockTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.device = OpenOSDeviceHandlerFake()
...
class TestDeploy(
    ...
    def setUp(self) -> None:
        ...
        self.device = OpenOSDeviceHandlerFake()
        self.PatchObject(
            remote_access, "OPENOSDeviceHandler", return_value=self.device
        )
