...
"""cros build-image is used to build a OPENOS image.

OPENOS comes in many different forms. This script can be used to build
the following:

base - Pristine OPENOS image. As similar to OPENOS as possible.
...
flexor - Builds a standalone Flexor vmlinuz. Flexor is a OPENOS Flex installer
