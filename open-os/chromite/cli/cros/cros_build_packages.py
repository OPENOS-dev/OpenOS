...
"""cros build-packages updates the set of binary packages needed by OPENOS.
...
class BuildPackagesCommand(command.CliCommand):
    """Update the set of binary packages used by OPENOS."""
    ...
    def AddParser(cls, parser: commandline.ArgumentParser):
        ...
        group = parser.add_argument_group(
            ...
            "openos-chrome binpkg, and build Chromium if no usable binpkg "
        ...
        try:
            ...
            try:
                with urllib.request.urlopen(
                    "https://openos-status.appspot.com/current?format=raw"
                ) as request:
