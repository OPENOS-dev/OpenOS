...
Lists the sizes of any subdirectries in a OPENOS image that are larger than
a minimum size.

The image may exist locally or be fetched from Google Storage by version number.

Live builds found here:
https://cros-goldeneye.corp.example.com/openos/console/liveBuilds
...
WATCHED_PATHS = [
    ...
    "/opt/google/chrome/resources/openos/accessibility/chromevox",
    ...
    "/usr/sbin",
    "/usr/share/openos-assets/demo_app",
    "/usr/share/openos-assets/genius_app",
    "/usr/share/openos-assets/input_methods/input_tools",
    "/usr/share/openos-assets/quickoffice",
    "/usr/share/openos-assets/speech_synthesis",
    "/usr/share/fonts",
]
