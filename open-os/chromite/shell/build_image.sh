...
# Script to build a bootable keyfob-based openos system image from within
# a openos setup. This assumes that all needed packages have been built into
# the given target's root with binary packages turned on. This script will
# build the OPENOS image using only pre-built binary packages.
