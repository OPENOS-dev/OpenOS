...
# source: openos/build/api/system_image.proto
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\'openos/build/api/system_image.proto\x12\x14\x63hromiumos.build.api\x1a\"openos/build/api/portage.proto\"\xd3\x08\n\x0bSystemImage\x12\x35\n\x02id\x18\x01 \x01(\x0b\x32).openos.build.api.SystemImage.ImageId\x12\x41\n\x08metadata\x18\x02 \x01(\x0b\x32/.openos.build.api.SystemImage.BuildMetadata\x1a\x18\n\x07ImageId\x12\r\n\x05value\x18\x01 \x01(\t\x1aV\n\x0b\x42uildTarget\x12G\n\x14portage_build_target\x18\x01 \x01(\x0b\x32).openos.build.api.Portage.BuildTarget\x1a\x81\x06\n\rBuildMetadata\x12\x43\n\x0c\x62uild_target\x18\x01 \x01(\x0b\x32-.openos.build.api.SystemImage.BuildTarget\x12W\n\x0fpackage_summary\x18\x02 \x01(\x0b\x32>.openos.build.api.SystemImage.BuildMetadata.PackageSummary\x12\x37\n\x08packages\x18\x03 \x03(\x0b\x32%.openos.build.api.Portage.Package\x1a\xfd\x02\n\x0ePackageSummary\x12@\n\x03\x61rc\x18\x01 \x01(\x0b\x32\x33.openos.build.api.SystemImage.BuildMetadata.Arc\x12I\n\x06\x63hrome\x18\x02 \x01(\x0b\x32\x39.openos.build.api.SystemImage.BuildMetadata.AshChrome\x12H\n\x07\x63hipset\x18\x03 \x01(\x0b\x32\x37.openos.build.api.SystemImage.BuildMetadata.Chipset\x12\x46\n\x06kernel\x18\x04 \x01(\x0b\x32\x36.openos.build.api.SystemImage.BuildMetadata.Kernel\x12L\n\ttoolchain\x18\x05 \x01(\x0b\x32\x39.openos.build.api.SystemImage.BuildMetadata.Toolchain\x1a&\n\x03\x41rc\x12\x0f\n\x07version\x18\x01 \x01(\t\x12\x0e\n\x06\x62ranch\x18\x02 \x01(\t\x1a\x1c\n\tAshChrome\x12\x0f\n\x07version\x18\x01 \x01(\t\x1a\x1a\n\x07\x43hipset\x12\x0f\n\x07overlay\x18\x01 \x01(\t\x1a\x19\n\x06Kernel\x12\x0f\n\x07version\x18\x01 \x01(\t\x1a\x1c\n\tToolchain\x12\x0f\n\x07version\x18\x01 \x01(\t\x1aT\n\x11\x42uildMetadataList\x12?\n\x06values\x18\x01 \x03(\x0b\x32/.openos.build.api.SystemImage.BuildMetadataB0Z.go.chromium.org/openos/config/go/build/apib\x06proto3')

_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'openos.build.api.system_image_pb2', _globals)
