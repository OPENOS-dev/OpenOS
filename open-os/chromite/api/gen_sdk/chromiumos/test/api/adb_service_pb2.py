...
# source: openos/test/api/adb_service.proto
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n%openos/test/api/adb_service.proto\x12\x13\x63hromiumos.test.api\"2\n\x11\x41\x44\x42\x43ommandRequest\x12\x0f\n\x07\x63ommand\x18\x01 \x01(\t\x12\x0c\n\x04\x61rgs\x18\x02 \x03(\t\"G\n\x12\x41\x44\x42\x43ommandResponse\x12\x0e\n\x06stdout\x18\x01 \x01(\x0c\x12\x0e\n\x06stderr\x18\x02 \x01(\x0c\x12\x11\n\texit_code\x18\x03 \x01(\x05\x32n\n\nADBService\x12`\n\x0b\x45xecCommand\x12&.openos.test.api.ADBCommandRequest\x1a\'.openos.test.api.ADBCommandResponse\"\x00\x42/Z-go.chromium.org/openos/config/go/test/apib\x06proto3')

_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'openos.test.api.adb_service_pb2', _globals)
