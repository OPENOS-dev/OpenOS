...
`infra/proto_branched/src/openos/common.proto`.
...
option go_package = "go.chromium.org/openos/infra/proto/go/chromite/api";

import "chromite/api/build_api.proto";
// NEW!
import "openos/common.proto";

// HelloService/Hello request and response messages.
message HelloRequest {
  string target = 1;
  // NEW!
  openos.Chroot chroot = 2;
}
...
```shell script
$> cd ~/openos/infra/proto_branched
$> ./generate.sh
$> cd ~/openos/chromite/api
...
message HelloRequest {
  ...
  openos.Chroot chroot = 2;
  // NEW!
  openos.Path targets_file = 3;
  // NEW!
  openos.ResultPath output_dir = 4;
}
...
message HelloResponse {
  ...
  reserved 1;
  // NEW!
  repeated openos.Path message_files = 2;
}
...
In the request, we also added `openos.Path` and `openos.ResultPath`
fields, and in the response, a repeated `openos.Path` field.
...
`~/openos/chromite/api/contrib/call_scripts/hello__hello_input.json`
```json
{
...
```shell script
$> cd ~/openos/chromite/api/contrib/call_scripts/
$> ./hello__hello
...
15:17:13: DEBUG: Copying /tmp/targets-file to /usr/local/google/home/saklein/openos/chroot/tmp/tmptdazkiqh/targets-file
15:17:13: INFO: Writing input message to: /usr/local/google/home/saklein/openos/chroot/tmp/tmpx9cumt3j/request
15:17:13: INFO: Writing config message to: /usr/local/google/home/saklein/openos/chroot/tmp/tmpx9cumt3j/config
15:17:13: INFO: run: cros_sdk --chroot /usr/local/google/home/saklein/openos/chroot -- build_api chromite.api.HelloService/Hello --input-json /tmp/tmpx9cumt3j/request --output-binary /tmp/tmpx9cumt3j/response --config-json /tmp/tmpx9cumt3j/config --debug
...
15:17:15: DEBUG: Copying /usr/local/google/home/saklein/openos/chroot/tmp/tmpxjuwd_lj/world to /tmp/hello-results/world
15:17:15: DEBUG: Copying /usr/local/google/home/saklein/openos/chroot/tmp/tmpxjuwd_lj/moon to /tmp/hello-results/moon
15:17:15: DEBUG: Copying /usr/local/google/home/saklein/openos/chroot/tmp/tmpxjuwd_lj/everybody to /tmp/hello-results/everybody
