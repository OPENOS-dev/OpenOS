...
class UprevVersionedPackageTest(
    ...
    def testValidateOnly(self) -> None:
        ...
        request.package_info.category = "openos-base"
        request.package_info.package_name = "openos-chrome"
...
class GetBestVisibleTest(cros_test_lib.MockTestCase, api_config.ApiConfigMixin):
    ...
    def testValidateOnly(self) -> None:
        ...
        request = self._GetRequest(atom="openos-chrome")
...
class GetTargetVersionsTest(
    ...
    def testGetTargetVersions(self) -> None:
        ...
        android_package = "openos-base/android-container-pi-10.3"
        self.PatchObject(
            packages_service,
...
class GetAndroidMetadataTest(
    ...
    def testSuccess(self) -> None:
        ...
        version = "7123456"
        full_package = f"openos-base/{package}-{version}-r1"
