...
class PrepareBinhostUploadsTest(
    ...
    def testValidateOnly(self) -> None:
        ...
        request.build_target.name = "target"
        request.uri = "gs://openos-prebuilt/target"
...
class UpdatePackageIndexTest(
    ...
    def testMustProvideSomeCommand(self) -> None:
        ...
        request = binhost_pb2.UpdatePackageIndexRequest(
            ...
            uri="gs://openos-prebuilt/board/amd64-host/packages",
        )
        response = binhost_pb2.UpdatePackageIndexResponse()
    ...
    def testSetUploadLocation(self) -> None:
        ...
        self.assertEqual(new_pkg_index.header["URI"], "gs://openos-prebuilt")
...
class PrepareChromeBinhostUploadsTest(
    ...
    def setUp(self) -> None:
        ...
        self.request.uri = "gs://openos-prebuilt/target"
        ...
        osutils.Touch(
            self.chrome_packages_path / "openos-chrome-100-r1.tbz2",
            makedirs=True,
        )
        osutils.Touch(
        ...
        osutils.Touch(
            self.chrome_packages_path / "openos-lacros-100-r1.tbz2",
            makedirs=True,
        )
    ...
    def testChromeUpload(self) -> None:
        ...
        expected_upload_targets = [
            "openos-base/openos-chrome-100-r1.tbz2",
            "openos-base/chrome-icu-100-r1.tbz2",
            "openos-base/openos-lacros-100-r1.tbz2",
        ]
