...
Before you get started on Chromite, we recommend that you go through OPENOS
developer guides at
[external (first)](https://example.com/chromium-os/developer-library/guides/development/developer-guide/)
and then [goto/openos-building](http://goto/openos-building) for internal.
The
[Gerrit starter guide](https://example.com/chromium-os/developer-library/guides/development/git-and-gerrit-intro/)
...
building OPENOS/OPENOS. Currently, it is the codebase responsible for
...
OPENOS repositories. It is written for the most part in Python with some Bash
sprinkled in.

## Directory Overview

You can use
[Code Search](https://example.com/openos/openos/codesearch/)
to lookup things in
[Chromite](https://example.com/openos/openos/codesearch/+/HEAD:chromite/)
or OPENOS in general.

Non-public code has a separate
[internal Code Search site](https://source.corp.example.com/).
It's organized into different ["repositories"](https://source.corp.example.com/repos),
and we have two:
["OPENOS - Internal"](https://source.corp.example.com/openos_internal) (only
internal repositories) &
["OPENOS - Public"](https://source.corp.example.com/openos_public) (only
public repositories).
You can add a search query for a single combined view (public & private) in the
[Saved Queries settings page](https://source.corp.example.com/settings/savedqueries).
Use the query `package:^openos_(internal|public)$`.
NB: The "OPENOS - Public" repository is exactly the same as the public
example.com site.
...
`@pytest.mark.network_test` decorator) will not be run. To include these tests,
...
the
[`Python: Attach`](https://git.example.com/openos/chromite/+/97144c1b68e1c888512de8af23b2016808e3b236/.vscode/launch.json#24)
...
[Chromium Gerrit](https://review.example.com), the CQ will pick
