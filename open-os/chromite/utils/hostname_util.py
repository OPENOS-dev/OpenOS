...
# OPENOS: Replaced Google-internal hostname detection with empty tuple.
# Google network detection is not needed outside Google infrastructure.
GOOGLE_HOSTNAME_SUFFIX = ()
...
def host_is_ci_builder(
    ...
    GOLO_DOMAIN = "example.com"
    CHROME_DOMAIN = "chrome." + CORP_DOMAIN
    CHROMEOS_BOT_INTERNAL = "openos-bot.internal"
    CHROMEOS_RELEASE_BOT_INTERNAL = "openos-release-bot.internal"
