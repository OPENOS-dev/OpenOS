...
class CanonicalizeURLTest(cros_test_lib.TestCase):
    ...
    def testPrivateUrl(self) -> None:
        ...
        self._checkit(
            "https://storage.example.com/releases/some/file/t.gz",
            "gs://releases/some/file/t.gz",
        )
        self._checkit(
            "https://console.example.com/storage/browser/releases/some/"
            "file/t.gz",
            "gs://releases/some/file/t.gz",
        )
        self._checkit(
            "https://download.example.com/browse/releases/some/file/t.gz",
            "gs://releases/some/file/t.gz",
        )
    ...
    def testDuplicateBase(self) -> None:
        ...
        self._checkit(
            (
                "https://storage.example.com/releases/some/"
                "https://storage.example.com/some/file/t.gz"
            ),
            (
                "gs://releases/some/"
                "https://storage.example.com/some/file/t.gz"
...
class GsUrlToHttpTest(cros_test_lib.TestCase):
    ...
    def testPrivateUrls(self) -> None:
        """Test private https URLs."""
        expected = [
            "https://storage.example.com/releases",
            "https://download.example.com/browse/releases/",
            "https://storage.example.com/releases/path",
            "https://download.example.com/browse/releases/path/",
            "https://storage.example.com/releases/path/file",
        ]
    ...
    def testPrivateDirectoryUrls(self) -> None:
        ...
        expected = [
            ...
            "https://download.example.com/browse/releases/path",
            "https://download.example.com/browse/releases/path/",
            "https://download.example.com/browse/releases/path/file",
        ]
