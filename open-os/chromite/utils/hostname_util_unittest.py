...
class TestGetHostname(cros_test_lib.MockTestCase):
    ...
    def testhost_is_ci_builder(self) -> None:
        ...
        fq_hostname_golo = "test.example.com"
        fq_hostname_gce_1 = "test.openos-bot.internal"
        fq_hostname_gce_2 = "test.chrome.corp.example.com"
        fq_hostname_gce_3 = "test.openos-release-bot.internal"
