...
PRIVATE_BASE_HTTPS_URL = "https://storage.example.com/"
...
PRIVATE_BASE_HTTPS_DOWNLOAD_URL = "https://download.example.com/browse/"
BASE_GS_URL = "gs://"
...
def CanonicalizeURL(url: str, strict: bool = False) -> str:
    ...
    for prefix in (
        ...
        "https://console.example.com/storage/browser/",
...
def GsUrlToHttp(path: str, public: bool = True, directory: bool = False) -> str:
    ...
    e.g. 'gs://openos-image-archive/path/file' ->
