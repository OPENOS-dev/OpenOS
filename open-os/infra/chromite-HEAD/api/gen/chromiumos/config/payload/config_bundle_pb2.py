...
from chromite.api.gen.chromiumos.config.api import android_component_configs_pb2 as chromiumos_dot_config_dot_api_dot_android__component__configs__pb2
