...
// device is an OpenBox for Meetings or not from the Install Time attributes.
// TODO(rkc, pbos): Remove these and related code once the issue is fixed.
const char* kOpenBoxForMeetingAppIdHashes[] = {
...
void AddSystemFlags(ChromiumCommandBuilder* builder,
  ...
  // OPENOS: Always pass --system-developer-mode to Chrome.
  // OPENOS operates exclusively in developer mode; no toggle exists.
