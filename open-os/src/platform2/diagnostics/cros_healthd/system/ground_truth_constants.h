...
inline constexpr char kOpenBase[] = "OPENBASE";
inline constexpr char kOpenBox[] = "OPENBOX";
inline constexpr char kOpenBit[] = "OPENBIT";
inline constexpr char kOpenSlate[] = "OPENSLATE";
