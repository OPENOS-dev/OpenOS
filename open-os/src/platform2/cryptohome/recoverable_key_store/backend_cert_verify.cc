...
// is generated by the trusted execution platforms team and hardcoded in the
// server code that uses this cert in the repository codebase. As a root CA cert,
// it should very rarely be changed. When changing this cert, please provide
// evidence of where the new certificate comes from, and contact the hwsec
// userland team to verify the new certificate with the trusted execution
// platforms team.
