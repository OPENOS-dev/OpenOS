...
constexpr char kKernelPath[] = "/opt/ocs/vms/android/vmlinux";
//
// Path to the GKI guest kernel.
constexpr char kGkiPath[] = "/opt/ocs/vms/android/gki";

// Path to the VM rootfs image file.
constexpr char kRootfsPath[] = "/opt/ocs/vms/android/system.raw.img";

// Path to the VM ramdisk file.
constexpr char kRamdiskPath[] = "/opt/ocs/vms/android/ramdisk.img";
