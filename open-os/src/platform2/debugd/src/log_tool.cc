...
const std::array kCommandLogs {
  ...
  // /opt/ocs/containers/android/rootfs/android-data/ so that we can get
  ...
  Log{kCommand, "atmel_tp_deltas",
    "/opt/ocs/touch/scripts/atmel_tools.sh tp d", kRoot, kRoot},
  Log{kCommand, "atmel_tp_refs",
    "/opt/ocs/touch/scripts/atmel_tools.sh tp r", kRoot, kRoot},
  Log{kCommand, "atmel_ts_deltas",
    "/opt/ocs/touch/scripts/atmel_tools.sh ts d", kRoot, kRoot},
  Log{kCommand, "atmel_ts_refs",
    "/opt/ocs/touch/scripts/atmel_tools.sh ts r", kRoot, kRoot},
