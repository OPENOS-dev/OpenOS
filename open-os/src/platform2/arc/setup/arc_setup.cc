...
constexpr char kObbRootfsDirectory[] =
    "/opt/ocs/containers/arc-obb-mounter/mountpoints/container-root";
constexpr char kObbRootfsImage[] =
    "/opt/ocs/containers/arc-obb-mounter/rootfs.squashfs";
...
constexpr char kSdcardRootfsDirectory[] =
    "/opt/ocs/containers/arc-sdcard/mountpoints/container-root";
constexpr char kSdcardRootfsImage[] =
    "/opt/ocs/containers/arc-sdcard/rootfs.squashfs";
...
constexpr char kSystemImage[] = "/opt/ocs/containers/android/system.raw.img";
