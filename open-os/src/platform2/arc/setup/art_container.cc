...
constexpr char kAndroidRootfs[] =
    "/opt/ocs/containers/arc-art/mountpoints/container-root";
constexpr char kAndroidVendor[] =
    "/opt/ocs/containers/arc-art/mountpoints/vendor";
...
constexpr char kArtDevRootfsDirectory[] =
    "/opt/ocs/containers/arc-art/mountpoints/dev-rootfs";
constexpr char kArtDevRootfsImage[] =
    "/opt/ocs/containers/arc-art/dev-rootfs.squashfs";
...
constexpr char kVendorImage[] = "/opt/ocs/containers/android/vendor.raw.img";
