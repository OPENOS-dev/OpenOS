...
// One LaunchAndWait call will take at least ~40ms on ARM OpenOS devices because
...
// ARM OpenOS devices because arc_setup is executed when the CPU is very busy and
