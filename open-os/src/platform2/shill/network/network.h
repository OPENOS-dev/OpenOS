...
class Network : public NetworkMonitor::ClientNetwork {
 public:
  ...
  // Returns true if the DHCP parameters provided indicate that the Open-OS device
  // is tetherd to an Android mobile device or another Open-OS device over a WiFi
