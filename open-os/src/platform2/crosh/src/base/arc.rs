...
mod tests {
    ...
    fn test_valid_commands() {
        let valid_commands = [
            "ping 8.8.8.8",
            "ping eth 1.1.1.1",
            "ping wifi example.com",
            "http https://example.com",
            "http cell https://example.com",
            "dns example.com",
    ...
    fn test_arc_networking_commands() {
        let commands = [
            ...
            (
                "ping wifi example.com",
                "shell dumpsys wifi tools reach wifi example.com",
            ),
            (
                "http https://example.com",
                "shell dumpsys wifi tools http https://example.com",
            ),
            (
                "http cell https://example.com",
                "shell dumpsys wifi tools http cell https://example.com",
            ),
            (
                "dns example.com",
                "shell dumpsys wifi tools dns example.com",
            ),
            (
                "dns vpn portal.corp.com",
            ...
            (
                "proxy http://example.com",
                "shell dumpsys wifi tools proxy http://example.com",
            ),
