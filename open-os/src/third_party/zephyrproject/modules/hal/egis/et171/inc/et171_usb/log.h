...
#define DbgMsg( t, x, ...)
#endif
#define vDbgMsg( l, m, n, ...) DbgMsg( l, m, "[%s %4d %4d]-" n, __func__,\
                                                    (unsigned int)__LINE__, (unsigned int)g_dbg_log_cnt++, __VA_ARGS__)
#define cvDbgMsg( l, m, n, ...) cDbgMsg( l, m, "[%s %4d %4d]-" n, __func__,\
                                                    (unsigned int)__LINE__, (unsigned int)g_dbg_log_cnt++, __VA_ARGS__)
#define evDbgMsg( l, m, n, ...) { cDbgMsg( l, m, "[%s %4d %4d]-" n, __func__,         \
                                                    (unsigned int)__LINE__, (unsigned int)g_dbg_log_cnt++, __VA_ARGS__); \
                                  ASSERT(0); }
