...
/* bit definitions for extien 0x199 **/
#define UCM_EXTIEN_WAKEUPIEN    0x80 /* bit 7 wakeupien*/
...
/** bit definitions for irq mode registers */
#define UCM_IRQ_MODE_0  0x01
#define UCM_IRQ_MODE_1  0x02
