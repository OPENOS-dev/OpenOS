...
/* Allow tests to redirect this to their own favorite temporary directory. */
#ifndef LIBNIH_TEMPDIR
#define LIBNIH_TEMPDIR "/tmp"
#endif
...
#define TEST_FILENAME(_var) \
	do { \
		snprintf ((_var), sizeof (_var), "%s/%s-%s-%d-%d", \
			  LIBNIH_TEMPDIR, \
