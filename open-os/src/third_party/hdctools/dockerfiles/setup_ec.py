...
if "PACKAGE" in os.environ and os.environ["PACKAGE"] == "powerlog":
    setup(
        name="powerlog",
        version="1.0",
        author="Nick Sanders",
...
if "PACKAGE" in os.environ and os.environ["PACKAGE"] == "console":
    setup(
        name="console",
        version="1.0",
        author="Nick Sanders",
...
if "PACKAGE" in os.environ and os.environ["PACKAGE"] == "unpack_ftb":
    setup(
        name="unpack_ftb",
        version="1.0",
        author="Wei-Han Chen",
