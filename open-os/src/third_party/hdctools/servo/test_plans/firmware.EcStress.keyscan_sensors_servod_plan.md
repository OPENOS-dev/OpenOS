...
# Servod Test Plan: firmware.EcStress.keyscan_sensors

This test plan emulates the hardware-level interactions of the `firmware.EcStress.keyscan_sensors` Tast test.
