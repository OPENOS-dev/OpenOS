...
# Servod Test Plan: Isolated Write - image_usbkey_direction:dut_sees_usbkey

This test plan verifies the write path for `image_usbkey_direction:dut_sees_usbkey`.
