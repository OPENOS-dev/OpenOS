...
# Servod Test Plan: firmware.UserRequestRecovery.dev

This test plan emulates the hardware-level interactions of the `firmware.UserRequestRecovery.dev` Tast test.
