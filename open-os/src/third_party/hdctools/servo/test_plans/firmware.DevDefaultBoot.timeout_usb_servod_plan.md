...
# Servod Test Plan: firmware.DevDefaultBoot.timeout_usb

This test plan emulates the hardware-level interactions of the `firmware.DevDefaultBoot.timeout_usb` Tast test.
