...
# Servod Test Plan: firmware.FpSoftwareWriteProtect

This test plan emulates the hardware-level interactions of the `firmware.FpSoftwareWriteProtect` Tast test.
