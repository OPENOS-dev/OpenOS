...
# Servod Test Plan: firmware.EcStress.keyscan_pd_sensors

This test plan emulates the hardware-level interactions of the `firmware.EcStress.keyscan_pd_sensors` Tast test.
