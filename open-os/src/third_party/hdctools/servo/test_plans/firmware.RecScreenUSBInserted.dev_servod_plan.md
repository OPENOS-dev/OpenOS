...
# Servod Test Plan: firmware.RecScreenUSBInserted.dev

This test plan emulates the hardware-level interactions of the `firmware.RecScreenUSBInserted.dev` Tast test.
