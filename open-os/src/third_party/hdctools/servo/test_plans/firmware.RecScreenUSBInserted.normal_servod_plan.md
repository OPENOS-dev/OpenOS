...
# Servod Test Plan: firmware.RecScreenUSBInserted.normal

This test plan emulates the hardware-level interactions of the `firmware.RecScreenUSBInserted.normal` Tast test.
