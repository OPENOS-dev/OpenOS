...
# Servod Test Plan: firmware.BootMode.dev_cold

This test plan emulates the hardware-level interactions of the `firmware.BootMode.dev_cold` Tast test.
...
dut-control ccd_keepalive_en:on
dut-control watchdog_remove:servo_v4p1
dut-control download_image_to_usb_dev:${IMAGE_URL}
dut-control image_usbkey_dev
dut-control image_usbkey_mux
dut-control image_usbkey_pwr
dut-control image_usbkey_dev
