...
# Servod Test Plan: firmware.DevBootInvalidUSB.restore_usb

This test plan emulates the hardware-level interactions of the `firmware.DevBootInvalidUSB.restore_usb` Tast test.
