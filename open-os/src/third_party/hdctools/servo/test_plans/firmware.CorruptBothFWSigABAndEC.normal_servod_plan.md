...
# Servod Test Plan: firmware.CorruptBothFWSigABAndEC.normal

This test plan emulates the hardware-level interactions of the `firmware.CorruptBothFWSigABAndEC.normal` Tast test.
