...
# Servod Test Plan: firmware.EcStress.flash_sensors_suspend

This test plan emulates the hardware-level interactions of the `firmware.EcStress.flash_sensors_suspend` Tast test.
