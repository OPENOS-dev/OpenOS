...
# Servod Test Plan: firmware.DevDefaultBoot.timeout_internal

This test plan emulates the hardware-level interactions of the `firmware.DevDefaultBoot.timeout_internal` Tast test.
