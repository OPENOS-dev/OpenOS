...
# Servod Test Plan: firmware.EcStress.flash_sensors

This test plan emulates the hardware-level interactions of the `firmware.EcStress.flash_sensors` Tast test.
