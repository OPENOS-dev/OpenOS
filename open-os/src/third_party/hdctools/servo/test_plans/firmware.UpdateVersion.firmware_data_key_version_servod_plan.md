...
# Servod Test Plan: firmware.UpdateVersion.firmware_data_key_version

This test plan emulates the hardware-level interactions of the `firmware.UpdateVersion.firmware_data_key_version` Tast test.
