...
# Servod Test Plan: firmware.TPMKernelVersion.dev_usb

This test plan emulates the hardware-level interactions of the `firmware.TPMKernelVersion.dev_usb` Tast test.
