...
# Servod Test Plan: firmware.FWAutoupdate.battery_rw

This test plan emulates the hardware-level interactions of the `firmware.FWAutoupdate.battery_rw` Tast test.
