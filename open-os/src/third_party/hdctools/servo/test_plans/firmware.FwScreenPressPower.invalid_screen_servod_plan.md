...
# Servod Test Plan: firmware.FwScreenPressPower.invalid_screen

This test plan emulates the hardware-level interactions of the `firmware.FwScreenPressPower.invalid_screen` Tast test.
