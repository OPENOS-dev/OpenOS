...
# Servod Test Plan: firmware.UserRequestRecovery.normal

This test plan emulates the hardware-level interactions of the `firmware.UserRequestRecovery.normal` Tast test.
