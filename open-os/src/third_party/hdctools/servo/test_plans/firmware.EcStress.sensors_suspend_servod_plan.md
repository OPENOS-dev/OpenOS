...
# Servod Test Plan: firmware.EcStress.sensors_suspend

This test plan emulates the hardware-level interactions of the `firmware.EcStress.sensors_suspend` Tast test.
