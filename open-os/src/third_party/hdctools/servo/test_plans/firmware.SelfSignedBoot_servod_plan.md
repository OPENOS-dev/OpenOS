...
# Servod Test Plan: firmware.SelfSignedBoot

This test plan emulates the hardware-level interactions of the `firmware.SelfSignedBoot` Tast test.
...
dut-control arb_key_config:
dut-control arb_key:tab
dut-control ec_uart_regexp:None
dut-control ec_uart_cmd:kbpress 11 5 1
dut-control ec_uart_regexp:None
dut-control ec_uart_cmd:kbpress 11 5 0
dut-control dut_connection_type
dut-control servo_uart_regexp:"['cc: (\\w+)[\\r\\n]']"
dut-control servo_uart_cmd:cc off
dut-control servo_uart_cmd
...
dut-control servo_pd_role:snk
dut-control dut_pd_data_role:DFP
dut-control arb_key_config:<esc>
dut-control arb_key:tab
dut-control ec_uart_regexp:None
dut-control ec_uart_cmd:kbpress 1 1 1
dut-control ec_uart_regexp:None
dut-control ec_uart_cmd:kbpress 1 1 0
dut-control image_usbkey_direction:dut_sees_usbkey
dut-control image_usbkey_mux
dut-control image_usbkey_pwr
dut-control image_usbkey_pwr:on
...
dut-control ec_uart_cmd:kbpress 0 2 1
dut-control ec_uart_regexp:None
dut-control ec_uart_cmd:kbpress 6 7 1
dut-control ec_uart_regexp:None
dut-control ec_uart_cmd:kbpress 0 2 0
dut-control ec_uart_regexp:None
dut-control ec_uart_cmd:kbpress 6 7 0
dut-control dut_eth_pwr_en:off
dut-control dut_eth_pwr_en:on
dut-control dut_pd_data_role:DFP
dut-control ctrl_u:tab
