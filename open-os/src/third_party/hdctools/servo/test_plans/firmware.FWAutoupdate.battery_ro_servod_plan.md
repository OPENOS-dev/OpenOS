...
# Servod Test Plan: firmware.FWAutoupdate.battery_ro

This test plan emulates the hardware-level interactions of the `firmware.FWAutoupdate.battery_ro` Tast test.
