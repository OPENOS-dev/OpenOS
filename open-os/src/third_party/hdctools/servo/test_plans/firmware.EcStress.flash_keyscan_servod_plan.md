...
# Servod Test Plan: firmware.EcStress.flash_keyscan

This test plan emulates the hardware-level interactions of the `firmware.EcStress.flash_keyscan` Tast test.
