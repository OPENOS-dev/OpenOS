...
# Servod Test Plan: firmware.DevBootUSB.late_insert

This test plan emulates the hardware-level interactions of the `firmware.DevBootUSB.late_insert` Tast test.
