...
# Servod Test Plan: firmware.TPMExtend.dev_recovery

This test plan emulates the hardware-level interactions of the `firmware.TPMExtend.dev_recovery` Tast test.
