...
# Servod Test Plan: firmware.EcStress.pd_sensors_suspend

This test plan emulates the hardware-level interactions of the `firmware.EcStress.pd_sensors_suspend` Tast test.
