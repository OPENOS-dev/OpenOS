...
# Servod Test Plan: firmware.BootMode.rec_to_dev_gbb

This test plan emulates the hardware-level interactions of the `firmware.BootMode.rec_to_dev_gbb` Tast test.
