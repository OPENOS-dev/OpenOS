...
# Servod Test Plan: firmware.EcStress.flash_keyscan_pd_sensors_suspend

This test plan emulates the hardware-level interactions of the `firmware.EcStress.flash_keyscan_pd_sensors_suspend` Tast test.
...
dut-control ec_system_powerstate
dut-control ec_uart_regexp:None
dut-control ec_uart_cmd:kbpress 3 2 1
dut-control ec_system_powerstate
dut-control servo_uart_regexp:"['dual-role toggling:\\s+([\\w ]+)[\\r\\n]']"
dut-control servo_uart_cmd:pd 1 dualrole
...
dut-control servo_uart_cmd
dut-control servo_uart_regexp:None
dut-control servo_uart_regexp:"['DRP\\s=\\s(\\d)']"
dut-control servo_uart_cmd:usbc_action drp
dut-control servo_uart_cmd
dut-control servo_uart_regexp:None
dut-control servo_uart_regexp:"['dual-role toggling:\\s+([\\w ]+)[\\r\\n]']"
dut-control servo_uart_cmd:pd 1 dualrole
...
dut-control servo_uart_regexp:None
dut-control ec_system_powerstate
dut-control servo_uart_cmd:fakedisconnect 0 0
...
dut-control servo_uart_regexp:None
dut-control ec_uart_regexp:None
dut-control ec_uart_cmd:kbpress 3 2 0
dut-control ec_system_powerstate
