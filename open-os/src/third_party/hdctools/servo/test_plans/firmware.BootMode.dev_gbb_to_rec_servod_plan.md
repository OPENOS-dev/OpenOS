...
# Servod Test Plan: firmware.BootMode.dev_gbb_to_rec

This test plan emulates the hardware-level interactions of the `firmware.BootMode.dev_gbb_to_rec` Tast test.
