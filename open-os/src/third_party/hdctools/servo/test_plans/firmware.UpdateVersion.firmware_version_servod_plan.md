...
# Servod Test Plan: firmware.UpdateVersion.firmware_version

This test plan emulates the hardware-level interactions of the `firmware.UpdateVersion.firmware_version` Tast test.
