...
# Servod Test Plan: firmware.DevBootInternal.keyboard_with_usb

This test plan emulates the hardware-level interactions of the `firmware.DevBootInternal.keyboard_with_usb` Tast test.
