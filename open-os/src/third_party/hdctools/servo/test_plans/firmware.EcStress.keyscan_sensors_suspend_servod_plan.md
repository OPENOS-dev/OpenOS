...
# Servod Test Plan: firmware.EcStress.keyscan_sensors_suspend

This test plan emulates the hardware-level interactions of the `firmware.EcStress.keyscan_sensors_suspend` Tast test.
