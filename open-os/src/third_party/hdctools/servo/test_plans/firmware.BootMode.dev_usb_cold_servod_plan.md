...
# Servod Test Plan: firmware.BootMode.dev_usb_cold

This test plan emulates the hardware-level interactions of the `firmware.BootMode.dev_usb_cold` Tast test.
