...
"""Geralt rev0 on-board adc map"""

# generates geralt_rev0.xml
revs = [0]
...
# drvname      slv      name                        nom     sense   mux     is_calib
  ...
  ('ina231',   '0x46',  'pp3300_ec_z1',             3.300,  0.02,   'rem',  True),  # RS9
  ('ina231',   '0x47',  'pp3300_gsc_z1',            3.300,  0.02,   'rem',  True),  # RS7
  ('ina231',   '0x48',  'pp1800_vio18_s3',          1.800,  0.02,   'rem',  True),  # RS4
  ('ina231',   '0x49',  'pp1800_gsc_z1',            1.800,  0.02,   'rem',  True),  # RS6
  ('ina231',   '0x4A',  'pp3300_wlan',              3.300,  0.02,   'rem',  True),  # RS16
  ('ina231',   '0x4B',  'pp3300_hub',               3.300,  0.02,   'rem',  True),  # RS17
  ('ina231',   '0x4C',  'ppvar_base',               3.300,  0.02,   'rem',  True),  # RS18
  ('ina231',   '0x4D',  'ppvar_mipi_bl_vin',        8.800,  0.01,   'rem',  True),  # RS11
  ('ina231',   '0x4E',  'pp5000_mipi_disp_vin',     5.000,  0.02,   'rem',  True),  # RS10
  ('ina231',   '0x4F',  'pp1800_mipi_disp_tchscr',  1.800,  0.02,   'rem',  True),  # RS12
]
