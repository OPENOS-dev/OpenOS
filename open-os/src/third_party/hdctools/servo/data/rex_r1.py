...
#  drvname     addr:port   name                     nom         sense       mux   is_calib
  ...
  ('pac1954',  '0x11:1',   'PP1800_MEM',            1.800,      0.010,      'rem',True),  # RS2
  ...
  ('pac1954',  '0x19:1',   'PP1800_UWB_RF_X',       1.800,      0.100,      'rem',True),  # R1052
  ...
  ('pac1954',  '0x1B:1',   'PP1065_SOC_S3',         1.065,      0.003,      'rem',True),  # R876
