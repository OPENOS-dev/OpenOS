...
# drvname      slv        name                    nom      sense  mux     is_calib
  ...
  ('pac1954',  '0x11:3',  'pp3700_proc_b_in',     3.700,   0.01,  'rem',  True),  #RS38
  ...
  ('pac1954',  '0x15:0',  'pp3300_c0_z1',         3.300,   0.02,  'rem',  True),  #RS43
  ('pac1954',  '0x15:1',  'pp3300_wlan_s3',       3.300,   0.02,  'rem',  True),  #RS8
  ('pac1954',  '0x15:2',  'pp3300_hub_s3',        3.300,   0.02,  'rem',  True),  #RS34
  ('pac1954',  '0x17:0',  'pp1800_vio18_s3',      1.800,   0.02,  'rem',  True),  #RS33
  ('pac1954',  '0x17:1',  'pp0750_dvdd_sram_core',0.750,   0.002, 'rem',  True),  #RS30
  ('pac1954',  '0x17:2',  'pp3300_tchpad_s3',     3.300,   0.02,  'rem',  True),  #RS25
  ('pac1954',  '0x17:3',  'pp3300_ucam_x',        3.300,   0.02,  'rem',  True),  #RS6
  ('pac1954',  '0x1a:0',  'pp3300_edp_x',         3.300,   0.02,  'rem',  True),  #RS4
  ('pac1954',  '0x1a:1',  'ppvar_edp_bl_s3',      13.200,  0.02,  'rem',  True),  #RS24
  ('pac1954',  '0x1a:2',  'pp3300_tchscr_x',      3.300,   0.02,  'rem',  True),  #RS5
  ('pac1954',  '0x1a:3',  'ppvar_vbus_in',        15.000,  0.01,  'rem',  True),  #R501
]
