...
#   drvname,   slv,     name,               nom,   sense, mux,   is_calib
   ...
   ('ina231',  '0x41',  'ppvar_sys',        13.2,  0.01,  'rem', True),  # R376
   ('ina231',  '0x42',  'ppvar_vbus_in',    15.0,  0.01,  'rem', True),  # RS4
   ('ina231',  '0x43',  'pp5000_z2',        5.0,   0.01,  'rem', True),  # R546
   ('ina231',  '0x44',  'pp4200_z2',        4.2,   0.01,  'rem', True),  # R535
   ...
   ('ina231',  '0x49',  'pp3300_hub',       3.3,   0.02,  'rem', True),  # RS13
   ('ina231',  '0x4a',  'pp3300_c0_mux',    3.3,   0.02,  'rem', True),  # RS14
   ('ina231',  '0x4b',  'pp3300_z2_sub',    3.3,   0.02,  'rem', True),  # RS29
   ...
   ('ina231',  '0x4f',  'pp3300_lte',       3.3,   0.02,  'rem', True),  # RS27
]
