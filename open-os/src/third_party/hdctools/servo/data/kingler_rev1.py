...
"""kingler proto1 on-board adc map"""

# generates kingler_rev1
revs = [1]

# these devices are pac1934 (4-channels/i2c address) devices
inas = [
#    drvname,    slv,        name,                nom,    sense, mux,   is_calib
   ('pac1934',   '0x10:0',   'ppvar_batt_chg',    12.00,  0.010, 'rem', True),  # RS15
   ('pac1934',   '0x10:1',   'ppvar_batt_dischg', 12.00,  0.010, 'rem', True),  # RS15
   ('pac1934',   '0x11:0',   'ppvar_sys',         12.00,  0.010, 'rem', True),  # R376
   ('pac1934',   '0x11:1',   'ppvar_vbus_in',     20.00,  0.010, 'rem', True),  # RS4
   ('pac1934',   '0x12:0',   'ppvar_bl',          12.00,  0.020, 'rem', True),  # R453
   ...
   ('pac1934',   '0x14:0',   'pp3300_hub',        3.300,  0.020, 'rem', True),  # RS13
   ...
   ('pac1934',   '0x1a:1',   'pp1800_vio18_s3',   1.800,  0.010, 'rem', True),  # RS11
   ('pac1934',   '0x1b:0',   'pp3300_z2',         3.300,  0.010, 'rem', True),  # R533
   ('pac1934',   '0x1b:1',   'pp3300_c0_mux',     3.300,  0.020, 'rem', True),  # RS14
   ('pac1934',   '0x1c:0',   'pp3300_gsc_z2',     3.300,  0.020, 'rem', True),  # RS19
   ('pac1934',   '0x1c:1',   'pp1800_gsc_z2',     1.800,  0.020, 'rem', True),  # RS18
   ('pac1934',   '0x1d:0',   'pp3300_ec_z2',      3.300,  2.200, 'rem', True),  # R511
   ('pac1934',   '0x1d:1',   'pp1800_ec_z2',      1.800,  2.200, 'rem', True),  # R512
   ('pac1934',   '0x1e:0',   'pp5000_lspkr',      5.000,  0.020, 'rem', True),  # R489
   ('pac1934',   '0x1e:1',   'pp3300_cs',         3.300,  0.020, 'rem', True),  # RS12
   ('pac1934',   '0x1f:1',   'pp5000_rspkr' ,     5.000,  0.020, 'rem', True),  # R481
]
