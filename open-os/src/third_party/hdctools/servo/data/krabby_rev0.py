...
"""krabby proto0 on-board adc map"""

# generates krabby_rev0
revs = [0]
...
#    drvname,    slv,        name,                nom,    sense, mux,   is_calib
   ...
   ('pac1934',   '0x1e:0',   'pp5000_spkr_usba',  5.000,  0.020, 'rem', True),  # RS2
   ('pac1934',   '0x1e:1',   'pp3300_cs',         3.300,  0.020, 'rem', True),  # RS26
   ('pac1934',   '0x1f:0',   'pp3300_lte',        3.300,  0.020, 'rem', True),  # RS27
]
