...
inas = [
    ...
    ("pac1954", "0x10:0", "PPVAR_BAT", 13.2, 0.005, "rem", True),  # R448
    ...
    ("pac1954", "0x14:0", "PPVAR_SYS_1800_S5", 9, 0.02, "rem", True),  # R69
    ...
    ("pac1954", "0x15:2", "PPVAR_VCCIN_AUX", 9, 0.001, "rem", True),  # R1274
    ("pac1954", "0x15:3", "PPVAR_SYS_VCCIN_AUX", 1.8, 0.002, "rem", True),  # R692
    ("pac1954", "0x16:0", "PP3300_Z5", 3.3, 0.5, "rem", True),  # R904
    ("pac1954", "0x16:1", "PPVAR_SYS_5000_Z1", 9, 0.01, "rem", True),  # R597
    ("pac1954", "0x16:2", "PPVAR_SYS_3300_S5", 9, 0.02, "rem", True),  # R1009
    ("pac1954", "0x16:3", "PP5000_Z1", 5, 0.001, "rem", True),  # R560
    ("pac1954", "0x17:0", "PPVAR_VBUS_IN", 20, 0.01, "rem", True),  # R430
    ("pac1954", "0x17:1", "PP5000_PD_Z1", 5, 0.005, "rem", True),  # R985
    ("pac1954", "0x17:2", "PP3300_PD_PIN32", 3.3, 0.01, "rem", True),  # R986
    ("pac1954", "0x17:3", "PP0500_MEM_S0", 0.5, 0.01, "rem", True),  # RS1
    ...
    ("pac1954", "0x1a:0", "PPVAR_SYS_VCCCORE_GT", 13.2, 0.005, "rem", True),  # R1137
    ("pac1954", "0x1a:1", "PPVAR_SYS_VCCGT", 13.2, 0.005, "rem", True),  # R1139
    ("pac1954", "0x1a:2", "PPVAR_VCCGT", 1.5, 0.0005, "rem", True),  # R91395
    ("pac1954", "0x1a:3", "PPVAR_VCCCORE_PH1", 1.5, 0.001, "rem", True),  # R91391
    ("pac1954", "0x1b:0", "PPVAR_VCCCORE_PH2", 1.5, 0.001, "rem", True),  # R91394
]
