...
inas = [
    ...
    ('ina231', '0x41', 'ppvar_batt',      13.05,  0.010, 'rem', True), # RS15
    ('ina231', '0x42', 'pp4200_z2',       4.2,    0.010, 'rem', True), # RS16
    ('ina231', '0x43', 'ppvar_bl',        13.05,  0.010, 'rem', True), # RS10
    ('ina231', '0x44', 'pp3300_z2',       3.3,    0.010, 'rem', True), # RS6
    ('ina231', '0x45', 'pp5000_s5',       5.0,    0.010, 'rem', True), # RS7
    ('ina231', '0x46', 'pp3300_gsc_z2',   3.3,    0.020, 'rem', True), # RS12
    ('ina231', '0x47', 'ppvar_sys',       13.05,  0.010, 'rem', True), # RS4
    ('ina231', '0x48', 'pp1800_vio18_s3', 1.8,    0.020, 'rem', True), # RS9
    ('ina231', '0x49', 'pp3300_ts_s3',    3.3,    0.020, 'rem', True), # RS17
    ('ina231', '0x4a', 'pp1800_gsc_z2',   1.8,    0.020, 'rem', True), # RS13
    ('ina231', '0x4b', 'pp1800_ec_vcc',   1.8,    0.020, 'rem', True), # RS19
