...
inas = [
    ...
    ('ina231', (4,10),    'pp1200_pd_s5',           1.2, 0.010, 'android', True), # R296, USB C0 C1 TCPC
    ...
    ('ina231', (19,25),   'pp3300_codec',           3.3, 0.010, 'android', True), # R345, audio DAC
    ...
    ('ina231', (24,30),   'pp3300_ssd',             3.3, 0.025, 'android', True), # R77, SSD, original 0.010mohm
    ...
    ('ina231', (34,40),   'pp3300_hub',             3.3, 0.010, 'android', True), # R102, USB hub + boot flash
    ('ina231', (41,47),   'pp5000_s5',              5.0, 0.050, 'android', True), # R170, speaker amps + kbd bl + USB A0 C0 C1, original 0.005mohm
    ('ina231', (36,42),   'pp3300_pd_s5_rb',        3.3, 0.500, 'android', True), # R88, USB C1
    ('ina231', (49,55),   'ppvar_sys_pp3300_z1_in', 8.8, 0.010, 'android', True), # R484, before voltage change
    ('ina231', (51,57),   'pp2850_wf_vcm',          2.85, 0.01, 'android', True), # R413, WF cam
    ('ina231', (53,59),   'pp3300_ec_r_s5',         3.3, 2.200, 'android', True), # R94, EC
    ('ina231', (67,73),   'src_vph_pwr',            3.9, 0.010, 'android', True), # R375, MB + UF cam
    ('ina231', (62,68),   'pp3300_tcpc_c0',         3.3, 0.500, 'android', True), # R482, USB C0
    ('ina231', (64,70),   'pp1800_sensors_s5',      1.8, 0.100, 'android', True), # R135, lid accel + ALS + gyro
    ...
    ('ina231', (81,87),   'pp1800_gsc_z1',          1.8, 0.010, 'android', True), # R147, security
    ('ina231', (83,89),   'pp3300_ec_s5',           3.3, 0.010, 'android', True), # R134, EC + EEPROM
    ('ina231', (97,103),  'pp3300_ec_stby_z1',      3.3, 0.010, 'android', True), # R204, RTC + EC + USB C1
    ('ina231', (92,98),   'pp3300_gsc_z1',          3.3, 0.025, 'android', True), # R191, security + spi flash analog mux, original 0.010ohm
    ('ina231', (99,105),  'pp3300_pd_s5',           3.3, 0.010, 'android', True), # R189, USB C0 C1
    ...
    ('ina231', (112,118), 'ppvar_sys_bl',           8.8, 0.010, 'android', True), # R368
