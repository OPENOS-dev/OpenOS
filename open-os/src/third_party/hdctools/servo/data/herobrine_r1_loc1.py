...
inas = [
    ...
    ('ina231', (24,30),   'pp3300_ssd',             3.3, 0.010, 'android', True), # R77, SSD
    ...
    ('ina231', (41,47),   'pp5000_s5',              5.0, 0.005, 'android', True), # R170, speaker amps + kbd bl + USB A0 C0 C1
    ...
    ('ina231', (92,98),   'pp3300_gsc_z1',          3.3, 0.010, 'android', True), # R191, security + spi flash analog mux
