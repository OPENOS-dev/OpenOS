...
struct vn_graphics_pipeline_fix_tmp {
   ...
   VkPipelineCreateFlags2CreateInfoKHR *flags2_infos;
...
vn_graphics_pipeline_library_state_update(
   ...
   VkPipelineCreateFlags2KHR flags2,
   ...
   struct vn_graphics_pipeline_fix_desc *out_fix_desc)
{
    ...
    *    VkPipeline handle
    */
   if ((flags2 & VK_PIPELINE_CREATE_2_DERIVATIVE_BIT_KHR) &&
                           ...
                           VkPipeline *pPipelines)
{
   ...
   for (uint32_t i = 0; i < createInfoCount; i++) {
      ...
      const VkPipelineCreateFlags2KHR flags2 = vn_pipeline_create_flags2(
