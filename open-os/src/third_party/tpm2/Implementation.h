...
#define    CC_Commit                         CC_SET((CC_S_TCG_MUST * ALG_ECC))
...
#define    CC_Duplicate                      CC_SET(CC_S_WIN_TCG  | CC_S_CROS_MUST)
...
#define    CC_TestParms                      CC_SET(CC_S_TCG_MUST | CC_S_CROS_MUST)
...
//
#define MAX_NV_BUFFER_SIZE                1280
