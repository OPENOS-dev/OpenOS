...
typedef struct
{
  ...
  int max_messages_per_connection;      /**< Max number of pending messages addressed to a connection */
...
int               bus_context_get_max_messages_per_connection    (BusContext       *context);
