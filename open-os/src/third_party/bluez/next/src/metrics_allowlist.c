 ...
 */
static const int chipset_info_allow_list_vidpid[][3] = {
	/* Intel */
...
static const struct chipstr_transport {
	int transport;
	uint64_t hash_value;
	const char *str;
} chipset_info_allow_list_str[] = {
	{ USB, 0x676651522ac38489ULL,
		"usb:v8087p0AAAd0002dcE0dsc01dp01icE0isc01ip01in00" },
	{ UART, 0x0f7029c4e4bee5c2ULL,
		"of:NbluetoothT(null)Cqcom,wcn3991-bt" },
	{ USB, 0xc87adddb3473cef2ULL,
		"usb:v8087p0033d0000dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0xd4af1ceff203aa54ULL,
		"usb:v8087p0A2Ad0003dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0x67ff2e0860c6088cULL,
		"usb:v8087p0026d0002dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0x5ea49b43333b6757ULL,
		"usb:v0BDApB009d0200dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0xae4252633a7fc378ULL,
		"usb:v0A12p0001d8891dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0xe8b1d7dcab4a9180ULL,
		"usb:v05ACp821Fd0156dcFFdsc01dp01icFFisc01ip01in00" },
	{ USB, 0xf2fc524b34906492ULL,
		"usb:v413Cp8160d0173dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0xa16695ffe3ebcf8eULL,
		"usb:v0BDApB00Cd0000dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0x45fa5f31f455c161ULL,
		"usb:v05ACp821Ad0042dcFFdsc01dp01icFFisc01ip01in00" },
	{ USB, 0xed0707b5f055458dULL,
		"usb:v05ACp821Dd0156dcFFdsc01dp01icFFisc01ip01in00" },
	{ UART, 0x645c8874e1a27038ULL,
		"of:NbluetoothT(null)Cqcom,wcn6750-bt" },
	{ USB, 0xf8feae883f843f61ULL,
		"usb:v0A5Cp21BCd0761dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0x3db1b39b76523e6fULL,
		"usb:v0A5Cp219Cd0628dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0xa4fec7094cdb7bedULL,
		"usb:v05ACp8205d1965dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0x952ae80214a19dd9ULL,
		"usb:v05ACp828Ad0150dcFFdsc01dp01icFFisc01ip01in00" },
	{ USB, 0x40e84e9cf6844c32ULL,
		"usb:v8087p0025d0002dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0x6b037999f75bc6ceULL,
		"usb:v0A5Cp21F1d0112dcFFdsc01dp01icFFisc01ip01in00" },
	{ USB, 0x91be30aba4f17b7eULL,
		"usb:v8087p0A2Ad0001dcE0dsc01dp01icE0isc01ip01in00" },
	{ USB, 0xd393d6690ca2c212ULL,
		"usb:v0BDApB720d0200dcEFdsc02dp01icE0isc01ip01in00" },
};
				...
				const char *chipset_string, uint64_t *hval)
{
	...
	if (vendor_id != 0 && product_id != 0) {
		for (i = 0; i < sizeof(chipset_info_allow_list_vidpid) /
				sizeof(chipset_info_allow_list_vidpid[0]);
		     i++) {
			const int *record = chipset_info_allow_list_vidpid[i];

			if (transport == record[0] &&
			    vendor_id == record[1] &&
			    product_id == record[2])
				return true;
		}
	} else if (!!chipset_string && !!strlen(chipset_string)) {
		for (i = 0; i < sizeof(chipset_info_allow_list_str) /
				sizeof(chipset_info_allow_list_str[0]);
		     i++) {
			const struct chipstr_transport *record =
						&chipset_info_allow_list_str[i];

			if (strcmp(chipset_string, record->str) == 0 &&
