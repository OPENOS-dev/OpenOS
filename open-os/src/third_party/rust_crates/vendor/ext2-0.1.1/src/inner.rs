...
pub struct Ext2Filesystem<T: Read + Write + Seek> {
...
impl<T: Read + Write + Seek> fmt::Debug for Ext2Filesystem<T> {
...
struct EntryIter<'a, T: Read + Write + Seek> {
    filesystem: &'a Ext2Filesystem<T>,
    inode: (Inode, u64),
    curr_offset: u32,
}

impl<'a, T: Read + Write + Seek> Iterator for EntryIter<'a, T> {
