    ...
    cups_lang_t *lang)			/* I - Language */
{
  ...
  */
  ...
  ipp_attribute_t *copies_supported =
      ippFindAttribute(supported, "copies-supported", IPP_TAG_RANGE);
  if (copies_supported) {
