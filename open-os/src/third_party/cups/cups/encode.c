...
static const _ipp_option_t ipp_options[] =
{
  ...
  { 1, "client-info",		IPP_TAG_BEGIN_COLLECTION, IPP_TAG_OPERATION,
							IPP_TAG_ZERO,
							ipp_job_creation },
  { 0, "client-name",		IPP_TAG_NAME,	IPP_TAG_OPERATION,
							IPP_TAG_ZERO,
							ipp_job_creation },
  { 0, "client-patches",		IPP_TAG_TEXT,	IPP_TAG_OPERATION,
							IPP_TAG_ZERO,
							ipp_job_creation },
  { 0, "client-string-version",IPP_TAG_TEXT,	IPP_TAG_OPERATION,
							IPP_TAG_ZERO,
							ipp_job_creation },
  { 0, "client-type",		IPP_TAG_ENUM,	IPP_TAG_OPERATION,
							IPP_TAG_ZERO,
							ipp_job_creation },
  { 0, "client-version",		IPP_TAG_STRING,	IPP_TAG_OPERATION,
							IPP_TAG_ZERO,
							ipp_job_creation },
