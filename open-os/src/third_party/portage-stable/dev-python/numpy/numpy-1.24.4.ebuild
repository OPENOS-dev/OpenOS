...
python_prepare_all() {
	...
	# Disable AVX-512 acceleration of floating-point operations on non-x86
	# architectures. See
	# https://github.com/numpy/doc/blob/cf4a45ee23c639295256125de55d69a423529c42/1.24/user/building.html#L797.
	if ! use x86; then
...
python_test() {
	local EPYTEST_DESELECT=(
		...
		# runs the whole test suite recursively, that's just bonkers
