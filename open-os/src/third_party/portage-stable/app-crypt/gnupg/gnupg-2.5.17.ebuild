...
my_src_configure() {
	...
	# ChromeOS: Fix cross-compilation. (https://bugs.gentoo.org/914711)
	if tc-is-cross-compiler; then
		export ac_cv_path_NPTH_CONFIG="${CHOST}-npth-config"
	else
		export ac_cv_path_NPTH_CONFIG="${ESYSROOT}/usr/bin/npth-config"
	fi
