...
typedef struct tagINIT_INFORMATION {
  ...
  LPCTSTR szProductName;    /* [in]���i�� ex. DR-2580C */ 
  LPCTSTR szLocalizeFilePath; /* [in]���[�J���C�Y�t�@�C���̃p�X�BNULL�̏ꍇ�A�����B */
    LPCTSTR szLibraryFilePath;  /* [in]���C�u�����̃p�X�BNULL�̏ꍇ�A�����B */
...
public:
  //STI�̏������E�I������
  virtual INT32 STDMETHODCALLTYPE InitSTI(TCHAR *pConnectionName/*ex pConnectionName = "STI - 0000"; */)=0;
...
/*
ICeiSti::SendCustom�ɂ���
�d�l���̂P�@�X�L���i���{on STI 00**���擾����B
������NULL, 0, -1, �o�b�t�@, �o�b�t�@�T�C�Y
��F
  TCHAR buf[256]={0};
  SendCustom(NULL, 0, -1, buf, _countof(buf));
  buf�́A"�X�L���i���{on STI 00**"�ƂȂ�
...
typedef struct tagPROBE_INFORMATION {
  DWORD dwSize;       /* [in]size of this structure */
  LPCTSTR szProductName;    /* [in]���i�� ex. DR-2580C */ 
  ICeiSti *pSti;        /* [in]�X�L���i�ɃR�}���h�𑗂邽�߂̃N���X�BNULL�̏ꍇ�A�����B*/
  bool    SimulationMode;     /* [in]�V�~�����[�V�������[�h�؂�ւ��t���O*/ 
