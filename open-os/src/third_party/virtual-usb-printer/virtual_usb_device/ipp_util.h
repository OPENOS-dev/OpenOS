...
#ifndef VIRTUAL_USB_DEVICE_IPP_UTIL_H_
#define VIRTUAL_USB_DEVICE_IPP_UTIL_H_
...
class IppHeader {
 public:
  ...
  static std::optional<IppHeader> Deserialize(SmartBuffer* message);
...
#endif  // VIRTUAL_USB_DEVICE_IPP_UTIL_H_
