...
#ifndef SRC_OPENSHORTCONFIG_H_
#define SRC_OPENSHORTCONFIG_H_
...
class OrderOpenShortConfig {
 ...
 public:
  OrderOpenShortConfig() : reArrange(false), InvXorder(0), InvYorder(0) {}
};
...
class OpenShortConfig {
 public:
  ...
  OpenShortConfig();
  static bool loadOpenShortConfig(char* filename, OpenShortConfig* config,
                                  bool isMuti);
