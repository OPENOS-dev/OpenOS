...
#ifndef SRC_OPENSHORTRESULT_H_
#define SRC_OPENSHORTRESULT_H_
...
class OpenShortResult {
 ...
 public:
  ...
  static void fprintData(FILE *fp2D, OpenShortData *data,
                         OpenShortResult *result, OpenShortConfig *config,
                         int tableID);
  ...
  static void transferPointResultToErrorReasonSimple(unsigned int result,
                                                     char *buf);
  static bool saveOpenShortResult(FILE *file, OpenShortData *data,
