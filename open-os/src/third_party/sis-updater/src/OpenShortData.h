...
#ifndef SRC_OPENSHORTDATA_H_
#define SRC_OPENSHORTDATA_H_
...
class OpenShortData {
 ...
 public:
  ...
  inline int getBtnChannel() { return 0; }
  ...
  bool loadSampleSeedResultFile(FILE* file, const int x_inverse,
                                const int y_inverse, bool bFilter = false);
