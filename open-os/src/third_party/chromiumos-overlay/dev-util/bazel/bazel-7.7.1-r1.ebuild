...
inherit bash-completion-r1 flag-o-matic java-pkg-2 multiprocessing

DESCRIPTION="Fast and correct automated build system"
HOMEPAGE="https://bazel.build/"

SRC_URI="
	https://github.com/bazelbuild/bazel/releases/download/${PV}/${P}-dist.zip
"
...
src_compile() {
	...
	append-cppflags -Wno-error=deprecated-builtins
	export EXTRA_BAZEL_ARGS="${BAZEL_ARGS[*]} $(bazel-get-flags)"
	export BAZEL_DEV_VERSION_OVERRIDE="${PV}"
