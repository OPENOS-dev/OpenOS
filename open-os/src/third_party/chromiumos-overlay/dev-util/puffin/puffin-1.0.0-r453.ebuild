...
CROS_WORKON_COMMIT=("471962251575bc16bb51fd8a7a2fb01287a287e2" "dd52f5f53116b5880387bc1a878478e172b768be")
CROS_WORKON_TREE=("dbc76c889309287e40c7a572a21112216ba2f69e" "f91b6afd5f2ae04ee9a2c19109a3a4a36f7659e6" "d5b2e1140bb5d80e845bd170bd364e892b05ebd1")
...
src_prepare() {
	...
	eapply "${FILESDIR}"/puffin-logging-LOG_FATAL-LOGGING_FATAL.patch
	eapply "${FILESDIR}"/puffin-skip-last-incomplete-gzip-entry.patch
	eapply_user
}
