...
DESCRIPTION="List of packages required for the ChromiumOS Printing subsystem"
...
RDEPEND="
	...
	net-print/cups-filter-rastertoescpos
	net-print/custom-cupsdrv
	net-print/dymo-cups-drivers
	net-print/epson-inkjet-printer-colorworks
	net-print/epson-inkjet-printer-escpr
	net-print/epson-receipt-printer-thermal
	net-print/hwasung-cupsdrv
	net-print/pwgtocanonij
	net-print/starcupsdrv
	!arm? ( net-print/tsc-cupsdrv )
	internal? (
		...
		postscript? ( net-print/hplip-plugin )
	)
