...
DESCRIPTION="List of packages that are needed inside the ChromiumOS test image;
...
CROS_COMMON_RDEPEND="
	...
	chromeos-base/heartd-tool
	!no_factory_flow? ( virtual/factory-deps )
	biod? (
		virtual/chromeos-fpmcu-test
		virtual/chromeos-fpmcu-unittests
	)
	...
	scanner? (
		...
		chromeos-base/lorgnette-wwcb-sane-backend-tests
	...
	camera_feature_super_res? (
		media-libs/cros-camera-super-res-tests
	)
	racc? ( chromeos-base/factory_runtime_probe )
	rmad? ( chromeos-base/factory_generate_ssfc )
	...
	p2p? ( dev-python/dpkt )
	perfetto? (
		chromeos-base/dbus_perfetto_producer
...
CROS_RDEPEND="${CROS_RDEPEND}
	app-accessibility/screen-ai-ocr-test
	app-admin/sudo
	app-arch/gzip
	app-arch/tar
	...
	chromeos-base/policy-test-tool
	...
	media-gfx/zbar
	arc-camera3? (
		camera_diagnostics? ( media-libs/cros-camera-diagnostics-tests )
	...
	media-libs/cros-camera-basic-ops-perf-tests
	media-libs/cros-camera-feature-benchmark
