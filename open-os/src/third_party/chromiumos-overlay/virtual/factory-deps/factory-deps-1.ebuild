...
DESCRIPTION="List of packages that are needed for ChromeOS factory software to run factory env on hw."
...
# Install Factory Installer on test image for tast test and battery cutoff.
FACTORY_TEST_RDEPEND+="
	chromeos-base/factory_installer_rust
"
