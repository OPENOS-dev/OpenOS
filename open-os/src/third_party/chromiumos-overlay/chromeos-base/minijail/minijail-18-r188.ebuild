...
CROS_WORKON_COMMIT="d2e47c2e9aaaa2b175162c31b6bb8976cc762e1a"
CROS_WORKON_TREE="3646bd96de6a73124f266edeec90128b62b57a87"
...
inherit cros-debug cros-sanitizers cros-workon cros-common.mk cros-toolchain-funcs distutils-r1
...
DEPEND="${COMMON_DEPEND}
	cros_host? (
		$(python_gen_cond_dep 'dev-python/gpep517[${PYTHON_USEDEP}]')
...
src_configure() {
	...
	export USE_LIBC_COMPATIBILITY_ALLOWLIST=yes
