...
CROS_WORKON_COMMIT=(
	"14a2c8f523b9541ffe34d2fef94f3e35b4387109" # policy
	"3bdfdd53bcda6b8b24fcbb3d1b3a4176bec2f5d8" # private_membership
	"0fac8a073afdecfabe6d6178fe9c7a98374e681c" # shell-encryption
)
# git rev-parse $HASH:./
CROS_WORKON_TREE=(
	"ea3210adb0c3b724db5e3b0c9af77b1fab48ba3f" # policy
	"ee335bdae5fea807369030dcd4cec27f09f29582" # private_membership
	"742561e0dd355438da682b68d1fe8eabaa360894" # shell-encryption
)
...
src_compile() {
	...
	chrome_major_version=$(grep "^MAJOR" "${FILESDIR}/VERSION" | awk -F"=" '{ print $2 }')
	"${POLICY_DIR}/tools/generate_policy_source.py" \
		--cloud-policy-protobuf="${WORKDIR}/cloud_policy.proto" \
		--chrome-version-major="${chrome_major_version}" \
