...
EAPI=7
CROS_WORKON_COMMIT="38aa832662869871c8791af4c2bc15d47f0ea5a2"
CROS_WORKON_TREE="b7a153ed96db724ce43b47499e16375a35c9e1e9"
...
inherit cros-workon python-single-r1 cros-constants cros-factory cros-protobuf
...
RDEPEND="
	${PYTHON_DEPS}
	virtual/factory-deps
"
DEPEND="
	${PYTHON_DEPS}
	test? ( virtual/factory-deps )
