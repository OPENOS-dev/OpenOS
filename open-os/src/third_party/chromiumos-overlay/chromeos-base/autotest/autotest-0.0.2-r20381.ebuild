...
CROS_WORKON_COMMIT=("366eea64d1d8cb97ab527f7de303fea8056acf35" "61c30f0d70adfeaf9cb0979f27a678a9cdd87946" "bde3bfb64b88a82d40479120526503f70f9c0f62")
CROS_WORKON_TREE=("b4188693e827e91fc307c310555a15405eee7289" "ed7fc6979a1dbe18179fb4433a67f41c7768f070" "2fb949ef2643929d25fe4b08c59e1c1a8e61866b")
...
src_prepare() {
	...
	cp -fpru "${S}"/{cache_server,tko,utils,site_utils,test_suites,frontend} "${AUTOTEST_WORK}"
	...
	# Copy fw-testing-configs/CONSOLIDATED.json into work dir
	cp -fpu "${S}/fw-testing-configs/CONSOLIDATED.json" "${AUTOTEST_WORK}" || die
	# Copy fw-testing-configs/CONSOLIDATED.json into ${S}, just for the unit tests
	cp -fpu "${S}/fw-testing-configs/CONSOLIDATED.json" "${S}" || die
