...
EAPI=7
CROS_WORKON_COMMIT="2cb29356b6c1a30f25f1239b7549a6e2a574dde5"
CROS_WORKON_TREE="e1fe2ca7ee3695e52be6ee9883467ddba870de4e"
...
src_install() {
	...
	for policy in "${policies[@]}"; do
		doins etphidiap/policies/"${ARCH}"/etphidiap."${policy}".policy
	done
}
