...
inherit cros-fuzzer cros-sanitizers cmake flag-o-matic
...
SLOT="0/34.157"
KEYWORDS="*"
IUSE="cros_host doc examples test systemd"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-1.57.0-fix-template-args.patch"
	"${FILESDIR}/${PN}-1.43.0-build-codegen.patch"
)
