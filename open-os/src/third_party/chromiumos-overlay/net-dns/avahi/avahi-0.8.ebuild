...
PATCHES=(
	...
	"${FILESDIR}/${PN}-0.8-drop-local-localhost.patch"
	"${FILESDIR}/${PN}-0.8-inexpensive-checks-first.patch"
	"${FILESDIR}/${PN}-0.8-onepass-domain-equal.patch"
	"${FILESDIR}/${PN}-0.8-key-hash-type-fix.patch"
	"${FILESDIR}/${PN}-0.8-CVE-2023-38469.patch"
	"${FILESDIR}/${PN}-0.8-CVE-2023-38470.patch"
	"${FILESDIR}/${PN}-0.8-CVE-2023-38471.patch"
	"${FILESDIR}/${PN}-0.8-CVE-2023-38472.patch"
	"${FILESDIR}/${PN}-0.8-CVE-2023-38473.patch"
)
