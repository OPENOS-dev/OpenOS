...
EAPI=7
inherit flag-o-matic autotools multilib-minimal systemd cros-toolchain-funcs udev \
...
src_prepare() {
	...
	eapply "${FILESDIR}"/sane-backends-1.2.1-Bind-socket-for-epson2-network-discovery.patch
	eapply "${FILESDIR}"/sane-backends-1.3.1-CHROMEOS-Remove-conflicting-backends.patch
	eapply "${FILESDIR}"/sane-backends-1.3.1-epsonds-add-SSL-support-and-new-models.patch
	eapply "${FILESDIR}"/sane-backends-1.4.0-epsonds-epson2-changes-from-Epson.patch
