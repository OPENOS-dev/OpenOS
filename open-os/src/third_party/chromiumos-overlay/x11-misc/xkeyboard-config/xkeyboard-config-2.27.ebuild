...
PATCHES=(
	...
	"${FILESDIR}"/${P}-remap-xf86-vt-switch-to-fkey.patch
	...
	"${FILESDIR}"/${P}-us-noop-altgr.patch
	"${FILESDIR}"/${P}-bg-101.patch
	"${FILESDIR}"/${P}-jp-default-layout.patch
	"${FILESDIR}"/${P}-jp-remove-prsc-execute.patch
	"${FILESDIR}"/${P}-kr-add-cros-variant.patch
	"${FILESDIR}"/${P}-hr.patch
	"${FILESDIR}"/${P}-ee.patch
