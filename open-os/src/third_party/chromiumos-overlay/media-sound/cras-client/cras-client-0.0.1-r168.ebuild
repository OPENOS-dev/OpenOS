...
CROS_WORKON_COMMIT="20c71c2d55f9b7831a26b1143c662e1b460cd010"
CROS_WORKON_TREE=("b4831761139c269c3e3e8b6b070b825cee1eb86f" "f65908a4a13948388be0de034afa96484c7e96dc" "2429c745d66b1b5e0e3883ed625136af0c0308e6" "07a7dc03bdeb178a5879a8d6563ad972e8c821e8")
...
# TODO(b/312900687): Reenable incremental build when the issue is fixed.
# CROS_WORKON_INCREMENTAL_BUILD=1
CROS_WORKON_SUBTREE="${CROS_RUST_SUBDIR} cras/common cras/include cras/dbus_bindings"
...
# versions.
export_crates=("cras-sys" "libcras" "cras_common")
export_crate_versions=("0.1.0" "0.1.0" "0.1.0")
# Relative to cras/client.
export_crate_paths=("cras-sys" "libcras" "../common")
