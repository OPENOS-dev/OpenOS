...
inherit cros-constants python-any-r1 cros-toolchain-funcs
...
RUST_SRC_TARBALL_NAME="rustc-1.90.0-src"

BOOTSTRAP_HOST_TRIPLE="x86_64-unknown-linux-gnu"
RUST_STAGE0_DATE="2025-08-07"
RUST_STAGE0_VERSION="1.89.0"
...
SRC_URI+="
	https://static.rust-lang.org/dist/${RUST_SRC_TARBALL_NAME}.tar.gz -> ${RUST_SRC_TARBALL_NAME}.tar.gz
	https://static.rust-lang.org/dist/${RUST_STAGE0_DATE}/${RUST_CARGO_TARBALL_NAME}.tar.xz -> ${RUST_CARGO_TARBALL_NAME}.tar.xz
	https://static.rust-lang.org/dist/${RUST_STAGE0_DATE}/${RUST_STAGE0_TARBALL_NAME}.tar.xz -> ${RUST_STAGE0_TARBALL_NAME}.tar.xz
	https://static.rust-lang.org/dist/${RUST_STAGE0_DATE}/${RUST_STD_TARBALL_NAME}.tar.xz -> ${RUST_STD_TARBALL_NAME}.tar.xz
	https://static.rust-lang.org/dist/${RUST_STAGE0_DATE}/${RUST_RUSTFMT_TARBALL_NAME}.tar.xz -> ${RUST_RUSTFMT_TARBALL_NAME}.tar.xz
"
...
src_prepare() {
	...
	# Change rustc_llvm from libstdc++ to libc++.
	...
	eapply "${FILESDIR}/rust-rustc_llvm-stage0-is-not-cross-compiling.patch"
	eapply "${FILESDIR}/rust-allow-stage0-builds-like-stage1-with-local_rebuild.patch"
	eapply "${FILESDIR}/rust-relax-stable.patch"
