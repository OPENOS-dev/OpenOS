...
PATCHES=(
	...
	# CVE-2024-0409
	"${FILESDIR}"/0001-xwayland-proper-cursor-private-key.patch

	# CVE-2023-6816
	"${FILESDIR}"/0001-dix-allocate-enough-space-for-logical-button-maps.patch

	# CVE-2024-0408
	"${FILESDIR}"/0001-glx-Call-XACE-hooks-on-the-GLX-buffer.patch

	# CVE-2025-26594
	"${FILESDIR}"/0009-Cursor-Refuse-to-free-the-root-cursor.patch
	"${FILESDIR}"/0010-dix-keep-a-ref-to-the-rootCursor.patch

	# CVE-2025-26595
	"${FILESDIR}"/0011-xkb-Fix-buffer-overflow-in-XkbVModMaskText.patch

	# CVE-2025-26596
	"${FILESDIR}"/0012-xkb-Fix-computation-of-XkbSizeKeySyms.patch

	# CVE-2025-26597
	"${FILESDIR}"/0013-xkb-Fix-buffer-overflow-in-XkbChangeTypesOfKey.patch

	# CVE-2025-26598
	"${FILESDIR}"/0014-Xi-Fix-barrier-device-search.patch

	# CVE-2025-26599
	"${FILESDIR}"/0015-composite-Handle-failure-to-redirect-in-compRedirectWindow.patch
	"${FILESDIR}"/0016-composite-initialize-border-clip-even-when-pixmap-alloc-fails.patch

	# CVE-2025-26600
	"${FILESDIR}"/0017-dix-Dequeue-pending-events-on-frozen-device-on-removal.patch

	# CVE-2025-26601
	"${FILESDIR}"/0018-sync-Do-not-let-sync-objects-uninitialized.patch
	"${FILESDIR}"/0019-sync-Check-values-before-applying-changes.patch
	"${FILESDIR}"/0020-sync-Do-not-fail-SyncAddTriggerToSyncObject.patch
	"${FILESDIR}"/0021-sync-Apply-changes-last-in-SyncChangeAlarmAttributes.patch
)
