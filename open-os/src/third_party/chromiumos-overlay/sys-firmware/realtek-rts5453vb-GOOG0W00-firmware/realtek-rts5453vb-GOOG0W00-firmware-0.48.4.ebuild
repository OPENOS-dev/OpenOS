...
DESCRIPTION="RTS5453-VB Firmware GOOG0W00 Binary"
...
#          realtek-rts5453vb-GOOG0W00-firmware-${PV}/rts5453_V${PV}.bin
...
# 4) Finally run `ebuild realtek-rts5453vb-GOOG0W00-firmware-${PV}.ebuild manifest`
src_install() {
	...
	local bf=rts5453vb_GOOG0W00.bin
	local hf=rts5453vb_GOOG0W00.hash
