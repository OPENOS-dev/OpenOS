...
DESCRIPTION="RTS5453 Firmware retimer_jhl9040 Binary"
...
#    ex: tar -cJf realtek-rts5453-retimer_jhl9040-firmware-${PV}.tar.xz \
#          realtek-rts5453-retimer_jhl9040-firmware-${PV}/rts5453_V${PV}.bin
...
# 4) Finally run `ebuild realtek-rts5453-retimer_jhl9040-firmware-${PV}.ebuild manifest`
src_install() {
	...
	local bf=rts5453_retimer_jhl9040.bin
	local hf=rts5453_retimer_jhl9040.hash
