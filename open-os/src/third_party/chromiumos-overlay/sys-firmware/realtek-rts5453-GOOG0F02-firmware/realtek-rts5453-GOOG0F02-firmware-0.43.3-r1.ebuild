...
DESCRIPTION="RTS5453 Firmware GOOG0F02 Binary"
...
#    ex: tar -cJf realtek-rts5453-GOOG0F02-firmware-${PV}.tar.xz \
#          realtek-rts5453-GOOG0F02-firmware-${PV}/rts5453_V${PV}.bin
...
# 4) Finally run `ebuild realtek-rts5453-GOOG0F02-firmware-${PV}.ebuild manifest`
src_install() {
	...
	local bf=rts5453_GOOG0F02.bin
	local hf=rts5453_GOOG0F02.hash
