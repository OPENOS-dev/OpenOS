...
DESCRIPTION="RTS5453 Firmware GOOG0B00 Binary"
...
#    ex: tar -cJf realtek-rts5453-GOOG0B00-firmware-${PV}.tar.xz \
...
# 4) Finally run `ebuild realtek-rts5453-GOOG0B00-firmware-${PV}.ebuild manifest`
src_install() {
	...
	local bf=rts5453_GOOG0B00.bin
	local hf=rts5453_GOOG0B00.hash
