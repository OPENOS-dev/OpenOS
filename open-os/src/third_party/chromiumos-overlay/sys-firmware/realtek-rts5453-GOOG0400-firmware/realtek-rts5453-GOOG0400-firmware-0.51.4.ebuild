...
DESCRIPTION="RTS5453 Firmware GOOG0400 Binary"
...
#    ex: tar -cJf realtek-rts5453-GOOG0400-firmware-${PV}.tar.xz \
#          realtek-rts5453-GOOG0400-firmware-${PV}/rts5453_V${PV}.bin
...
# 4) Finally run `ebuild realtek-rts5453-GOOG0400-firmware-${PV}.ebuild manifest`
src_install() {
	...
	local bf=rts5453_GOOG0400.bin
	local hf=rts5453_GOOG0400.hash
