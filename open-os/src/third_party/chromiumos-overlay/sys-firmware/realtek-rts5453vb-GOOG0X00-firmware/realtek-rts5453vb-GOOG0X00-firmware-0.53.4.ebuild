...
DESCRIPTION="RTS5453-VB Firmware GOOG0X00 Binary"
...
#    ex: tar -cJf realtek-rts5453vb-GOOG0X00-firmware-${PV}.tar.xz \
...
# 4) Finally run `ebuild realtek-rts5453vb-GOOG0X00-firmware-${PV}.ebuild manifest`
src_install() {
	...
	local bf=rts5453vb_GOOG0X00.bin
	local hf=rts5453vb_GOOG0X00.hash
