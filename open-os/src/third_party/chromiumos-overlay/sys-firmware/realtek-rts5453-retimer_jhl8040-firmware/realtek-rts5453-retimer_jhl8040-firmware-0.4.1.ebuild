...
#    ex: tar -cJf realtek-rts5453-retimer_jhl8040-firmware-${PV}.tar.xz \
#          realtek-rts5453-retimer_jhl8040-firmware-${PV}/rts5453_V${PV}.bin
...
# 4) Finally run `ebuild realtek-rts5453-retimer_jhl8040-firmware-${PV}.ebuild manifest`
src_install() {
