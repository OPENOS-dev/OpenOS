...
FILENAMES_SKYRIM=(
	...
	# samsung,PM9C1a-256G
	"d162c68537f63a96c8a61e5d6214e9262c47937fd07f7cab815d1ab6ddea3454-SAMSUNG_PM9C1a_SSD_FW_57330409.cab"
	# ssstc,CL4-3D256-Q11
	"508817bdf4a71fd31344194e6a6971ab693685ad6dd5a7b60d9afb91ca3bd2c1-25301114.cab"
	# hynix,BC901-256G
	"2ba0d13ec546099ac26a97fea7a0043a22142a01cbdad69231b2c55faf9b95e3-LVFS_BC901_Dell_51006151.cab"
	# wdc,SN740
	"5805ef2c25a3d6c8943064dff7a0fea61fbefdff7c11f982f2d876244112b25b-73914107_ID5440.cab"
	# kioxia,BG6
	"5e61fa513abba954d648fa54db4a8ba642f906a3dc5b42d5dc0f8c2cc802e0eb-12000102.cab"
)
...
# b/374857405
FILENAMES_NISSA=(
	# samsung,KLUDG4UHGC-B0E1
	"unsigned_SOLVIT_V6_TLC_256Gb_UFS31_GEN1_128GB_P21_FW01_e52a9b8_241106_13h23m.cab"
)

# b/394756078
FILENAMES_RAURU=(
	"unsigned_SDINHFT4-256G_1314.cab"
)
...
SRC_URI="
	...
	nissa? ( ${FILENAMES_NISSA[*]/#/${CROS_FWUPD_URL}/} )
	rauru? ( ${FILENAMES_RAURU[*]/#/${CROS_FWUPD_URL}/} )
"
install_rules() {
	local ufiledir="${1}"
...
src_install() {
	...
	if use nissa; then
		install_rules "${FILESDIR}/nissa"
	fi
	if use rauru; then
		install_rules "${FILESDIR}/rauru"
	fi
