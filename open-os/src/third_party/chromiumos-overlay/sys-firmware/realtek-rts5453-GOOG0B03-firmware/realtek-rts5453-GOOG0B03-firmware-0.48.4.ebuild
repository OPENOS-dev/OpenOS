...
DESCRIPTION="RTS5453 Firmware GOOG0B03 Binary"
...
#    ex: tar -cJf realtek-rts5453-GOOG0B03-firmware-${PV}.tar.xz \
#          realtek-rts5453-GOOG0B03-firmware-${PV}/rts5453_V${PV}.bin
...
# 4) Finally run `ebuild realtek-rts5453-GOOG0B03-firmware-${PV}.ebuild manifest`
src_install() {
	...
	local bf=rts5453_GOOG0B03.bin
	local hf=rts5453_GOOG0B03.hash
