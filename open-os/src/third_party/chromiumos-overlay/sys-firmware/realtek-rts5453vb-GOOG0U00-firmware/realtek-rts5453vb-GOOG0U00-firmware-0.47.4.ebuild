...
DESCRIPTION="RTS5453-VB Firmware GOOG0U00 Binary"
...
#    ex: tar -cJf realtek-rts5453vb-GOOG0U00-firmware-${PV}.tar.xz \
#          realtek-rts5453vb-GOOG0U00-firmware-${PV}/rts5453_V${PV}.bin
...
# 4) Finally run `ebuild realtek-rts5453vb-GOOG0U00-firmware-${PV}.ebuild manifest`
src_install() {
	...
	local bf=rts5453vb_GOOG0U00.bin
	local hf=rts5453vb_GOOG0U00.hash
