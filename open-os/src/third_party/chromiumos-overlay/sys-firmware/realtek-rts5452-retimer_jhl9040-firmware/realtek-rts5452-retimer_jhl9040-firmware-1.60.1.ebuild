...
DESCRIPTION="RTS5452 Firmware retimer_jhl9040 Binary"
...
# Here are the steps to uprev the RTS5452 firmware.
# 1) Tarball the firmware binary using XZ, including the right directory.
#    ex: tar -cJf realtek-rts5452-retimer_jhl9040-firmware-${PV}.tar.xz \
#          realtek-rts5452-retimer_jhl9040-firmware-${PV}/rts5452_V${PV}.bin
...
# 4) Finally run `ebuild realtek-rts5452-retimer_jhl9040-firmware-${PV}.ebuild manifest`
src_install() {
	...
	local bf=rts5452_retimer_jhl9040.bin
	local hf=rts5452_retimer_jhl9040.hash
