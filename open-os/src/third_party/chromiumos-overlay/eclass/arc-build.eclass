...
# e.g. /opt/android-main, for sys-devel/arc-toolchain-main
...
# TODO(b/368444482): Toolchain for android-vm-vic
BDEPEND="
	android-container-pi? ( sys-devel/arc-toolchain-p )
	android-container-rvc? ( sys-devel/arc-toolchain-r )
	android-vm-tm? ( sys-devel/arc-toolchain-t )
	android-vm-vic? ( sys-devel/arc-toolchain-main )
	android-vm-master? ( sys-devel/arc-toolchain-main )
"
