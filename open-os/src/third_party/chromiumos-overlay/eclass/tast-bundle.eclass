...
tast-bundle_src_compile() {
	...
	local host_exec="host_${TAST_BUNDLE_NAME}_${TAST_BUNDLE_TYPE}"
	...
	"./${host_exec}" -exportfixturemetadata > "${TAST_BUNDLE_NAME}_${TAST_BUNDLE_TYPE}_harness.pb" || die "Exporting fixture metadata of a harness"
}
...
tast-bundle_src_install() {
	...
	doins "${TAST_BUNDLE_NAME}_${TAST_BUNDLE_TYPE}_harness.pb"
}
