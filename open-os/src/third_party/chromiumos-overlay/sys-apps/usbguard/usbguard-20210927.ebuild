...
inherit autotools eutils user cros-sanitizers cros-protobuf
...
PATCHES=(
	...
	"${FILESDIR}/close_streambuf_fd.patch"
)
...
src_install() {
	...
	doins "${FILESDIR}"/usbguard-on-lock.conf
	doins "${FILESDIR}"/usbguard-on-unlock.conf
