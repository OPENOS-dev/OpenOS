...
inherit multilib cros-toolchain-funcs eutils distutils-r1
...
src_prepare() {
	...
	if use python ; then
		...
		# Generate libfdt.py.  This needs to happen before src_prepare copies
		# the sources for each build.
		swig -I../libfdt -python libfdt.i || die
