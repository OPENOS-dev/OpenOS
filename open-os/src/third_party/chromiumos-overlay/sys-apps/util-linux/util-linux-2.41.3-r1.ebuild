...
inherit cros-toolchain-funcs libtool flag-o-matic bash-completion-r1 \
...
SLOT="0"
IUSE="audit build caps +cramfs cryptsetup fdformat +hardlink kernel_Hurd kill +logger magic ncurses nls pam python +readline rtas selinux slang static-libs +su +suid systemd test tty-helpers udev unicode uuidd"
...
PATCHES=(
	...
	"${FILESDIR}"/CHROMIUM-losetup-autoclear.patch  # b/358629433: downstream patch for now.
)
