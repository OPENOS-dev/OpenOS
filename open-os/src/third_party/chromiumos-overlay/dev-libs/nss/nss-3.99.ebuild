...
PATCHES=(
	...
	# b/346636077 - Use a fixed HMAC key so shlibsign we can generate
	# reproducible .chk files.
	"${FILESDIR}/CHROMIUM-fixed-hmac-key.patch"
	...
	"${FILESDIR}/${PN}-3.68.2-add-clear-cache-method.patch"
)
