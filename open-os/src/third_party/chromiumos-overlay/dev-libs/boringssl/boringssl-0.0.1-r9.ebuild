...
CROS_WORKON_COMMIT="3e89a7e8db8139db356b892ca9993172346c80cf"
CROS_WORKON_TREE="01e833fa072117aca555a7b978bc96d45036282c"
...
PATCHES=(
	"${FILESDIR}/${PN}-memchr-c23-const.patch"
)
...
src_install() {
	...
	local libdir=${ED}/${INSTALL_PREFIX}/$(get_libdir)
	mv "${libdir}/libcrypto.a" "${libdir}/libboringcrypto.a" || die
	mv "${libdir}/libssl.a" "${libdir}/libboringssl.a" || die
	...
	sed \
		...
		-e "s|@version@|${PV}|g" \
		"${FILESDIR}/boringssl.pc" | newins - boringssl.pc
}
