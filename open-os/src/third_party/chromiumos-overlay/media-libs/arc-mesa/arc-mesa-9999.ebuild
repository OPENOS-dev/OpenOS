...
inherit meson multilib-minimal flag-o-matic cros-toolchain-funcs cros-workon arc-build cros-sanitizers
...
src_prepare() {
	...
	eapply "${FILESDIR}"/UPSTREAM-glapi-remove-deprecated-.getchildren-that-has-been-r.patch
	default
}
