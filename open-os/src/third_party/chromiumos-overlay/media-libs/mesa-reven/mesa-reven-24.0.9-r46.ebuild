...
CROS_WORKON_COMMIT="31f978279f5de2ad5cea3e55e867b4523ff26e0c"
CROS_WORKON_TREE="560ea7d5c7d4791365f5cc5c50257e03d76ef7aa"
CROS_WORKON_PROJECT="chromiumos/third_party/mesa"
CROS_WORKON_EGIT_BRANCH="chromeos-reven"
CROS_WORKON_LOCALNAME="mesa-reven"

inherit flag-o-matic meson cros-toolchain-funcs cros-workon
...
src_install() {
	...
	# VM boards use vkms for display output. Install a configuration
	# file that causes mesa to load kms-swrast instead of swrast
	# with vkms.
	if use vkms; then
