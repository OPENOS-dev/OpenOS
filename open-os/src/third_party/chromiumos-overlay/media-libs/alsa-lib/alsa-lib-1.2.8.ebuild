...
SLOT="0"
KEYWORDS="*"
IUSE="alisp cros_host debug doc elibc_uclibc python +thread-safety"

# add ucm2/ucm.conf for UCM1 compatibility
RDEPEND="
	python? ( ${PYTHON_DEPS} )
	!cros_host? ( media-libs/alsa-ucm-conf )
"
DEPEND="${RDEPEND}
...
PATCHES=(
	...
	"${FILESDIR}/0001-ucm-fix-Path-condition-substitute-Path-and-Mode-fiel.patch"
	"${FILESDIR}/0002-ucm-fix-Path-condition-substitute-Path.patch"
)
