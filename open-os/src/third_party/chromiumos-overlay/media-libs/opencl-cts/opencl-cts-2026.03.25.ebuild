...
OPENCL_CTS="OpenCL-CTS-2026-03-25-00"
...
BDEPEND="
	...
	>=dev-util/spirv-tools-1.4.313.0
"

S="${WORKDIR}/${OPENCL_CTS}"

PATCHES=(
	"${FILESDIR}/opencl-cts-00-test_compiler.patch"
	"${FILESDIR}/opencl-cts-01-GITHUB-PR-2658-round_to_int_and_clamp.patch"
)
...
src_configure() {
	local mycmakeargs=(
		...
		-DSPIRV_INCLUDE_DIR="${ESYSROOT}/usr"
	)
...
src_install() {
	...
	doexe "${BUILD_DIR}/test_conformance/extensions/cl_ext_buffer_device_address/test_cl_ext_buffer_device_address"
	...
	doexe "${BUILD_DIR}/test_conformance/extensions/cl_khr_external_memory_dma_buf/test_cl_khr_external_memory_dma_buf"
	doexe "${BUILD_DIR}/test_conformance/extensions/cl_khr_kernel_clock/test_cl_khr_kernel_clock"
