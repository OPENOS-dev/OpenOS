...
CROS_WORKON_COMMIT="feba6de6da4d04ac3da20181b5b56d49aeeedc29"
...
PATCHES=(
	...
	"${FILESDIR}"/0002-vkr-handle-spurious-wakeups-in-ring-notify-cnd_wait.patch
	"${FILESDIR}"/0003-vkr-handle-spurious-wakeups-in-ring-monitor-thread.patch
	"${FILESDIR}"/0004-c11-threads-fix-build-on-c23.patch
	"${FILESDIR}"/0005-fix-build-with-glibc-2.43.patch
	"${FILESDIR}"/0006-drm-validate-blob_size-against-container-shmem-struc.patch
	"${FILESDIR}"/0010-CHROMIUM-drm-msm-validate-SUBMITQUEUE_NEW-payload-si.patch
)
