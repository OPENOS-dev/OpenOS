...
THIS_VERSION_PREBUILT_NAME=rust-bootstrap-1.90.0-r2.tbz2
...
PRIOR_RUST_BOOTSTRAP_VERSION="1.89.0"
...
src_install() {
	...
	if is_only_installing_prebuilt; then
		...
		tools="${build_root}/stage1-tools/x86_64-unknown-linux-gnu/release"
	fi
	exeinto "/opt/${P}/bin"
