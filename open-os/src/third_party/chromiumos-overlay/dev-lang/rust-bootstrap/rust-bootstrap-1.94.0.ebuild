...
THIS_VERSION_PREBUILT_NAME=rust-bootstrap-1.94.0.tbz2
...
PRIOR_RUST_BOOTSTRAP_VERSION="1.93.0"
...
linker = "${CC}"
ranlib = "${ranlib}"
# b/459782820#comment9: the self-contained linker breaks us, and the chroot is
