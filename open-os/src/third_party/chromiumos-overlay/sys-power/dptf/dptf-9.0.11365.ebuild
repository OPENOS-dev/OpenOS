...
inherit cros-unibuild cmake cros-toolchain-funcs
...
PATCHES=(
	"${FILESDIR}/update-json_hpp-to-3.11.3.patch"
	"${FILESDIR}/fix-const-qualifier-discards-in-string-lookup-results.patch"
)
