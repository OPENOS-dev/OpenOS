...
# b/335720762: Remove dependency on media-libs/speexdsp.
# Wireshark will use a bundled version if not included. This simplifies uprevs.
RDEPEND="
	acct-group/pcap
...
# b/335720762: Use sys-devel/flex directly rather than app-alternatives/lex in order to make the uprev simpler.
BDEPEND="
	${PYTHON_DEPS}
	dev-lang/perl
	sys-devel/flex
