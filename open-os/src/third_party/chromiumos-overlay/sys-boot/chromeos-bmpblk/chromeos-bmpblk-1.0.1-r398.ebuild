...
EAPI=7
CROS_WORKON_COMMIT="ebb793c6131e3603e585bee2fa5c1c9b04cc92ec"
CROS_WORKON_TREE="6d45b714e1ea7b4a55028e8ef54a291e9ccb250e"
CROS_WORKON_PROJECT="chromiumos/platform/bmpblk"
CROS_WORKON_LOCALNAME="../platform/bmpblk"
CROS_WORKON_OUTOFTREE_BUILD="1"

PYTHON_COMPAT=( python3_11 )
inherit eutils cros-workon python-any-r1 cros-unibuild
...
src_prepare() {
	...
	while read -r name && read -r bmpblk_target; do
		if [[ -z "${bmpblk_target}" ]]; then
			die "Missing bmpblk build target"
		fi
