...
python_prepare_all() {
	...
	# b/456473896 There is a race condition in regenerating vs. using
	# src/python/grpcio/grpc/_cython/cygrpc.cpp. To avoid the race, delete the file
	# before the build.
	rm -f src/python/grpcio/grpc/_cython/cygrpc.cpp || die
}
