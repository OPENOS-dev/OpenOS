 ...
 */
#ifndef _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM15_H_
#define _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM15_H_
#pragma once

#include "../dbg_exif_def.h"

//
// Debug Exif Version 15 - MT6873
//
namespace dbg_cam_mf_param_15 {

 // MF debug info
enum { MF_DEBUG_TAG_VERSION = 15 };
...
#endif//_MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM15_H_
