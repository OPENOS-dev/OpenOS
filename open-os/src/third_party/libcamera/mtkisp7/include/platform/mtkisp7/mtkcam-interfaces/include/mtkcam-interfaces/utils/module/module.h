...
#ifndef INCLUDE_MTKCAM_INTERFACES_UTILS_MODULE_MODULE_H_
#define INCLUDE_MTKCAM_INTERFACES_UTILS_MODULE_MODULE_H_
//
/******************************************************************************
 *
 ******************************************************************************/
#include <stdint.h>
#include <sys/cdefs.h>
#include <mtkcam-interfaces/def/module.h>
...
#define GET_MTKCAM_MODULE_EXTENSION(_module_id_) \
    ...
    ((0 == getMtkcamModule(_module_id_, &m) && m) \
    ? m->get_module_extension() : NULL);})
 ...
 ******************************************************************************/
__END_DECLS
#endif  // INCLUDE_MTKCAM_INTERFACES_UTILS_MODULE_MODULE_H_
