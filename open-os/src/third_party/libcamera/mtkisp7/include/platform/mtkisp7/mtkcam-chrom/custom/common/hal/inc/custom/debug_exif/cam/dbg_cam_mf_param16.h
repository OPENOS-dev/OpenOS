 ...
 */
#ifndef _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM16_H_
#define _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM16_H_
#pragma once

#include "../dbg_exif_def.h"

//
// Debug Exif Version 16 - MT6853
//
namespace dbg_cam_mf_param_16 {

 // MF debug info
enum { MF_DEBUG_TAG_VERSION = 16 };
...
#endif//_MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM16_H_
