 ...
 */
#ifndef _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM14_H_
#define _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM14_H_
#pragma once

#include "../dbg_exif_def.h"

//
// Debug Exif Version 14 - MT6885
//
namespace dbg_cam_mf_param_14 {

 // MF debug info
enum { MF_DEBUG_TAG_VERSION = 14 };
...
#endif//_MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM14_H_
