...
#define MAXIMUM_NVRAM_CAMERA_ISP_FILE_SIZE         (10000000) // (size of NVRAM_CAMERA_ISP_PARAM_STRUCT)

#define MAXIMUM_NVRAM_CAMERA_3A_FILE_SIZE          (2000000) //

#define MAXIMUM_NVRAM_CAMERA_FEATURE_FILE_SIZE      (1000000)
