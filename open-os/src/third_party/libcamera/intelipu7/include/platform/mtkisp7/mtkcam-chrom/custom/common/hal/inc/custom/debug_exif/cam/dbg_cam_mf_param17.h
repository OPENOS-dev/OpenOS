 ...
 */
#ifndef _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM17_H_
#define _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM17_H_
#pragma once

#include "../dbg_exif_def.h"

//
// Debug Exif Version 17 - MT6877
//
namespace dbg_cam_mf_param_17 {

 // MF debug info
enum { MF_DEBUG_TAG_VERSION = 17 };
...
#endif//_MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM17_H_
