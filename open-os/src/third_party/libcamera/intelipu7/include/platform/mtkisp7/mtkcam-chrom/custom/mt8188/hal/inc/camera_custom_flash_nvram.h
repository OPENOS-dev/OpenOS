...
typedef struct
{
    ...
    int minFlashPulseWidth; // 1000 (default)
    int maxFlashPulseWidth; // 65000 (default)
    int slowSyncFlashFgOverCnt; // 5 (default)
    int slowSyncFlashBgOverCnt; // 5 (default)
    int slowSyncFlashMaxExp; // 250000 (default)
    int slowSyncFlashMaxIso; // 5000 (default)
...
typedef struct
{
    ...
    short panelYTab[FLASH_CUSTOM_MAX_DUTY_NUM];  //x128
...
typedef struct
{
    ...
    NVRAM_FLASH_ENG_LEVEL panelEngLevel;
