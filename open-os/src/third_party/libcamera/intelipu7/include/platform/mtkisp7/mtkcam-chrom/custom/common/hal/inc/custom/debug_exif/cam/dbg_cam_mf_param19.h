 ...
 */
#ifndef _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM19_H_
#define _MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM19_H_
#pragma once

#include "../dbg_exif_def.h"

//
// Debug Exif Version 19 - MT6781
//
namespace dbg_cam_mf_param_19 {

 // MF debug info
enum { MF_DEBUG_TAG_VERSION = 19 };
...
#endif//_MTK_CUSTOM_DEBUG_EXIF_CAM_DBG_CAM_MF_PARAM19_H_
