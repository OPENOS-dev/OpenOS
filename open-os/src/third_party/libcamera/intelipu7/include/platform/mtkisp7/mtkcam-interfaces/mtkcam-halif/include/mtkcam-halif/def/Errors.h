...
#ifndef INCLUDE_MTKCAM_HALIF_DEF_ERRORS_H_
#define INCLUDE_MTKCAM_HALIF_DEF_ERRORS_H_
...
/**
 * Error codes. All error codes are negative values.
 */
typedef int MERROR;
/**
...
#endif  // INCLUDE_MTKCAM_HALIF_DEF_ERRORS_H_
