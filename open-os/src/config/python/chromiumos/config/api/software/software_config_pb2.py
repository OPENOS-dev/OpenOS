...
from chromiumos.config.api.software import unified_fw_config_pb2 as chromiumos_dot_config_dot_api_dot_software_dot_unified__fw__config__pb2
...
_SOFTWARECONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='unified_fw_config', full_name='chromiumos.config.api.software.SoftwareConfig.unified_fw_config', index=21,
...
_SOFTWARECONFIG.fields_by_name['unified_fw_config'].message_type = chromiumos_dot_config_dot_api_dot_software_dot_unified__fw__config__pb2._UNIFIEDFIRMWARECONFIG
