...
_ANDROIDPROVISIONCLIRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='installed_android_os', full_name='chromiumos.test.api.AndroidProvisionCLIResponse.installed_android_os', index=4,
...
_ANDROIDPROVISIONCLIRESPONSE.fields_by_name['installed_android_os'].message_type = chromiumos_dot_test_dot_api_dot_android__provision__metadata__pb2._INSTALLEDANDROIDOS
