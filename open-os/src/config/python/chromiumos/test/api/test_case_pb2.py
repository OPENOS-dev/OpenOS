...
_TESTCASE_BUILDDEPS = _descriptor.Descriptor(
  name='BuildDeps',
  full_name='chromiumos.test.api.TestCase.BuildDeps',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='chromiumos.test.api.TestCase.BuildDeps.value', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TESTCASE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='build_dependencies', full_name='chromiumos.test.api.TestCase.build_dependencies', index=4,
  ...
  nested_types=[_TESTCASE_ID, _TESTCASE_TAG, _TESTCASE_DEPENDENCY, _TESTCASE_BUILDDEPS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_TESTCASE_BUILDDEPS.containing_type = _TESTCASE
...
_TESTCASE.fields_by_name['build_dependencies'].message_type = _TESTCASE_BUILDDEPS
...
TestCase = _reflection.GeneratedProtocolMessageType('TestCase', (_message.Message,), {
  ...
  'BuildDeps' : _reflection.GeneratedProtocolMessageType('BuildDeps', (_message.Message,), {
    'DESCRIPTOR' : _TESTCASE_BUILDDEPS,
    '__module__' : 'chromiumos.test.api.test_case_pb2'
    # @@protoc_insertion_point(class_scope:chromiumos.test.api.TestCase.BuildDeps)
    })
  ,
...
_sym_db.RegisterMessage(TestCase.BuildDeps)
