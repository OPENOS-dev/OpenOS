...
#define bs_debug_error(...) bs_debug_print("ERROR", __func__, __FILE__, __LINE__, __VA_ARGS__)
#define bs_debug_warning(...) bs_debug_print("WARN", __func__, __FILE__, __LINE__, __VA_ARGS__)
#define bs_debug_info(...) bs_debug_print("INFO", __func__, __FILE__, __LINE__, __VA_ARGS__)
