...
#define METRICSV_VALID_EK_SHIFT 8
#define METRICSV_VALID_EK_MASK (1 << METRICSV_VALID_EK_SHIFT)
#define METRICSV_VALID_UDS_SK_SHIFT 9
#define METRICSV_VALID_UDS_SK_MASK (1 << METRICSV_VALID_UDS_SK_SHIFT)
