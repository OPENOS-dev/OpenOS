...
StructuredBuffer<myStruct> structured_buffer; // D3D_SIT_STRUCTURED
RWStructuredBuffer<myStruct> rw_structured_buffer; // D3D_SIT_UAV_RWSTRUCTURED
...
PSOutput main(PSInput input)
{
  ...
  ret.oColor4 = input.Scaling * structured_buffer[0].f3.x * ba_buffer.Load(0);
