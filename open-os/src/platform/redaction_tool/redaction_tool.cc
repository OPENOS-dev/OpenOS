...
CustomPatternWithAlias kCustomPatternsWithContext[] = {
    ...
    // serial number string. The iSerial index must be nonzero, as an index
    // of zero indicates no string descriptor is present. The serial number
    // string itself is up to the manufacturer, but is observed to be
    // alphanumetric (numbers, and both upper and lower case letters).
