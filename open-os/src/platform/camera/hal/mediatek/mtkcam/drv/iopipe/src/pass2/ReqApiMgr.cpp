...
ReqApiMgr::SYNC_ID ReqApiMgr::getSyncIdByNodeId(V4L2StreamNode::ID id) {
  ...
  switch(id){
    case V4L2StreamNode::ID_P2_RAW_INPUT:
      return ReqApiMgr::SYNC_ID_RAW_INPUT;
    case V4L2StreamNode::ID_P2_TUNING:
      return ReqApiMgr::SYNC_ID_TUNING;
    case V4L2StreamNode::ID_P2_VIPI:
      return ReqApiMgr::SYNC_ID_VIPI;
    case V4L2StreamNode::ID_P2_LCEI:
      return ReqApiMgr::SYNC_ID_LCEI;
    case V4L2StreamNode::ID_P2_MDP0:
      return ReqApiMgr::SYNC_ID_MDP0;
    case V4L2StreamNode::ID_P2_MDP1:
      return ReqApiMgr::SYNC_ID_MDP1;
    case V4L2StreamNode::ID_P2_IMG2:
      return ReqApiMgr::SYNC_ID_IMG2O;
    case V4L2StreamNode::ID_P2_IMG3:
      return ReqApiMgr::SYNC_ID_IMG3O;
    case V4L2StreamNode::ID_P2_CAP_RAW_INPUT:
      return ReqApiMgr::SYNC_ID_CAP_RAW_INPUT;
    case V4L2StreamNode::ID_P2_CAP_TUNING:
      return ReqApiMgr::SYNC_ID_CAP_TUNING;
    case V4L2StreamNode::ID_P2_CAP_VIPI:
      return ReqApiMgr::SYNC_ID_CAP_VIPI;
    case V4L2StreamNode::ID_P2_CAP_LCEI:
      return ReqApiMgr::SYNC_ID_CAP_LCEI;
    case V4L2StreamNode::ID_P2_CAP_MDP0:
      return ReqApiMgr::SYNC_ID_CAP_MDP0;
    case V4L2StreamNode::ID_P2_CAP_MDP1:
      return ReqApiMgr::SYNC_ID_CAP_MDP1;
    case V4L2StreamNode::ID_P2_CAP_IMG2:
      return ReqApiMgr::SYNC_ID_CAP_IMG2O;
    case V4L2StreamNode::ID_P2_CAP_IMG3:
      return ReqApiMgr::SYNC_ID_CAP_IMG3O;
    case V4L2StreamNode::ID_P2_REP_RAW_INPUT:
      return ReqApiMgr::SYNC_ID_REP_RAW_INPUT;
    case V4L2StreamNode::ID_P2_REP_TUNING:
      return ReqApiMgr::SYNC_ID_REP_TUNING;
    case V4L2StreamNode::ID_P2_REP_VIPI:
      return ReqApiMgr::SYNC_ID_REP_VIPI;
    case V4L2StreamNode::ID_P2_REP_LCEI:
      return ReqApiMgr::SYNC_ID_REP_LCEI;
    case V4L2StreamNode::ID_P2_REP_MDP0:
      return ReqApiMgr::SYNC_ID_REP_MDP0;
    case V4L2StreamNode::ID_P2_REP_MDP1:
      return ReqApiMgr::SYNC_ID_REP_MDP1;
    case V4L2StreamNode::ID_P2_REP_IMG2:
      return ReqApiMgr::SYNC_ID_REP_IMG2O;
    case V4L2StreamNode::ID_P2_REP_IMG3:
      return ReqApiMgr::SYNC_ID_REP_IMG3O;
    default:
...
int ReqApiMgr::releaseUsedReqApi(SYNC_ID caller, int fd) {
  ...
  if (it_record->is_done(static_cast<SYNC_ID>(it_record->user_id_mask))) {
    ...
    LOGD("reinit request_api:%#x and push idx:%td to free list",
