  ...
  switch (gSearchRange) {
    ...
    case LMV_MAX_GMV_64: {
      ...
      CAM_LOGD(
          ...
          "MaxGmv(%d)",
          reinterpret_cast<const char*>(table_name), _this->mImgWidth,
          _this->mImgHeight, _this->mLmvDivH, _this->mLmvDivV, win_numH,
          win_numV, max_range);
    }
