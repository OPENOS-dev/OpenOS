...
const char* IntelAlgoIpcCmdToString(IPC_CMD cmd) {
    static const char* gIpcCmdMapping[] = {
        ...
        "IPC_CCA_CONSTRUCT", "IPC_CCA_DESTRUCT", "IPC_CCA_INIT", "IPC_CCA_RUN_AEC",
        "IPC_CCA_RUN_AIQ", "IPC_CCA_RUN_LTM", "IPC_CCA_RECONFIG_DVS", "IPC_CCA_UPDATE_ZOOM",
        "IPC_CCA_RUN_DVS", "IPC_CCA_GET_CMC", "IPC_CCA_GET_AIQD", "IPC_CCA_UPDATE_TUNING",
        "IPC_CCA_DEINIT", "IPC_CCA_RUN_AIC", "IPC_CCA_GET_PAL_SIZE", "IPC_PG_PARAM_INIT",
        "IPC_PG_PARAM_PREPARE", "IPC_PG_PARAM_ALLOCATE_PG", "IPC_PG_PARAM_GET_FRAG_DESCS",
        "IPC_PG_PARAM_PREPARE_PROGRAM", "IPC_PG_PARAM_REGISTER_PAYLOADS", "IPC_PG_PARAM_ENCODE",
        "IPC_PG_PARAM_DECODE", "IPC_PG_PARAM_DEINIT", "IPC_GPU_TNR_INIT",
        "IPC_GPU_TNR_GET_SURFACE_INFO", "IPC_GPU_TNR_PREPARE_SURFACE", "IPC_GPU_TNR_RUN_FRAME",
        "IPC_GPU_TNR_PARAM_UPDATE", "IPC_GPU_TNR_DEINIT",
...
const char* IntelAlgoServerThreadName(int index) {
    ...
    static const char* gIpcCmdMapping[IPC_CPU_GROUP_NUM] = {"AiqCPUAlgoServer", "PalCPUAlgoServer",
                                                            "PsysCPUAlgoServer", "FdCPUAlgoServer",
                                                            "OtherCPUAlgoServer"};
