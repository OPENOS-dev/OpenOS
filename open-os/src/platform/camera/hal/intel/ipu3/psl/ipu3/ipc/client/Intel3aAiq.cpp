            ...
            uintptr_t mkn_handle)
{
    ...
    CheckAndLogError(ret == false, false, "@%s, allocShmMem fails",
                     __FUNCTION__);
...
void Intel3aAiq::deinit()
{
    ...
    CheckAndLogError(reinterpret_cast<ia_aiq*>(mAiq) == nullptr, VOID_VALUE,
              ...
              ia_aiq_ae_results** ae_results)
{
    ...
    CheckAndLogError(mInitialized == false, ia_err_general,
                     "@%s, mInitialized is false", __FUNCTION__);
    CheckAndLogError(reinterpret_cast<ia_aiq*>(mAiq) == nullptr, ia_err_general,
                     "@%s, mAiq is nullptr", __FUNCTION__);

    CheckAndLogError((ae_input_params == nullptr), ia_err_argument,
                     "@%s, ae_input_params is nullptr", __FUNCTION__);
    CheckAndLogError((ae_results == nullptr), ia_err_argument,
    ...
    CheckAndLogError(ret == false, ia_err_general, "@%s, clientFlattenAe fails",
                     __FUNCTION__);

    ret = mCommon.requestSync(IPC_3A_AIQ_AE_RUN, mMemAe.mHandle);
    CheckAndLogError(ret == false, ia_err_general, "@%s, requestSync fails",
                     __FUNCTION__);

    ret = mIpc.clientUnflattenAe(*params, ae_results);
    CheckAndLogError(ret == false, ia_err_general,
              ...
              ia_aiq_af_results** af_results)
{
    ...
    CheckAndLogError((af_input_params == nullptr), ia_err_argument,
                     "@%s, af_input_params is nullptr", __FUNCTION__);
    CheckAndLogError((af_results == nullptr), ia_err_argument,
                     "@%s, af_results is nullptr", __FUNCTION__);

    af_run_params* params = static_cast<af_run_params*>(mMemAf.mAddr);

    bool ret = mIpc.clientFlattenAf(mAiq, *af_input_params, params);
    CheckAndLogError(ret == false, ia_err_general, "@%s, clientFlattenAf fails",
                     __FUNCTION__);
    ...
    CheckAndLogError(ret == false, ia_err_general,
                     "@%s, clientUnflattenAf fails", __FUNCTION__);
               ...
               ia_aiq_awb_results** awb_results)
{
    ...
    CheckAndLogError((awb_input_params == nullptr), ia_err_argument,
                     "@%s, awb_input_params is nullptr", __FUNCTION__);
    CheckAndLogError((awb_results == nullptr), ia_err_argument,
    ...
    CheckAndLogError(ret == false, ia_err_general,
                     "@%s, clientFlattenAwb fails", __FUNCTION__);
                ...
                ia_aiq_gbce_results** gbce_results)
{
    ...
    CheckAndLogError((gbce_input_params == nullptr), ia_err_argument,
                     "@%s, gbce_input_params is nullptr", __FUNCTION__);
    CheckAndLogError((gbce_results == nullptr), ia_err_argument,
                     "@%s, gbce_results is nullptr", __FUNCTION__);
    ...
    CheckAndLogError(ret == false, ia_err_general,
                     "@%s, clientFlattenGbce fails", __FUNCTION__);
    ...
    CheckAndLogError(ret == false, ia_err_general,
                     "@%s, clientUnflattenGbce fails", __FUNCTION__);
...
ia_err Intel3aAiq::getAiqdData(ia_binary_data* out_ia_aiq_data)
{
    ...
    CheckAndLogError((out_ia_aiq_data == nullptr), ia_err_argument,
                     "@%s, out_ia_aiq_data is nullptr", __FUNCTION__);
               ...
               ia_aiq_pa_results** pa_results)
{
    ...
    CheckAndLogError((pa_input_params == nullptr), ia_err_argument,
                     "@%s, pa_input_params is nullptr", __FUNCTION__);
    CheckAndLogError((pa_results == nullptr), ia_err_argument,
                     "@%s, pa_results is nullptr", __FUNCTION__);

    pa_run_params* params = static_cast<pa_run_params*>(mMemPa.mAddr);

    bool ret = mIpc.clientFlattenPa(mAiq, *pa_input_params, params);
    CheckAndLogError(ret == false, ia_err_general, "@%s, clientFlattenPa fails",
                     __FUNCTION__);
    ...
    CheckAndLogError(ret == false, ia_err_general,
                     "@%s, clientUnflattenPa fails", __FUNCTION__);
               ...
               ia_aiq_sa_results** sa_results)
{
    ...
    CheckAndLogError((sa_input_params == nullptr), ia_err_argument,
                     "@%s, sa_input_params is nullptr", __FUNCTION__);
    CheckAndLogError((sa_results == nullptr), ia_err_argument,
                     "@%s, sa_results is nullptr", __FUNCTION__);

    sa_run_params* params = static_cast<sa_run_params*>(mMemSa.mAddr);

    bool ret = mIpc.clientFlattenSa(mAiq, *sa_input_params, params);
    CheckAndLogError(ret == false, ia_err_general, "@%s, clientFlattenSa fails",
                     __FUNCTION__);
    ...
    CheckAndLogError(ret == false, ia_err_general,
                     "@%s, clientUnflattenSa fails", __FUNCTION__);
...
ia_err Intel3aAiq::statisticsSet(const ia_aiq_statistics_input_params* input_params)
{
    ...
    CheckAndLogError((input_params == nullptr), ia_err_argument,
                     "@%s, input_params is nullptr", __FUNCTION__);
