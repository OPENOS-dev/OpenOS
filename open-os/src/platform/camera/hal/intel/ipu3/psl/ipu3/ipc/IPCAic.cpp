...
bool IPCAic::flattenIPU3AICRuntimeParams(const IPU3AICRuntimeParams& params, IPU3AICRuntimeParams_data* input)
{
    ...
    CheckAndLogError(input == nullptr, false, "@%s, input is nullptr",
                     __FUNCTION__);
                                    ...
                                    Transport* transport)
{
    ...
    CheckAndLogError(transport == nullptr, false, "@%s, transport is nullptr",
                     __FUNCTION__);

    if (aiqb) {
        CheckAndLogError(aiqb->size > sizeof(transport->aiqb.data), false,
                         "@%s, aiqb, size:%d is too big", __FUNCTION__,
                         aiqb->size);
        transport->aiqb.size = aiqb->size;
        MEMCPY_S(transport->aiqb.data, sizeof(transport->aiqb.data), aiqb->data, aiqb->size);
    }

    CheckAndLogError(reinterpret_cast<ia_cmc_t*>(cmc) == nullptr, false,
                     "@%s, cmc is nullptr", __FUNCTION__);
    ...
    CheckAndLogError(ret == false, false,
                     "@%s, flattenIPU3AICRuntimeParams fails", __FUNCTION__);
                                    ...
                                    int* test_frameworkDump)
{
    ...
    CheckAndLogError(params == nullptr, false, "@%s, params is nullptr",
                     __FUNCTION__);
    CheckAndLogError(numPipes == nullptr, false, "@%s, numPipes is nullptr",
                     __FUNCTION__);
    CheckAndLogError(dumpAicParameters == nullptr, false,
                     "@%s, dumpAicParameters is nullptr", __FUNCTION__);
    CheckAndLogError(test_frameworkDump == nullptr, false,
                     "@%s, test_frameworkDump is nullptr", __FUNCTION__);
    ...
    *test_frameworkDump = transport.test_frameworkDump;
    ...
    CheckAndLogError(ret == false, false,
                     "@%s, unflattenIPU3AICRuntimeParams fails", __FUNCTION__);
