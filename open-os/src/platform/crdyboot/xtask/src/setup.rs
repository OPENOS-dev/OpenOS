...
const SETUP_VERSION: u32 = 21;

const VBOOT_REFERENCE_REPO: &str =
    "https://chromium.googlesource.com/chromiumos/platform/vboot_reference";
const VBOOT_REFERENCE_REV: &str = "906136da2c93e6dfe3c93763c93dfae59d24e54d";
