...
from .post_process import RoundingDivideByPowerOfTwo
from .post_process import SaturateActivationPipeline
from .post_process import SaturatingRoundingDoubleHighMul
    ...
    def test_simple_case(self):
        ...
        def process():
            for num_allowed, start, input_valid, running, finished in data:
                ...
                self.assertEqual(
                    running and input_valid, (yield dut.stream_out.valid)
                )
...
class OutputWordAssemblerTest(TestBase):
    ...
    def test_it_does_more(self):
        ...
        for sixteen_bytes in group(inputs, 16):
            ...
            expected_words = [
                pack_vals(*word) for word in expected_words_as_bytes
            ]
