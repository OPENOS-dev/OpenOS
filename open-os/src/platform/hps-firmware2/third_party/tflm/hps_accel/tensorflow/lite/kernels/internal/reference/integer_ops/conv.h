...
==============================================================================*/
#ifndef THIRD_PARTY_TFLM_HPS_ACCEL_TENSORFLOW_LITE_KERNELS_INTERNAL_REFERENCE_INTEGER_OPS_CONV_H_
#define THIRD_PARTY_TFLM_HPS_ACCEL_TENSORFLOW_LITE_KERNELS_INTERNAL_REFERENCE_INTEGER_OPS_CONV_H_
...
class CumulativeMinMax {
 public:
  explicit CumulativeMinMax(const char* name)
      : name_(name),
...
inline void UnacceleratedConvPerChannel(const ConvParams& params,
...
#endif  // THIRD_PARTY_TFLM_HPS_ACCEL_TENSORFLOW_LITE_KERNELS_INTERNAL_REFERENCE_INTEGER_OPS_CONV_H_
