...
_HARDWARETOPOLOGY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='dsp', full_name='chromiumos.config.api.HardwareTopology.dsp', index=36,
...
_HARDWARETOPOLOGY.fields_by_name['dsp'].message_type = chromiumos_dot_config_dot_api_dot_topology__pb2._TOPOLOGY
