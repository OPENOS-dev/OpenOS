...
_PROGRAM_PLATFORM_SWAPCONFIG = _descriptor.Descriptor(
  name='SwapConfig',
  full_name='chromiumos.config.api.Program.Platform.SwapConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='size_multiplier', full_name='chromiumos.config.api.Program.Platform.SwapConfig.size_multiplier', index=0,
...
_PROGRAM_PLATFORM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='swap_config', full_name='chromiumos.config.api.Program.Platform.swap_config', index=11,
  ...
  nested_types=[_PROGRAM_PLATFORM_CAPABILITIES, _PROGRAM_PLATFORM_SCHEDULERTUNE, _PROGRAM_PLATFORM_ARCSETTINGS, _PROGRAM_PLATFORM_SWAPCONFIG, ],
  enum_types=[
...
_PROGRAM_PLATFORM_SWAPCONFIG.containing_type = _PROGRAM_PLATFORM
...
_PROGRAM_PLATFORM.fields_by_name['swap_config'].message_type = _PROGRAM_PLATFORM_SWAPCONFIG
...
Program = _reflection.GeneratedProtocolMessageType('Program', (_message.Message,), {
  ...
  'Platform' : _reflection.GeneratedProtocolMessageType('Platform', (_message.Message,), {
    ...
    'SwapConfig' : _reflection.GeneratedProtocolMessageType('SwapConfig', (_message.Message,), {
      'DESCRIPTOR' : _PROGRAM_PLATFORM_SWAPCONFIG,
      '__module__' : 'chromiumos.config.api.program_pb2'
      # @@protoc_insertion_point(class_scope:chromiumos.config.api.Program.Platform.SwapConfig)
      })
    ,
...
_sym_db.RegisterMessage(Program.Platform.SwapConfig)
