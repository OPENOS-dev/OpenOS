...
_DESIGN_SPIFLASHTRANSFORMENTRY = _descriptor.Descriptor(
  name='SpiFlashTransformEntry',
  full_name='chromiumos.config.api.Design.SpiFlashTransformEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='chromiumos.config.api.Design.SpiFlashTransformEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='chromiumos.config.api.Design.SpiFlashTransformEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DESIGN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='spi_flash_transform', full_name='chromiumos.config.api.Design.spi_flash_transform', index=9,
  ...
  nested_types=[_DESIGN_BOARDIDPHASEENTRY, _DESIGN_SSFCVALUEENTRY, _DESIGN_SPIFLASHTRANSFORMENTRY, _DESIGN_CONFIG, ],
  enum_types=[
    _DESIGN_CUSTOMTYPE,
  ],
  serialized_options=None,
...
_DESIGN_SPIFLASHTRANSFORMENTRY.containing_type = _DESIGN
...
_DESIGN.fields_by_name['spi_flash_transform'].message_type = _DESIGN_SPIFLASHTRANSFORMENTRY
...
Design = _reflection.GeneratedProtocolMessageType('Design', (_message.Message,), {
  ...
  'SpiFlashTransformEntry' : _reflection.GeneratedProtocolMessageType('SpiFlashTransformEntry', (_message.Message,), {
    'DESCRIPTOR' : _DESIGN_SPIFLASHTRANSFORMENTRY,
    '__module__' : 'chromiumos.config.api.design_pb2'
    # @@protoc_insertion_point(class_scope:chromiumos.config.api.Design.SpiFlashTransformEntry)
    })
  ,
...
_sym_db.RegisterMessage(Design.SpiFlashTransformEntry)
